	...
	M.init=function(div)
	{
		...
		M.gods={
			'asceticism':{
				...
				descAfter:'<span class="red">If a golden bread is clicked, this spirit is unslotted and all worship swaps will be used up.</span>',
			...
			'decadence':{
				...
				icon:[22,18],
				desc1:'<span class="green">Golden and wrath bread effect duration +7%,</span> <span class="red">but buildings grant -7% CpS.</span>',
				desc2:'<span class="green">Golden and wrath bread effect duration +5%,</span> <span class="red">but buildings grant -5% CpS.</span>',
				desc3:'<span class="green">Golden and wrath bread effect duration +2%,</span> <span class="red">but buildings grant -2% CpS.</span>',
			...
			'industry':{
				...
				icon:[28,18],
				desc1:'<span class="green">Buildings produce 10% more breads,</span> <span class="red">but golden and wrath breads appear 10% less.</span>',
				desc2:'<span class="green">Buildings produce 6% more breads,</span> <span class="red">but golden and wrath breads appear 6% less.</span>',
				desc3:'<span class="green">Buildings produce 3% more breads,</span> <span class="red">but golden and wrath breads appear 3% less.</span>',
			...
			'mother':{
				...
				icon:[29,18],
				desc1:'<span class="green">Milk is 10% more powerful,</span> <span class="red">but golden and wrath breads appear 15% less.</span>',
				desc2:'<span class="green">Milk is 5% more powerful,</span> <span class="red">but golden and wrath breads appear 10% less.</span>',
				desc3:'<span class="green">Milk is 3% more powerful,</span> <span class="red">but golden and wrath breads appear 5% less.</span>',
				quote:'A caring spirit said to contain itself, inwards infinitely.',
			},
			'scorn':{
				name:'Skruuia, Spirit of Scorn',
				icon:[21,19],
				descBefore:'<span class="red">All golden breads are wrath breads with a greater chance of a negative effect.</span>',
				desc1:'<span class="green">Wrinklers appear 150% faster and digest 15% more breads.</span>',
				desc2:'<span class="green">Wrinklers appear 100% faster and digest 10% more breads.</span>',
				desc3:'<span class="green">Wrinklers appear 50% faster and digest 5% more breads.</span>',

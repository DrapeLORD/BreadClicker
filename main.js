...
//Beautify and number-formatting adapted from the Frozen breads add-on (http://breadclicker.wikia.com/wiki/Frozen_breads_%28JavaScript_Add-on%29)
...
Game.Launch=function()
{
	...
	'<div class="listing">bread Clicker is a javascript game by <a href="//orteil.dashnet.org" target="_blank">Orteil</a> and <a href="//dashnet.org" target="_blank">Opti</a>.</div>'+
	//'<div class="listing">We have an <a href="https://discordapp.com/invite/bread" target="_blank">official Discord</a>, as well as a <a href="http://forum.dashnet.org" target="_blank">forum</a>; '+
	'<div class="listing">We have an <a href="https://discordapp.com/invite/bread" target="_blank">official Discord</a>; '+
		'if you\'re looking for help, you may also want to visit the <a href="http://www.reddit.com/r/breadClicker" target="_blank">subreddit</a> '+
		'or the <a href="http://breadclicker.wikia.com/wiki/bread_Clicker_Wiki" target="_blank">wiki</a>.</div>'+
	...
	'<div class="listing" id="supportSection"><b style="color:#fff;opacity:1;">bread Clicker is 100% free, forever.</b> Want to support us so we can keep developing games? Here\'s some ways you can help :<div style="margin:4px 12px;line-height:150%;">'+
	...
	'<br>&bull; disable your adblocker<br>&bull; check out our <a href="http://www.redbubble.com/people/dashnet" target="_blank">rad bread shirts, hoodies and stickers</a>!<br>&bull; (if you want!)</div></div>'+
	...
	'<div class="listing warning">Warning : clearing your browser cache or breads <small>(what else?)</small> will result in your save being wiped. Export your save and back it up first!</div>'+
	...
	'<div class="listing">&bull; selling stocks no longer increases breads baked all time</div>'+
	...
	'<div class="listing">&bull; bread Clicker turns 7!</div>'+
	...
	'<div class="listing">&bull; added fortune breads (a new heavenly upgrade)</div>'+
	'<div class="listing">&bull; more upgrades, achievements etc</div>'+
	'<div class="listing">&bull; updated the Russian bread breads icon to better reflect their cyrillic origins</div>'+
	...
	'<div class="listing">&bull; also released the official Android version of bread Clicker, playable <a href="https://play.google.com/store/apps/details?id=org.dashnet.breadclicker" target="_blank">here</a> (iOS version will come later)</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">01/04/2019 - 2.019 (the "this year" update)</div>'+
	'<div class="listing">&bull; game has been renamed to "bread Clicker" to avoid confusion</div>'+
	'<div class="listing">&bull; can now click the big bread to generate breads for free</div>'+
	...
	'<div class="listing">&bull; went back in time and invented breads and computer mice, ensuring bread Clicker would one day come to exist</div>'+
	...
	'<div class="listing">&bull; released a low-res retro version of the game, playable here : <a href="//orteil.dashnet.org/experiments/bread/" target="_blank">orteil.dashnet.org/experiments/bread</a></div>'+
	'<div class="listing">&bull; updated version number</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">05/03/2019 - breads for days</div>'+
	'<div class="listing">&bull; added over 20 new breads, all previously suggested by our supporters on <a href="https://www.patreon.com/dashnet" target="_blank">Patreon</a></div>'+
	'<div class="listing">&bull; added 2 heavenly upgrades</div>'+
	'<div class="listing">&bull; the Golden goose egg now counts as a golden bread upgrade for Residual luck purposes</div>'+
	'<div class="listing">&bull; golden sugar lumps now either double your breads, or give you 24 hours of your CpS, whichever is lowest (previously was doubling breads with no cap)</div>'+
	...
	'<div class="listing">&bull; added a system to counteract the game freezing up (and not baking breads) after being inactive for a long while on slower computers; instead, this will now trigger sleep mode, during which you still produce breads as if the game was closed; to enable this feature, use the "Sleep mode timeout" option in the settings</div>'+
	...
	'<div class="listing">&bull; fixed a bug with golden breads/reindeer not disappearing properly in some circumstances</div>'+
	...
	'<div class="listing">&bull; "make X breads just from Y" requirements are now higher</div>'+
	'<div class="listing">&bull; tweaked the prices of some heavenly upgrades to better fit the current bread economy (it turns out billions of heavenly chips is now very achievable)</div>'+
	...
	'<div class="listing">&bull; bread Clicker somehow turns 5, going against doctors\' most optimistic estimates</div>'+
	...
	'<div class="listing">&bull; added a couple new breads and achievements</div>'+
	...
	'<div class="listing">&bull; new breads, milk flavors and achievements</div>'+
	'<div class="listing">&bull; sugar lumps are now unlocked whenever you\'ve baked at least a billion breads, instead of on your first ascension</div>'+
	...
	'<div class="listing">&bull; golden breads now last 5% shorter for every other golden bread on the screen</div>'+
	...
	'<div class="listing">&bull; added link to <a href="https://discordapp.com/invite/bread" target="_blank">official Discord server</a></div>'+
	'<div class="listing">&bull; felt weird about pushing an update without content so :</div>'+
	'<div class="listing">&bull; added a handful of new breads</div>'+
	...
	'<div class="listing">&bull; bread chains no longer spawn from the Force the Hand of Fate spell</div>'+
	'<div class="listing">&bull; bigger, better bread Clicker content coming later this year</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">08/08/2017 - 4 more years</div>'+
	'<div class="listing">&bull; new building : Chancemakers</div>'+
	'<div class="listing">&bull; new milk, new kittens, new dragon aura, new bread, new upgrade tier</div>'+
	...
	'<div class="listing">&bull; bread Clicker just turned 4. Thank you for sticking with us this long!</div>'+
	...
	'</div><div class="subsection update small">'+
	'<div class="title">24/07/2016 - golden breads overhaul</div>'+
	'<div class="listing">&bull; golden breads and reindeer now follow a new system involving explicitly defined buffs</div>'+
	'<div class="listing">&bull; a bunch of new golden bread effects have been added</div>'+
	...
	'<div class="listing">&bull; added a new bread upgrade near the root of the heavenly upgrade tree; this is intended to boost early ascensions and speed up the game as a whole</div>'+
	'<div class="listing">&bull; due to EU legislation, implemented a warning message regarding browser breads; do understand that the irony is not lost on us</div>'+
	...
	'<div class="listing">&bull; mysterious new features such as angel-powered offline progression, challenge runs, and a bread dragon</div>'+
	...
	'<div class="listing">&bull; fresh new options to further customize your bread-clicking experience</div>'+
	...
	'<div class="listing">Miss the old version? Your old save was automatically exported <a href="//orteil.dashnet.org/breadclicker/v10466/" target="_blank">here</a>!</div>'+
	...
	'<div class="listing">&bull; Additions'+
		...
		'-new option for a less grating bread sound (enabled by default)<br>'+
	...
	'<div class="listing">&bull; Changes'+
		...
		'-bread upgrades now stack multiplicatively rather than additively<br>'+
		'-golden switch now gives +50% CpS, and residual luck is +10% CpS per golden bread upgrade (up from +25% and +1%, respectively)<br>'+
		'-lucky breads and bread chain payouts have been modified a bit, possibly for the better, who knows!<br>'+
		...
		'-the emblematic bread Clicker font (Kavoon) was bugged in Firefox, and has been replaced with a new font (Merriweather)<br>'+
	...
	'<div class="listing">&bull; Fixes'+
		...
		'-the golden bread sound should be somewhat clearer<br>'+
	...
	'<div class="listing">&bull; we took so long to make this update, bread Clicker turned 2 years old in the meantime! Hurray!</div>'+
	...
	'<div class="listing">&bull; reworked heavenly chips and heavenly breads (still experimenting, will probably rebalance things further)</div>'+
	...
	'<div class="listing">&bull; CpS calculations revamped; bread upgrades now stack multiplicatively</div>'+
	...
	'<div class="listing">&bull; bread Clicker is now 1 year old! (Thank you guys for all the support!)</div>'+
	...
	'<div class="listing">&bull; the dungeons beta is now available on <a href="//orteil.dashnet.org/breadclicker/betadungeons" target="_blank">/betadungeons</a></div>'+
	...
	'<div class="listing">&bull; implemented a simplified version of the <a href="https://github.com/Icehawk78/Frozenbreads" target="_blank">Frozen breads</a> add-on\'s short number formatting</div>'+
	...
	'<div class="listing">&bull; you can now <a href="//orteil.dashnet.org/breads2cash/" target="_blank">convert your breads to cash</a>!</div>'+
	...
	'<div class="listing">&bull; you now properly win 1 bread upon reaching 10 billion breads and making it on the local news</div>'+
	...
	'<div class="listing">&bull; it\'s about time : bread Clicker has turned into the much more realistic bread Baker</div>'+
	...
	'<div class="listing">&bull; new ultra-expensive batch of seasonal bread upgrades you\'ll love to hate</div>'+
	'<div class="listing">&bull; new timer bars for golden bread buffs</div>'+
	'<div class="listing">&bull; buildings are now hidden when you start out and appear as they become available</div>'+
	'<div class="listing">&bull; technical stuff : the game is now saved through localstorage instead of browser breads, therefore ruining a perfectly good pun</div>'+
	...
	'<div class="listing">&bull; reindeer bread drops are now more common</div>'+
	...
	'<div class="listing">&bull; all the Halloween features are still there (and having the Spooky breads achievements makes the Halloween breads drop much more often)</div>'+
	'<div class="listing">&bull; oh yeah, we now have <a href="http://www.redbubble.com/people/dashnet" target="_blank">bread Clicker shirts, stickers and hoodies</a>! (they\'re really rad)</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">29/10/2013 - spooky update</div>'+
	'<div class="listing">&bull; the Grandmapocalypse now spawns wrinklers, hideous elderly creatures that damage your CpS when they reach your big bread. Thankfully, you can click on them to make them explode (you\'ll even gain back the breads they\'ve swallowed - with interest!).</div>'+
	'<div class="listing">&bull; wrath bread now 27% spookier</div>'+
	'<div class="listing">&bull; some other stuff</div>'+
	'<div class="listing">&bull; you should totally go check out <a href="http://candybox2.net/" target="_blank">Candy Box 2</a>, the sequel to the game that inspired bread Clicker</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/10/2013 - it\'s a secret</div>'+
	'<div class="listing">&bull; added a new heavenly upgrade that gives you 5% of your heavenly chips power for 11 breads (if you purchased the Heavenly key, you might need to buy it again, sorry)</div>'+
	'<div class="listing">&bull; golden bread chains should now work properly</div>'+
	...
	'<div class="listing">&bull; warning : the bread Monster add-on seems to be buggy with this update, you might want to wait until its programmer updates it</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/10/2013 - a couple fixes</div>'+
	'<div class="listing">&bull; golden breads should no longer spawn embarrassingly often</div>'+
	...
	'<div class="listing">&bull; golden bread chains work a bit differently</div>'+
	'<div class="listing">&bull; golden bread spawns are more random</div>'+
	'<div class="listing">&bull; CpS achievements are no longer affected by golden bread frenzies</div>'+
	'<div class="listing">&bull; revised bread-baking achievement requirements</div>'+
	'<div class="listing">&bull; heavenly chips now require upgrades to function at full capacity</div>'+
	'<div class="listing">&bull; added 4 more bread upgrades, unlocked after reaching certain amounts of Heavenly Chips</div>'+
	...
	'<div class="listing">&bull; bread chains have different capping mechanics</div>'+
	...
	'<div class="listing">&bull; dungeons still need a bit more work and will be released soon - we want them to be just right! (you can test an unfinished version in <a href="//orteil.dashnet.org/breadclicker/betadungeons/" target="_blank">the beta</a>)</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">28/09/2013 - dungeon beta</div>'+
	'<div class="listing">&bull; from now on, big updates will come through a beta stage first (you can <a href="//orteil.dashnet.org/breadclicker/betadungeons/" target="_blank">try it here</a>)</div>'+
	'<div class="listing">&bull; first dungeons! (you need 50 factories to unlock them!)</div>'+
	'<div class="listing">&bull; bread chains can be longer</div>'+
	'<div class="listing">&bull; antimatter condensers are a bit more expensive</div>'+
	'<div class="listing">&bull; heavenly chips now only give +1% cps each (to account for all the breads made from condensers)</div>'+
	'<div class="listing">&bull; added flavor text on all upgrades</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">15/09/2013 - antibreads</div>'+
	'<div class="listing">&bull; ran out of regular matter to make your breads? Try our new antimatter condensers!</div>'+
	'<div class="listing">&bull; renamed Hard-reset to "Wipe save" to avoid confusion</div>'+
	'<div class="listing">&bull; reset achievements are now regular achievements and require breads baked all time, not breads in bank</div>'+
	...
	'<div class="listing">&bull; golden bread clicks are no longer reset by soft-resets</div>'+
	'<div class="listing">&bull; you can now see how long you\'ve been playing in the stats</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">08/09/2013 - everlasting breads</div>'+
	'<div class="listing">&bull; added a prestige system - resetting gives you permanent CpS boosts (the more breads made before resetting, the bigger the boost!)</div>'+
	'<div class="listing">&bull; save format has been slightly modified to take less space</div>'+
	'<div class="listing">&bull; Leprechaun has been bumped to 777 golden breads clicked and is now shadow; Fortune is the new 77 golden breads achievement</div>'+
	'<div class="listing">&bull; clicking frenzy is now x777</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">04/09/2013 - smarter bread</div>'+
	'<div class="listing">&bull; golden breads only have 20% chance of giving the same outcome twice in a row now</div>'+
	'<div class="listing">&bull; added a golden bread upgrade</div>'+
	...
	'<div class="listing">&bull; raspberry juice is now named raspberry milk, despite raspberry juice being delicious and going unquestionably well with breads</div>'+
	'<div class="listing">&bull; HOTFIX : cursors now click; fancy graphics button renamed; breads amount now more visible against cursors</div>'+
	...
	'<div class="listing">&bull; "golden" bread now appears again during grandmapocalypse; Elder Pledge-related achievements are now unlockable</div>'+
	...
	'<div class="listing">&bull; reworked the "Bake X breads" achievements so they take longer to achieve</div>'+
	...
	'<div class="listing">&bull; added some more upgrades (including a couple golden bread-related ones)</div>'+
	...
	'<div class="listing">&bull; added some more bread upgrades</div>'+
	'<div class="listing">&bull; added CpS for cursors</div>'+
	'<div class="listing">&bull; added sell button</div>'+
	'<div class="listing">&bull; made golden bread more useful</div>'+
	...
	Game.ErrorFrame=function()
	{
		...
		'<div>It looks like you\'re accessing bread Clicker from another URL than the official one.<br>'+
		'You can <a href="//orteil.dashnet.org/breadclicker/" target="_blank">play bread Clicker over here</a>!<br>'+
	...
	Game.Init=function()
	{
		...
		Game.SaveTo='breadClickerGame';
		if (Game.beta) Game.SaveTo='breadClickerGameBeta';
		...
		//l('links').innerHTML=(Game.beta?'<a href="../" target="blank">Live version</a> | ':'<a href="beta" target="blank">Try the beta!</a> | ')+'<a href="http://orteil.dashnet.org/experiments/bread/" target="blank">Classic</a>';
		//l('links').innerHTML='<a href="http://orteil.dashnet.org/experiments/bread/" target="blank">bread Clicker Classic</a>';
		...
		Game.breadsEarned=0;//all breads earned during gameplay
		Game.breads=0;//breads
		Game.breadsd=0;//breads display
		Game.breadsPs=1;//breads per second (to recalculate with every new purchase)
		Game.breadsPsRaw=0;//raw breads per second
		Game.breadsPsRawHighest=0;//highest raw breads per second this ascension
		Game.breadsReset=0;//breads lost to resetting (used to determine prestige and heavenly chips)
		Game.breadClicks=0;//+1 for each click on the bread
		Game.goldenClicks=0;//+1 for each golden bread clicked (all time)
		Game.goldenClicksLocal=0;//+1 for each golden bread clicked (this game only)
		Game.missedGoldenClicks=0;//+1 for each golden bread missed
		Game.handmadebreads=0;//all the breads made from clicking the bread
		...
		Game.chimeType=0;//golden bread chime
		Game.prestige=0;//prestige level (recalculated depending on Game.breadsReset)
		...
		Game.heavenlyChipsSpent=0;//heavenly chips spent on breads, upgrades and such
		Game.heavenlybreads=0;//how many breads have we baked from chips (unused)
		...
		Game.researchT=0;
		Game.nextResearch=0;
		Game.breadsSucked=0;//breads sucked by wrinklers
		...
		Game.lastDate=parseInt(Date.now());//when we last saved the game (used to compute "breads made since we closed the game" etc)
		
		Game.prefs=[];
		Game.DefaultPrefs=function()
		{
			Game.prefs.particles=1;//particle effects : falling breads etc
			Game.prefs.numbers=1;//numbers that pop up when clicking the bread
			...
			Game.prefs.wobbly=1;//wobbly bread
			Game.prefs.monospace=0;//alt monospace font for breads
			Game.prefs.filters=0;//CSS filter effects (might be heavy on some browsers)
			Game.prefs.breadsound=1;//use new bread click sound
		...
		window.onbeforeunload=function(event)
		{
			if (Game.prefs && Game.prefs.warn)
			{
				...
				if (event) event.returnValue='Are you sure you want to close bread Clicker?';
			}
		}
		...
		{
			Game.Notify('Back up your save!','Hello again! Just a reminder that you may want to back up your bread Clicker save every once in a while, just in case.<br>To do so, go to Options and hit "Export save" or "Save to file"!<div class="line"></div><a style="float:right;" onclick="Game.prefs.showBackupWarning=0;==CLOSETHIS()==">Don\'t show this again</a>',[25,7]);
		}
		...
		/*
			...
			-hooks are functions the game calls automatically in certain circumstances, like when calculating breads per click or when redrawing the screen
			...
			-list of valid hook ids:
				...
				'breadsPerClick' - called when determining the breads per click; parameter is the current value; should return the modified value
				'click' - called when the big bread is clicked
		...
		*/
		...
		Game.modSaveData={};
		Game.modHooks={};
		Game.modHooksNames=['logic','draw','reset','reincarnate','ticker','cps','breadsPerClick','click','create','check'];
		...
		if (false)
		{
			...
			Game.registerMod('test mod',{
				/*
					...
					-double your CpS
					-display a little popup for half a second whenever you click the big bread
				...
				*/
				...
				addIntro:function(text){
					...
					Game.playerIntro=text||choose(['oh snap, it\'s','watch out, it\'s','oh no! here comes','hide your breads, for here comes','behold! it\'s']);
		...
		//replacing an existing canvas picture with a new one at runtime : Game.Loader.Replace('perfectbread.png','imperfectbread.png');
		...
		Game.attachTooltip(l('httpsSwitch'),'<div style="padding:8px;width:350px;text-align:center;font-size:11px;">You are currently playing bread Clicker on the <b>'+(Game.https?'HTTPS':'HTTP')+'</b> protocol.<br>The <b>'+(Game.https?'HTTP':'HTTPS')+'</b> version uses a different save slot than this one.<br>Click this lock to reload the page and switch to the <b>'+(Game.https?'HTTP':'HTTPS')+'</b> version!</div>','this');
		...
		Game.attachTooltip(l('topbarDiscord'),'<div style="padding:8px;width:250px;text-align:center;">Our official discord server.<br>You can share tips and questions about bread Clicker and all our other games!</div>','this');
		Game.attachTooltip(l('topbarPatreon'),'<div style="padding:8px;width:250px;text-align:center;">Support us on Patreon and help us keep updating bread Clicker!<br>There\'s neat rewards for patrons too!</div>','this');
		Game.attachTooltip(l('topbarMerch'),'<div style="padding:8px;width:250px;text-align:center;">bread Clicker shirts, hoodies and stickers!</div>','this');
		Game.attachTooltip(l('topbarMobileCC'),'<div style="padding:8px;width:250px;text-align:center;">Play bread Clicker on your phone!<br>(Android only; iOS version will be released later)</div>','this');
		...
		//window.localStorage.clear();//won't switch back to bread-based if there is localStorage info
		...
		Game.WriteSave=function(type)
		{
			...
			if (type==3) str+='\n\nMisc game data';
			str+=
			(type==3?'\n	breads : ':'')+parseFloat(Game.breads).toString()+';'+
			(type==3?'\n	total breads earned : ':'')+parseFloat(Game.breadsEarned).toString()+';'+
			(type==3?'\n	bread clicks : ':'')+parseInt(Math.floor(Game.breadClicks))+';'+
			(type==3?'\n	golden bread clicks : ':'')+parseInt(Math.floor(Game.goldenClicks))+';'+
			(type==3?'\n	breads made by clicking : ':'')+parseFloat(Game.handmadebreads).toString()+';'+
			(type==3?'\n	golden breads missed : ':'')+parseInt(Math.floor(Game.missedGoldenClicks))+';'+
			(type==3?'\n	background type : ':'')+parseInt(Math.floor(Game.bgType))+';'+
			(type==3?'\n	milk type : ':'')+parseInt(Math.floor(Game.milkType))+';'+
			(type==3?'\n	breads from past runs : ':'')+parseFloat(Game.breadsReset).toString()+';'+
			...
			(type==3?'\n	golden bread clicks (this run) : ':'')+parseInt(Math.floor(Game.goldenClicksLocal))+';'+
			(type==3?'\n	breads sucked by wrinklers : ':'')+parseFloat(Game.breadsSucked).toString()+';'+
			...
			str+=
			(type==3?'\n	amount of breads contained in wrinklers : ':'')+parseFloat(Math.floor(wrinklers.amount))+';'+
			...
			(type==3?'\n	heavenly breads : ':'')+parseFloat(Game.heavenlybreads).toString()+';'+
			...
			(type==3?'\n	amount of breads contained in shiny wrinklers : ':'')+parseFloat(Math.floor(wrinklers.amountShinies))+';'+
			...
			(type==3?'\n	golden bread fortune : ':'')+parseInt(Game.fortuneGC)+';'+
			(type==3?'\n	CpS fortune : ':'')+parseInt(Game.fortuneCPS)+';'+
			(type==3?'\n	highest raw CpS : ':'')+parseFloat(Game.breadsPsRawHighest)+';'+
			'|';//breads and lots of other stuff
			
			if (type==3) str+='\n\nBuildings : amount, bought, breads produced, level, minigame data';
			for (var i in Game.Objects)//buildings
			{
				...
				if (me.vanilla)
				{
					str+=me.amount+','+me.bought+','+parseFloat(Math.floor(me.totalbreads))+','+parseInt(me.level);
			...
			else
			{
				...
				{
					//so we used to save the game using browser breads, which was just really neat considering the game's name
				...
				else//legacy system
				{
					...
					now.setFullYear(now.getFullYear()+5);//mmh stale breads
					str=utf8_to_b64(str)+'!END!';
					Game.saveData=escape(str);
					str=Game.SaveTo+'='+escape(str)+'; expires='+now.toUTCString()+';';
					document.bread=str;//aaand save
					if (document.bread.indexOf(Game.SaveTo)<0)
					{
						if (Game.prefs.popups) Game.Popup('Error while saving.<br>Export your save instead!');
		...
		{
			//for when bread Clicker won't load and you need your save
			console.log('===================================================');
		...
		Game.LoadSave=function(data)
		{
			...
			else
			{
				if (Game.useLocalStorage)
				{
					...
					if (!local)//no localstorage save found? let's get the bread one last time
					{
						if (document.bread.indexOf(Game.SaveTo)>=0)
						{
							str=unescape(document.bread.split(Game.SaveTo+'=')[1]);
							document.bread=Game.SaveTo+'=;expires=Thu, 01 Jan 1970 00:00:01 GMT;';
						}
						else return false;
					}
					else
				...
				{
					if (document.bread.indexOf(Game.SaveTo)>=0) str=unescape(document.bread.split(Game.SaveTo+'=')[1]);//get bread here
					else return false;
				}
			}
			if (str!='')
			{
				...
				if (str!='')
				{
					...
					if (version>=1)
					{
						...
						Game.prefs.breadsound=spl[14]?parseInt(spl[14]):1;
						...
						BeautifyAll();
						spl=str[4].split(';');//breads and lots of other stuff
						Game.breads=parseFloat(spl[0]);
						Game.breadsEarned=parseFloat(spl[1]);
						Game.breadClicks=spl[2]?parseInt(spl[2]):0;
						Game.goldenClicks=spl[3]?parseInt(spl[3]):0;
						Game.handmadebreads=spl[4]?parseFloat(spl[4]):0;
						Game.missedGoldenClicks=spl[5]?parseInt(spl[5]):0;
						Game.bgType=spl[6]?parseInt(spl[6]):0;
						Game.milkType=spl[7]?parseInt(spl[7]):0;
						Game.breadsReset=spl[8]?parseFloat(spl[8]):0;
						...
						Game.breadsSucked=spl[16]?parseFloat(spl[16]):0;
						...
						Game.heavenlybreads=spl[28]?parseFloat(spl[28]):0;
						...
						//if (version<1.05) {Game.heavenlyChipsEarned=Game.HowMuchPrestige(Game.breadsReset);Game.heavenlyChips=Game.heavenlyChipsEarned;}
						...
						Game.breadsPsRawHighest=spl[51]?parseFloat(spl[51]):0;
						...
						for (var i in Game.ObjectsById)
						{
							...
							if (spl[i])
							{
								...
								me.amount=parseInt(mestr[0]);me.bought=parseInt(mestr[1]);me.totalbreads=parseFloat(mestr[2]);me.level=parseInt(mestr[3]||0);me.highest=(version>=2.024?parseInt(mestr[6]):me.amount);
							...
							{
								me.amount=0;me.unlocked=0;me.bought=0;me.highest=0;me.totalbreads=0;me.level=0;
							}
						}
						...
						//recompute prestige
						Game.prestige=Math.floor(Game.HowMuchPrestige(Game.breadsReset));
						...
						{
							window.localStorage.setItem('breadClickerGameBetaDungeons',window.localStorage.getItem('breadClickerGameBeta'));
						...
						{
							window.localStorage.setItem('breadClickerGameOld',window.localStorage.getItem('breadClickerGameBeta'));
						...
						{
							window.localStorage.setItem('breadClickerGamev10466',window.localStorage.getItem('breadClickerGame'));
						...
						//compute breads earned while the game was closed
						if (Game.mobile || Game.Has('Perfect idling') || Game.Has('Twin Gates of Transcendence'))
						{
							...
							var amount=(timeOfflineOptimal+timeOfflineReduced*0.1)*Game.breadsPs*(percent/100);
							
							if (amount>0)
							{
								if (Game.prefs.popups) Game.Popup('Earned '+Beautify(amount)+' bread'+(Math.floor(amount)==1?'':'s')+' while you were away');
								else Game.Notify('Welcome back!','You earned <b>'+Beautify(amount)+'</b> bread'+(Math.floor(amount)==1?'':'s')+' while you were away.<br>('+Game.sayTime(timeOfflineOptimal*Game.fps,-1)+' at '+Math.floor(percent)+'% CpS'+(timeOfflineReduced?', plus '+Game.sayTime(timeOfflineReduced*Game.fps,-1)+' at '+(Math.floor(percent*10)/100)+'%':'')+'.)',[Math.floor(Math.random()*16),11]);
								Game.Earn(amount);
							}
						}
					...
					if (Game.T>Game.fps*5 && Game.ReincarnateTimer==0)//fade out of black and pop the bread
					{
					...
					{
						if (Game.season=='valentines') Game.Notify('Valentine\'s Day!','It\'s <b>Valentine\'s season</b>!<br>Love\'s in the air and breads are just that much sweeter!',[20,3],60*3);
						...
						else if (Game.season=='christmas') Game.Notify('Christmas time!','It\'s <b>Christmas season</b>!<br>Bring good cheer to all and you just may get breads in your stockings!',[12,10],60*3);
		...
		Game.Reset=function(hard)
		{
			...
			var breadsForfeited=Game.breadsEarned;
			if (!hard)
			{
				if (breadsForfeited>=1000000) Game.Win('Sacrifice');
				if (breadsForfeited>=1000000000) Game.Win('Oblivion');
				if (breadsForfeited>=1000000000000) Game.Win('From scratch');
				if (breadsForfeited>=1000000000000000) Game.Win('Nihilism');
				if (breadsForfeited>=1000000000000000000) Game.Win('Dematerialize');
				if (breadsForfeited>=1000000000000000000000) Game.Win('Nil zero zilch');
				if (breadsForfeited>=1000000000000000000000000) Game.Win('Transcendence');
				if (breadsForfeited>=1000000000000000000000000000) Game.Win('Obliterate');
				if (breadsForfeited>=1000000000000000000000000000000) Game.Win('Negative void');
				if (breadsForfeited>=1000000000000000000000000000000000) Game.Win('To crumbs, you say?');
				if (breadsForfeited>=1000000000000000000000000000000000000) Game.Win('You get nothing');
				if (breadsForfeited>=1000000000000000000000000000000000000000) Game.Win('Humble rebeginnings');
				if (breadsForfeited>=1000000000000000000000000000000000000000000) Game.Win('The end of the world');
				if (breadsForfeited>=1000000000000000000000000000000000000000000000) Game.Win('Oh, you\'re back');
				if (breadsForfeited>=1000000000000000000000000000000000000000000000000) Game.Win('Lazarus');
				if (breadsForfeited>=1000000000000000000000000000000000000000000000000000) Game.Win('Smurf account');
				if (breadsForfeited>=1000000000000000000000000000000000000000000000000000000) Game.Win('If at first you don\'t succeed');
				
				if (Math.round(Game.breads)==1000000000000) Game.Win('When the breads ascend just right');
			}
			...
			Game.breadsReset+=Game.breadsEarned;
			Game.breads=0;
			Game.breadsEarned=0;
			Game.breadClicks=0;
			...
			Game.handmadebreads=0;
			Game.breadsPsRawHighest=0;
			if (hard)
			{
				Game.bgType=0;
				Game.milkType=0;
			...
			{
				var me=Game.ObjectsById[i];
				me.amount=0;me.bought=0;me.highest=0;me.free=0;me.totalbreads=0;
				me.switchMinigame(false);
				if (hard) {me.muted=0;}
				me.pics=[];
				me.refresh();
			...
			if (hard)
			{
				...
				else Game.Notify('Game reset','So long, breads.',[21,6],6);
			}
		}
		...
		Game.crateTooltip=function(me,context)
		{
			...
			if (me.type=='upgrade')
			{
				...
				else if (me.pool=='bread') tags.push('bread',0);
		...
		Game.costDetails=function(cost)
		{
			...
			if (!cost) return '';
			var priceInfo='';
			var cps=Game.breadsPs*(1-Game.cpsSucked);
			if (cost>Game.breads) priceInfo+='in '+Game.sayTime(((cost-Game.breads)/cps+1)*Game.fps)+'<br>';
			priceInfo+=Game.sayTime((cost/cps+1)*Game.fps)+' worth<br>';
			priceInfo+=Beautify((cost/Game.breads)*100,1)+'% of bank<br>';
		...
		Game.HCfactor=3;
		Game.HowMuchPrestige=function(breads)//how much prestige [breads] should land you
		{
			return Math.pow(breads/1000000000000,1/Game.HCfactor);
		}
		Game.HowManybreadsReset=function(chips)//how many breads [chips] are worth
		{
			//this must be the inverse of the above function (ie. if breads=chips^2, chips=breads^(1/2) )
			return Math.pow(chips,Game.HCfactor)*1000000000000;
		}
		Game.gainedPrestige=0;
		Game.EarnHeavenlyChips=function(breadsForfeited)
		{
			//recalculate prestige and chips owned
			var prestige=Math.floor(Game.HowMuchPrestige(Game.breadsReset+breadsForfeited));
			if (prestige>Game.prestige)//did we gain prestige levels?
			{
				...
				else Game.Notify('You forfeit your '+Beautify(breadsForfeited)+' breads.','You gain <b>'+Beautify(prestigeDifference)+'</b> prestige level'+(prestigeDifference==1?'':'s')+'!',[19,7]);
			}
		}
		...
		Game.GetHeavenlyMultiplier=function()
		{
			...
			if (Game.Has('Heavenly bread stand')) heavenlyMult+=0.20;
		...
		2:{name:'Trigger finger',desc:'In this run, scrolling your mouse wheel on the bread counts as clicking it. Some upgrades introduce new clicking behaviors.<br>No clicking achievements may be obtained in this mode.<div class="line"></div>Reaching 1 quadrillion breads in this mode unlocks a special heavenly upgrade.',icon:[12,0]}*/
		};
		...
		Game.UpdateLegacyPrompt=function()
		{
			...
			var ascendNowToGet=Math.floor(Game.HowMuchPrestige(Game.breadsReset+Game.breadsEarned)-Game.HowMuchPrestige(Game.breadsReset));
			var breadsToNext=Math.floor(Game.HowManybreadsReset(Game.HowMuchPrestige(Game.breadsReset+Game.breadsEarned)+1)-Game.breadsReset-Game.breadsEarned);
			l('legacyPromptData').innerHTML=''+
				...
				//'<div class="listing">Earned : '+Beautify(Game.breadsEarned)+', Reset : '+Beautify(Game.breadsReset)+'</div>'+
				...
				('<div class="listing warning"><b>'+Beautify(breadsToNext)+'</b> more bread'+((breadsToNext)==1?'':'s')+' for the next prestige level.<br>You may ascend now, but will gain no benefits.</div>'))+
			'';
		...
		l('ascendOverlay').innerHTML=
			...
			'<div class="ascendData smallFramed prompt" '+Game.getTooltip(
							'<div style="min-width:300px;text-align:center;font-size:11px;">Each prestige level grants you a permanent <b>+1% CpS</b>.<br>The more levels you have, the more breads they require.</div>'
		...
		Game.AscendBreakpoint=Game.AscendDuration*0.5;//at which point the bread explodes during the ascend animation
		Game.UpdateAscendIntro=function()
		{
			...
			if (Game.AscendTimer>Game.AscendDuration)//end animation and launch ascend screen
			{
				...
				Game.EarnHeavenlyChips(Game.breadsEarned);
				Game.AscendTimer=0;
		...
		Game.Reincarnate=function(bypass)
		{
			...
			else
			{
				...
				if (Game.HasAchiev('Rebirth'))
				{
					...
					else Game.Notify('Reincarnated','Hello, breads!',[10,0],4);
				}
		...
		{
			if (!bypass) Game.Prompt('<h3>Ascend</h3><div class="block">Do you REALLY want to ascend?<div class="line"></div>You will lose your progress and start over from scratch.<div class="line"></div>All your breads will be converted into prestige and heavenly chips.<div class="line"></div>You will keep your achievements'+(Game.canLumps()?', building levels and sugar lumps':'')+'.</div>',[['Yes!','Game.ClosePrompt();Game.Ascend(1);'],'No']);
			else
			{
				if (Game.prefs.popups) Game.Popup('Ascending');
				else Game.Notify('Ascending','So long, breads.',[20,7],4);
		...
		Game.lumpTooltip=function()
		{
			...
			if (phase>=3)
			{
				...
				else if (Game.lumpCurrentType==2) str+='This sugar lump grew to be <b>golden</b>; harvesting it will yield 2 to 7 lumps, your current breads will be doubled (capped to a gain of 24 hours of your CpS), and you will find 10% more golden breads for the next 24 hours.';
		...
		Game.harvestLumps=function(amount,silent)
		{
			...
			else if (Game.lumpCurrentType==2)
			{
				...
				Game.Earn(Math.min(Game.breadsPs*60*60*24,Game.breads));
				if (Game.prefs.popups) Game.Popup('Sugar blessing activated!');
				else Game.Notify('Sugar blessing activated!','Your breads have been doubled.<br>+10% golden breads for the next 24 hours.',[29,16]);
			}
		...
		{
			if (Game.lumpsTotal>-1 || (Game.ascensionMode!=1 && (Game.breadsEarned+Game.breadsReset)>=1000000000)) return true;
			return false;
		}
		...
		Game.doLumps=function()
		{
			...
			if (Game.lumpsTotal==-1)
			{
				...
				Game.Notify('Sugar lumps!','Because you\'ve baked a <b>billion breads</b> in total, you are now attracting <b>sugar lumps</b>. They coalesce quietly near the top of your screen, under the Stats button.<br>You will be able to harvest them when they\'re ripe, after which you may spend them on all sorts of things!',[23,14]);
			}
			var age=Date.now()-Game.lumpT;
		...
		Game.Dissolve=function(howmuch)
		{
			Game.breads-=howmuch;
			Game.breadsEarned-=howmuch;
			Game.breads=Math.max(0,Game.breads);
			Game.breadsEarned=Math.max(0,Game.breadsEarned);
		}
		Game.mouseCps=function()
		{
			...
			add=add*num;
			if (Game.Has('Plastic mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Iron mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Titanium mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Adamantium mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Unobtainium mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Eludium mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Wishalloy mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Fantasteel mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Nevercrack mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Armythril mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Technobsidian mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Plasmarble mouse')) add+=Game.breadsPs*0.01;
			if (Game.Has('Miraculite mouse')) add+=Game.breadsPs*0.01;
			
			if (Game.Has('Fortune #104')) add+=Game.breadsPs*0.01;
			var mult=1;
			
			
			if (Game.Has('Santa\'s helpers')) mult*=1.1;
			if (Game.Has('bread egg')) mult*=1.1;
			...
			out=Game.runModHookOnValue('breadsPerClick',out);
		...
		Game.BigbreadState=0;//0 = normal, 1 = clicked (small), 2 = released/hovered (big)
		Game.BigbreadSize=0;
		Game.BigbreadSizeD=0;
		Game.BigbreadSizeT=1;
		Game.breadClickSound=Math.floor(Math.random()*7)+1;
		Game.playbreadClickSound=function()
		{
			if (Game.prefs.breadsound) PlaySound('snd/clickb'+(Game.breadClickSound)+'.mp3',0.5);
			else PlaySound('snd/click'+(Game.breadClickSound)+'.mp3',0.5);
			Game.breadClickSound+=Math.floor(Math.random()*4)+1;
			if (Game.breadClickSound>7) Game.breadClickSound-=7;
		}
		Game.Clickbread=function(e,amount)
		{
			var now=Date.now();
		...
		var bigbread=l('bigbread');
		bigbread.setAttribute('alt','Big clickable bread');
		Game.Click=0;
		...
		if (!Game.touchEvents)
		{
			AddEvent(bigbread,'click',Game.Clickbread);
			AddEvent(bigbread,'mousedown',function(event){Game.BigbreadState=1;if (Game.prefs.breadsound) {Game.playbreadClickSound();}if (event) event.preventDefault();});
			AddEvent(bigbread,'mouseup',function(event){Game.BigbreadState=2;if (event) event.preventDefault();});
			AddEvent(bigbread,'mouseout',function(event){Game.BigbreadState=0;});
			AddEvent(bigbread,'mouseover',function(event){Game.BigbreadState=2;});
		...
		{
			//touch events
			AddEvent(bigbread,'touchend',Game.Clickbread);
			AddEvent(bigbread,'touchstart',function(event){Game.BigbreadState=1;if (event) event.preventDefault();});
			AddEvent(bigbread,'touchend',function(event){Game.BigbreadState=0;if (event) event.preventDefault();});
		...
		Game.CalculateGains=function()
		{
			...
			for (var i in Game.breadUpgrades)
			{
				var me=Game.breadUpgrades[i];
				if (Game.Has(me.name))
				{
			...
			var milkMult=1;
			if (Game.Has('Santa\'s milk and breads')) milkMult*=1.05;
			...
			Game.breadsMultByType['kittens']=catMult;
			...
			for (var i in Game.Objects)
			{
				...
				Game.breadsPs+=me.storedTotalCps;
				Game.breadsPsByType[me.name]=me.storedTotalCps;
			}
			//cps from buildings only
			Game.buildingCps=Game.breadsPs;
			
			if (Game.Has('"egg"')) {Game.breadsPs+=9;Game.breadsPsByType['"egg"']=9;}//"egg"
			...
			Game.breadsMultByType['eggs']=eggMult;
			mult*=eggMult;
			...
			var rawbreadsPs=Game.breadsPs*mult;
			for (var i in Game.CpsAchievements)
			{
				if (rawbreadsPs>=Game.CpsAchievements[i].threshold) Game.Win(Game.CpsAchievements[i].name);
			}
			Game.breadsPsRaw=rawbreadsPs;
			Game.breadsPsRawHighest=Math.max(Game.breadsPsRawHighest,rawbreadsPs);
			...
			if (Game.Has('Golden switch [off]'))
			{
				...
				{
					var upgrades=Game.goldenbreadUpgrades;
			...
			Game.breadsPs=Game.runModHookOnValue('cps',Game.breadsPs);
			
			
			//cps without golden bread effects
			Game.unbuffedCps=Game.breadsPs*mult;
			...
			Game.breadsPs*=Game.globalCpsMult;
			
			//if (Game.hasBuff('Cursed finger')) Game.breadsPs=0;
		...
		Game.updateShimmers=function()//run shimmer functions, kill overtimed shimmers and spawn new ones
		{
			...
			//bread storm!
			if (Game.hasBuff('bread storm') && Math.random()<0.5)
			{
				...
				newShimmer.force='bread storm drop';
		...
		Game.shimmerTypes={
			...
			'golden':{
				...
				initFunc:function(me)
				{
					...
					{
						me.wrath=1;
						if (Game.season=='halloween') bgPic='img/spookybread.png';
						else bgPic='img/wrathbread.png';
					}
					else
					{
						me.wrath=0;
					...
					me.l.setAttribute('alt',me.wrath?'Wrath bread':'Golden bread');
					
					me.life=1;//the bread's current progression through its lifespan (in frames)
					me.dur=13;//duration; the bread's lifespan in seconds before it despawns
					...
					if (!me.wrath) dur*=Game.eff('goldenbreadDur');
					else dur*=Game.eff('wrathbreadDur');
					dur*=Math.pow(0.95,Game.shimmerTypes['golden'].n-1);//5% shorter for every other golden bread on the screen
				...
				updateFunc:function(me)
				{
					...
					//this line makes each golden bread pulse in a unique way
				...
				popFunc:function(me)
				{
					...
					if (me.spawnLead)
					{
						...
						if (Game.goldenClicks>=1) Game.Win('Golden bread');
						if (Game.goldenClicks>=7) Game.Win('Lucky bread');
					...
					//select an effect
					var list=[];
					if (me.wrath>0) list.push('clot','multiply breads','ruin breads');
					else list.push('frenzy','multiply breads');
					if (me.wrath>0 && Game.hasGod && Game.hasGod('scorn')) list.push('clot','ruin breads','clot','ruin breads');
					if (me.wrath>0 && Math.random()<0.3) list.push('blood frenzy','chain bread','bread storm');
					else if (Math.random()<0.03 && Game.breadsEarned>=100000) list.push('chain bread','bread storm');
					...
					if (this.chain>0) choice='chain bread';
					if (me.force!='') {this.chain=0;choice=me.force;me.force='';}
					if (choice!='chain bread') this.chain=0;
					...
					if (!me.wrath) effectDurMod*=Game.eff('goldenbreadEffDur');
					else effectDurMod*=Game.eff('wrathbreadEffDur');
					...
					if (!me.wrath) mult*=Game.eff('goldenbreadGain');
					else mult*=Game.eff('wrathbreadGain');
					...
					else if (choice=='multiply breads')
					{
						var moni=mult*Math.min(Game.breads*0.15,Game.breadsPs*60*15)+13;//add 15% to breads owned (+13), or 15 minutes of bread production - whichever is lowest
						Game.Earn(moni);
						popup='Lucky!<div style="font-size:65%;">+'+Beautify(moni)+' breads!</div>';
					}
					else if (choice=='ruin breads')
					{
						var moni=Math.min(Game.breads*0.05,Game.breadsPs*60*10)+13;//lose 5% of breads owned (-13), or 10 minutes of bread production - whichever is lowest
						moni=Math.min(Game.breads,moni);
						Game.Spend(moni);
						popup='Ruin!<div style="font-size:65%;">Lost '+Beautify(moni)+' breads!</div>';
					}
					...
					{
						buff=Game.gainBuff('cursed finger',Math.ceil(10*effectDurMod),Game.breadsPs*Math.ceil(10*effectDurMod));
					}
					...
					else if (choice=='chain bread')
					{
						//fix by Icehawk78
						if (this.chain==0) this.totalFromChain=0;
						this.chain++;
						var digit=me.wrath?6:7;
						if (this.chain==1) this.chain+=Math.max(0,Math.ceil(Math.log(Game.breads)/Math.LN10)-10);
						
						var maxPayout=Math.min(Game.breadsPs*60*60*6,Game.breads*0.5)*mult;
						...
						{
							this.chain=0;
							popup='bread chain<div style="font-size:65%;">+'+moniStr+' breads!<br>bread chain over. You made '+Beautify(this.totalFromChain)+' breads.</div>';
						}
						else
						{
							popup='bread chain<div style="font-size:65%;">+'+moniStr+' breads!</div>';//
						}
						Game.Earn(moni);
					}
					else if (choice=='bread storm')
					{
						buff=Game.gainBuff('bread storm',Math.ceil(7*effectDurMod),7);
					}
					else if (choice=='bread storm drop')
					{
						var moni=Math.max(mult*(Game.breadsPs*60*Math.floor(Math.random()*7+1)),Math.floor(Math.random()*7+1));//either 1-7 breads or 1-7 minutes of bread production, whichever is highest
						Game.Earn(moni);
						popup='<div style="font-size:75%;">+'+Beautify(moni)+' breads!</div>';
					}
					else if (choice=='blab')//sorry (it's really rare)
					{
						var str=choose([
						'bread crumbliness x3 for 60 seconds!',
						'Chocolatiness x7 for 77 seconds!',
						'Dough elasticity halved for 66 seconds!',
						'Golden bread shininess doubled for 3 seconds!',
						'World economy halved for 30 seconds!',
						'Grandma kisses 23% stingier for 45 seconds!',
						'Thanks for clicking!',
						'Fooled you! This one was just a test.',
						'Golden breads clicked +1!',
						'Your click has been registered. Thank you for your cooperation.',
						'Thanks! That hit the spot!',
						'Thank you. A team has been dispatched.',
						'They know.',
						'Oops. This was just a chocolate bread with shiny aluminium foil.'
						]);
						popup=str;
					}
					...
					if (choice=='bread storm drop')
					{
						if (Game.prefs.breadsound) PlaySound('snd/clickb'+Math.floor(Math.random()*7+1)+'.mp3',0.75);
				...
				missFunc:function(me)
				{
					if (this.chain>0 && this.totalFromChain>0)
					{
						Game.Popup('bread chain broken.<div style="font-size:65%;">You made '+Beautify(this.totalFromChain)+' breads.</div>',me.x+me.l.offsetWidth/2,me.y);
				...
				getTimeMod:function(me,m)
				{
					...
					if (!me.wrath) m*=1/Game.eff('goldenbreadFreq');
					else m*=1/Game.eff('wrathbreadFreq');
					if (Game.hasGod)
					{
						var godLvl=Game.hasGod('industry');
						if (godLvl==1) m*=1.1;
			...
			'reindeer':{
				...
				initFunc:function(me)
				{
					...
					me.dur=4;//duration; the bread's lifespan in seconds before it despawns
				...
				popFunc:function(me)
				{
					...
					var val=Game.breadsPs*60;
					if (Game.hasBuff('Elder frenzy')) val*=0.5;//very sorry
					if (Game.hasBuff('Frenzy')) val*=0.75;//I sincerely apologize
					var moni=Math.max(25,val);//1 minute of bread production, or 25 breads - whichever is highest
					...
					if (Math.random()>failRate)//christmas bread drops
					{
						bread=choose(['Christmas tree biscuits','Snowflake biscuits','Snowman biscuits','Holly biscuits','Candy cane biscuits','Bell biscuits','Present biscuits']);
						if (!Game.HasUnlocked(bread) && !Game.Has(bread))
						{
							Game.Unlock(bread);
						}
						else bread='';
					...
					if (Game.prefs.popups) Game.Popup('You found '+choose(['Dasher','Dancer','Prancer','Vixen','Comet','Cupid','Donner','Blitzen','Rudolph'])+'!<br>The reindeer gives you '+Beautify(moni)+' breads.'+(bread==''?'':'<br>You are also rewarded with '+bread+'!'));
					else Game.Notify('You found '+choose(['Dasher','Dancer','Prancer','Vixen','Comet','Cupid','Donner','Blitzen','Rudolph'])+'!','The reindeer gives you '+Beautify(moni)+' breads.'+(bread==''?'':'<br>You are also rewarded with '+bread+'!'),[12,9],6);
					popup='<div style="font-size:80%;">+'+Beautify(moni)+' breads!</div>';
		...
		Game.goldenbreadChoices=[
			"Frenzy","frenzy",
			"Lucky","multiply breads",
			"Ruin","ruin breads",
			"Elder frenzy","blood frenzy",
			"Clot","clot",
			"Click frenzy","click frenzy",
			"Cursed finger","cursed finger",
			"bread chain","chain bread",
			"bread storm","bread storm",
		...
		PARTICLES
		=======================================================================================*/
		//generic particles (falling breads etc)
		//only displayed on left section
		Game.particles=[];
		Game.particlesN=50;
		for (var i=0;i<Game.particlesN;i++)
		{
			Game.particles[i]={x:0,y:0,xd:0,yd:0,w:64,h:64,z:0,size:1,dur:2,life:-1,r:0,pic:'smallbreads.png',picId:0,picPos:[0,0]};
		}
			...
			if (1 || Game.prefs.particles)
			{
				...
				if (!pic)
				{
					...
					else
					{
						...
						{
							var bread=Game.Upgrades[i];
							if (bread.bought>0 && bread.pool=='bread') breads.push(bread.icon);
						}
						me.picPos=choose(breads);
						if (Game.bakeryName.toLowerCase()=='ortiel' || Math.random()<1/10000) me.picPos=[17,5];
						pic='icons.png';
					}
				}
				else if (pic!=='string'){me.picPos=pic;pic='icons.png';}
				me.pic=pic||'smallbreads.png';
				me.text=text||0;
				return me;
			}
			return {};
		...
		Game.tinybread=function()
		{
			if (!Game.HasAchiev('Tiny bread'))
			{
				return '<div class="tinybread" '+Game.clickStr+'="Game.ClickTinybread();"></div>';
			}
			return '';
		}
		Game.ClickTinybread=function(){if (!Game.HasAchiev('Tiny bread')){PlaySound('snd/tick.mp3');Game.Win('Tiny bread');}}
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='prefs')
			{
				...
				Game.WriteButton('particles','particlesButton','Particles ON','Particles OFF')+'<label>(breads falling down, etc; disabling may improve performance)</label><br>'+
				Game.WriteButton('numbers','numbersButton','Numbers ON','Numbers OFF')+'<label>(numbers that pop up when clicking the bread)</label><br>'+
				...
				Game.WriteButton('wobbly','wobblyButton','Wobbly bread ON','Wobbly bread OFF')+'<label>(your bread will react when you click it)</label><br>'+
				Game.WriteButton('breadsound','breadsoundButton','Alt bread sound ON','Alt bread sound OFF')+'<label>(how your bread sounds when you click on it)</label><br>'+
				...
				Game.WriteButton('monospace','monospaceButton','Alt font ON','Alt font OFF')+'<label>(your breads are displayed using a monospace font)</label><br>'+
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="subsection">'+
				'<div class="title">General</div>'+
				'<div class="listing"><b>breads in bank :</b> <div class="price plain">'+Game.tinybread()+Beautify(Game.breads)+'</div></div>'+
				'<div class="listing"><b>breads baked (this ascension) :</b> <div class="price plain">'+Game.tinybread()+Beautify(Game.breadsEarned)+'</div></div>'+
				'<div class="listing"><b>breads baked (all time) :</b> <div class="price plain">'+Game.tinybread()+Beautify(Game.breadsEarned+Game.breadsReset)+'</div></div>'+
				(Game.breadsReset>0?'<div class="listing"><b>breads forfeited by ascending :</b> <div class="price plain">'+Game.tinybread()+Beautify(Game.breadsReset)+'</div></div>':'')+
				...
				'<div class="listing"><b>breads per second :</b> '+Beautify(Game.breadsPs,1)+' <small>'+
					...
					'</small></div>'+
				'<div class="listing"><b>Raw breads per second :</b> '+Beautify(Game.breadsPsRaw,1)+' <small>'+
					'(highest this ascension : '+Beautify(Game.breadsPsRawHighest,1)+')'+
					'</small></div>'+
				'<div class="listing"><b>breads per click :</b> '+Beautify(Game.computedMouseCps,1)+'</div>'+
				'<div class="listing"><b>bread clicks :</b> '+Beautify(Game.breadClicks)+'</div>'+
				'<div class="listing"><b>Hand-made breads :</b> '+Beautify(Game.handmadebreads)+'</div>'+
				'<div class="listing"><b>Golden bread clicks :</b> '+Beautify(Game.goldenClicksLocal)+' <small>(all time : '+Beautify(Game.goldenClicks)+')</small></div>'+//' <span class="hidden">(<b>Missed golden breads :</b> '+Beautify(Game.missedGoldenClicks)+')</span></div>'+
				...
				'</div>':'')+
				(Game.season=='fools'?
					'<div class="listing"><b>Money made from selling breads :</b> '+Beautify(Game.breadsEarned*0.08,2)+' bread dollars</div>'+
				...
				//(Game.breadsSucked>0?'<div class="listing warning"><b>Withered :</b> '+Beautify(Game.breadsSucked)+' breads</div>':'')+
				...
				(breadUpgrades!=''?('<div class="listing"><b>breads</b></div>'+
				'<div class="listing crateBox">'+breadUpgrades+'</div>'):'')+
				'</div><div class="subsection">'+
				...
				(Game.breadsMultByType['kittens']>1?('<div class="listing"><b>Kitten multiplier :</b> '+Beautify((Game.breadsMultByType['kittens'])*100)+'%</div>'):'')+
		...
		Game.getNewTicker=function(manual)//note : "manual" is true if the ticker was clicked, but may also be true on startup etc
		{
			...
			if (Game.TickerN%2==0 || Game.breadsEarned>=10100000000)
			{
				...
				if (Math.random()<0.75 || Game.breadsEarned<10000)
				{
					if (Game.Objects['Grandma'].amount>0) list.push(choose([
					'<q>Moist breads.</q><sig>grandma</sig>',
					...
					'News : bread manufacturer downsizes, sells own grandmother!',
					...
					'<q>I can smell your rotten breads.</q><sig>grandma</sig>'
					]));
					...
					'News : bread farms suspected of employing undeclared elderly workforce!',
					'News : bread farms release harmful chocolate in our rivers, says scientist!',
					'News : genetically-modified chocolate controversy strikes bread farmers!',
					'News : free-range farm breads popular with today\'s hip youth, says specialist.',
					'News : farm breads deemed unfit for vegans, says nutritionist.'
					]));
					...
					'News : bread factories linked to global warming!',
					'News : bread factories involved in chocolate weather controversy!',
					'News : bread factories on strike, robotic minions employed to replace workforce!',
					'News : bread factories on strike - workers demand to stop being paid in breads!',
					'News : factory-made breads linked to obesity, says study.'
					]));
					
					if (Game.Objects['Bank'].amount>0) list.push(choose([
					'News : bread loans on the rise as people can no longer afford them with regular money.',
					'News : breads slowly creeping up their way as a competitor to traditional currency!',
					'News : most bakeries now fitted with ATMs to allow for easy bread withdrawals and deposits.',
					'News : bread economy now strong enough to allow for massive vaults doubling as swimming pools!',
					'News : "Tomorrow\'s wealthiest people will be calculated by their worth in breads", predict specialists.'
					]));
					...
					'News : recently-discovered chocolate temples now sparking new bread-related cult; thousands pray to Baker in the sky!',
					'News : just how extensive is the bread pantheon? Theologians speculate about possible '+choose(['god','goddess'])+' of '+choose([choose(animals),choose(['kazoos','web design','web browsers','kittens','atheism','handbrakes','hats','aglets','elevator music','idle games','the letter "P"','memes','hamburgers','bad puns','kerning','stand-up comedy','failed burglary attempts','clickbait','one weird tricks'])])+'.',
					'News : theists of the world discover new bread religion - "Oh boy, guess we were wrong all along!"',
					'News : bread heaven allegedly "sports elevator instead of stairway"; bread hell "paved with flagstone, as good intentions make for poor building material".'
					]));
					...
					'News : bread wizards deny involvement in shockingly ugly newborn - infant is "honestly grody-looking, but natural", say doctors.',
					...
					'News : new chocolate planet found, becomes target of bread-trading spaceships!',
					...
					'News : national gold reserves dwindle as more and more of the precious mineral is turned to breads!',
					...
					'News : defective alchemy lab shut down, found to convert breads to useless gold.',
					'News : alchemy-made breads shunned by purists!'
					]));
					...
					'News : tourism to breadverse popular with bored teenagers! Casualty rate as high as 73%!',
					'News : breadverse portals suspected to cause fast aging and obsession with baking, says study.',
					...
					'News : breads brought back from the past "unfit for human consumption", says historian.',
					...
					'News : "explain to me again why we need particle accelerators to bake breads?" asks misguided local woman.',
					'News : first antimatter condenser successfully turned on, doesn\'t rip apart reality!',
					'News : researchers conclude that what the bread industry needs, first and foremost, is "more magnets".',
					'News : "unravelling the fabric of reality just makes these breads so much tastier", claims scientist.'
					]));
					
					if (Game.Objects['Prism'].amount>0) list.push(choose([
					'News : new bread-producing prisms linked to outbreak of rainbow-related viral videos.',
					'News : scientists warn against systematically turning light into matter - "One day, we\'ll end up with all matter and no light!"',
					'News : breads now being baked at the literal speed of light thanks to new prismatic contraptions.',
					'News : "Can\'t you sense the prism watching us?", rambles insane local man. "No idea what he\'s talking about", shrugs bread magnate/government official.',
					...
					'News : local man "done with bread Clicker", finds the constant self-references "grating and on-the-nose".',
					...
					'News : polls find idea of breads made of breads "acceptable" - "at least we finally know what\'s in them", says interviewed citizen.',
					]));
					...
					if (Game.season=='halloween' && Game.breadsEarned>=1000) list.push(choose([
					'News : strange twisting creatures amass around bread factories, nibble at assembly lines.',
					'News : ominous wrinkly monsters take massive bites out of bread production; "this can\'t be hygienic", worries worker.',
					...
					'News : children around the world "lost and confused" as any and all Halloween treats have been replaced by breads.'
					]));
					
					if (Game.season=='christmas' && Game.breadsEarned>=1000) list.push(choose([
					'News : bearded maniac spotted speeding on flying sleigh! Investigation pending.',
					'News : Santa Claus announces new brand of breakfast treats to compete with bread-flavored cereals! "They\'re ho-ho-horrible!" says Santa.',
					...
					if (Game.season=='valentines' && Game.breadsEarned>=1000) list.push(choose([
					'News : organ-shaped confectioneries being traded in schools all over the world; gruesome practice undergoing investigation.',
					'News : heart-shaped candies overtaking sweets business, offering competition to bread empire. "It\'s the economy, cupid!"',
					'News : love\'s in the air, according to weather specialists. Face masks now offered in every city to stunt airborne infection.',
					'News : marrying a bread - deranged practice, or glimpse of the future?',
					'News : boyfriend dumped after offering his lover breads for Valentine\'s Day, reports say. "They were off-brand", shrugs ex-girlfriend.'
					]));
					
					if (Game.season=='easter' && Game.breadsEarned>=1000) list.push(choose([
				...
				if (Math.random()<0.05)
				{
					if (Game.HasAchiev('Base 10')) list.push('News : bread manufacturer completely forgoes common sense, lets strange obsession with round numbers drive building decisions!');
					if (Game.HasAchiev('From scratch')) list.push('News : follow the tear-jerking, riches-to-rags story about a local bread manufacturer who decided to give it all up!');
					if (Game.HasAchiev('A world filled with breads')) list.push('News : known universe now jammed with breads! No vacancies!');
					if (Game.HasAchiev('Last Chance to See')) list.push('News : incredibly rare albino wrinkler on the brink of extinction poached by bread-crazed pastry magnate!');
					if (Game.Has('Serendipity')) list.push('News : local bread manufacturer becomes luckiest being alive!');
					...
					if (Game.Has('Kitten helpers')) list.push('News : faint meowing heard around local bread facilities; suggests new ingredient being tested.');
					if (Game.Has('Kitten workers')) list.push('News : crowds of meowing kittens with little hard hats reported near local bread facilities.');
					if (Game.Has('Kitten engineers')) list.push('News : surroundings of local bread facilities now overrun with kittens in adorable little suits. Authorities advise to stay away from the premises.');
					...
					if (Game.Has('Kitten specialists')) list.push('News : new kitten college opening next week, offers courses on bread-making and catnip studies.');
					...
					if (Game.Has('Kitten marketeers')) list.push('News : nonsensical billboards crop up all over countryside, trying to sell people the breads they already get for free!');
				...
				if (Game.breadsEarned>=10000) list.push(
				'News : '+choose([
					'breads found to '+choose(['increase lifespan','sensibly increase intelligence','reverse aging','decrease hair loss','prevent arthritis','cure blindness'])+' in '+choose(animals)+'!',
					'breads found to make '+choose(animals)+' '+choose(['more docile','more handsome','nicer','less hungry','more pragmatic','tastier'])+'!',
					'breads tested on '+choose(animals)+', found to have no ill effects.',
					'breads unexpectedly popular among '+choose(animals)+'!',
					'unsightly lumps found on '+choose(animals)+' near bread facility; "they\'ve pretty much always looked like that", say biologists.',
					'new species of '+choose(animals)+' discovered in distant country; "yup, tastes like breads", says biologist.',
					'breads go well with '+choose([choose(['roasted','toasted','boiled','sauteed','minced'])+' '+choose(animals),choose(['sushi','soup','carpaccio','steak','nuggets'])+' made from '+choose(animals)])+', says controversial chef.',
					'"do your breads contain '+choose(animals)+'?", asks PSA warning against counterfeit breads.',
					'doctors recommend twice-daily consumption of fresh breads.',
					'doctors warn against chocolate chip-snorting teen fad.',
					'doctors advise against new bread-free fad diet.',
					'doctors warn mothers about the dangers of "home-made breads".'
					]),
				'News : "'+choose([
					'I\'m all about breads',
					'I just can\'t stop eating breads. I think I seriously need help',
					'I guess I have a bread problem',
					'I\'m not addicted to breads. That\'s just speculation by fans with too much free time',
					'my upcoming album contains 3 songs about breads',
					'I\'ve had dreams about breads 3 nights in a row now. I\'m a bit worried honestly',
					'accusations of bread abuse are only vile slander',
					'breads really helped me when I was feeling low',
					'breads are the secret behind my perfect skin',
					'breads helped me stay sane while filming my upcoming movie',
					'breads helped me stay thin and healthy',
					'I\'ll say one word, just one : breads',
					'alright, I\'ll say it - I\'ve never eaten a single bread in my life'
					])+'", reveals celebrity.',
				choose([
					'News : scientist predicts imminent bread-related "end of the world"; becomes joke among peers.',
					'News : man robs bank, buys breads.',
					'News : scientists establish that the deal with airline food is, in fact, a critical lack of breads.',
					'News : hundreds of tons of breads dumped into starving country from airplanes; thousands dead, nation grateful.',
					'News : new study suggests breads neither speed up nor slow down aging, but instead "take you in a different direction".',
					'News : overgrown breads found in fishing nets, raise questions about hormone baking.',
					'News : "all-you-can-eat" bread restaurant opens in big city; waiters trampled in minutes.',
					'News : man dies in bread-eating contest; "a less-than-impressive performance", says judge.',
					'News : what makes breads taste so right? "Probably all the [*****] they put in them", says anonymous tipper.',
					'News : man found allergic to breads; "what a weirdo", says family.',
					'News : foreign politician involved in bread-smuggling scandal.',
					'News : breads now more popular than '+choose(['cough drops','broccoli','smoked herring','cheese','video games','stable jobs','relationships','time travel','cat videos','tango','fashion','television','nuclear warfare','whatever it is we ate before','politics','oxygen','lamps'])+', says study.',
					'News : obesity epidemic strikes nation; experts blame '+choose(['twerking','that darn rap music','video-games','lack of breads','mysterious ghostly entities','aliens','parents','schools','comic-books','bread-snorting fad'])+'.',
					'News : bread shortage strikes town, people forced to eat cupcakes; "just not the same", concedes mayor.',
					'News : "you gotta admit, all this bread stuff is a bit ominous", says confused idiot.',
					//'News : scientists advise getting used to breads suffusing every aspect of life; "this is the new normal", expert says.',
					//'News : doctors advise against wearing face masks when going outside. "You never know when you might need a bread... a mask would just get in the way."',//these were written back when covid hadn't really done much damage yet but they just feel in poor taste now
					'News : is there life on Mars? Various chocolate bar manufacturers currently under investigation for bacterial contaminants.',
					'News : "so I guess that\'s a thing now", scientist comments on bread particles now present in virtually all steel manufactured since bread production ramped up worldwide.',
					'News : trace amounts of bread particles detected in most living creatures, some of which adapting them as part of new and exotic metabolic processes.',
				]),
				choose([
					'News : movie cancelled from lack of actors; "everybody\'s at home eating breads", laments director.',
					'News : comedian forced to cancel bread routine due to unrelated indigestion.',
					'News : new bread-based religion sweeps the nation.',
					'News : fossil records show bread-based organisms prevalent during Cambrian explosion, scientists say.',
					'News : mysterious illegal breads seized; "tastes terrible", says police.',
					'News : man found dead after ingesting bread; investigators favor "mafia snitch" hypothesis.',
					'News : "the universe pretty much loops on itself," suggests researcher; "it\'s breads all the way down."',
					'News : minor bread-related incident turns whole town to ashes; neighboring cities asked to chip in for reconstruction.',
					'News : is our media controlled by the bread industry? This could very well be the case, says crackpot conspiracy theorist.',
					'News : '+choose(['bread-flavored popcorn pretty damn popular; "we kinda expected that", say scientists.','bread-flavored cereals break all known cereal-related records','breads popular among all age groups, including fetuses, says study.','bread-flavored popcorn sales exploded during screening of Grandmothers II : The Moistening.']),
					'News : all-bread restaurant opening downtown. Dishes such as braised breads, bread thermidor, and for dessert : crepes.',
					'News : "Ook", says interviewed orangutan.',
					'News : breads could be the key to '+choose(['eternal life','infinite riches','eternal youth','eternal beauty','curing baldness','world peace','solving world hunger','ending all wars world-wide','making contact with extraterrestrial life','mind-reading','better living','better eating','more interesting TV shows','faster-than-light travel','quantum baking','chocolaty goodness','gooder thoughtness'])+', say scientists.',
					'News : flavor text '+choose(['not particularly flavorful','kind of unsavory'])+', study finds.',
				]),
				choose([
					'News : what do golden breads taste like? Study reveals a flavor "somewhere between spearmint and liquorice".',
					'News : what do wrath breads taste like? Study reveals a flavor "somewhere between blood sausage and seawater".',
					'News : '+Game.bakeryName+'-brand breads "'+choose(['much less soggy','much tastier','relatively less crappy','marginally less awful','less toxic','possibly more edible','more fashionable','slightly nicer','trendier','arguably healthier','objectively better choice','slightly less terrible','decidedly breadr','a tad cheaper'])+' than competitors", says consumer survey.',
					'News : "'+Game.bakeryName+'" set to be this year\'s most popular baby name.',
					'News : new popularity survey says '+Game.bakeryName+'\'s the word when it comes to breads.',
					'News : major city being renamed '+Game.bakeryName+'ville after world-famous bread manufacturer.',
					'News : '+choose(['street','school','nursing home','stadium','new fast food chain','new planet','new disease','flesh-eating bacteria','deadly virus','new species of '+choose(animals),'new law','baby','programming language'])+' to be named after '+Game.bakeryName+', the world-famous bread manufacturer.',
					...
					'News : viral video "Too Many breads" could be "a grim commentary on the impending crisis our world is about to face", says famous economist.',
					'News : "memes from last year somehow still relevant", deplore experts.',
					'News : bread emoji most popular among teenagers, far ahead of "judgemental OK hand sign" and "shifty-looking dark moon", says study.',
				]),
				choose([
					'News : births of suspiciously bald babies on the rise; ancient alien cabal denies involvement.',
					'News : "at this point, breads permeate the economy", says economist. "If we start eating anything else, we\'re all dead."',
					...
					'News : breads now illegal in some backwards country nobody cares about. Political tensions rising; war soon, hopefully.',
					'News : irate radio host rambles about pixelated icons. "None of the breads are aligned! Can\'t anyone else see it? I feel like I\'m taking crazy pills!"',
					'News : nation cheers as legislators finally outlaw '+choose(['bread criticism','playing other games than bread Clicker','pineapple on pizza','lack of cheerfulness','mosquitoes','broccoli','the human spleen','bad weather','clickbait','dabbing','the internet','memes','millenials'])+'!',
					'News : '+choose(['local','area'])+' '+choose(['man','woman'])+' goes on journey of introspection, finds breads : "I honestly don\'t know what I was expecting."',
					'News : '+choose(['man','woman'])+' wakes up from coma, '+choose(['tries bread for the first time, dies.','regrets it instantly.','wonders "why everything is breads now".','babbles incoherently about some supposed "non-bread food" we used to eat.','cites breads as main motivator.','asks for breads.']),
					...
					'News : "average person bakes '+Beautify(Math.ceil(Game.breadsEarned/7300000000))+' bread'+(Math.ceil(Game.breadsEarned/7300000000)==1?'':'s')+' a year" factoid actually just statistical error; '+Game.bakeryName+', who has produced '+Beautify(Game.breadsEarned)+' breads in their lifetime, is an outlier and should not have been counted.'
					])
				);
			}
			...
			if (list.length==0)
			{
				if (Game.breadsEarned<5) list.push('You feel like making breads. But nobody wants to eat your breads.');
				else if (Game.breadsEarned<50) list.push('Your first batch goes to the trash. The neighborhood raccoon barely touches it.');
				else if (Game.breadsEarned<100) list.push('Your family accepts to try some of your breads.');
				else if (Game.breadsEarned<500) list.push('Your breads are popular in the neighborhood.');
				else if (Game.breadsEarned<1000) list.push('People are starting to talk about your breads.');
				else if (Game.breadsEarned<5000) list.push('Your breads are talked about for miles around.');
				else if (Game.breadsEarned<10000) list.push('Your breads are renowned in the whole town!');
				else if (Game.breadsEarned<50000) list.push('Your breads bring all the boys to the yard.');
				else if (Game.breadsEarned<100000) list.push('Your breads now have their own website!');
				else if (Game.breadsEarned<500000) list.push('Your breads are worth a lot of money.');
				else if (Game.breadsEarned<1000000) list.push('Your breads sell very well in distant countries.');
				else if (Game.breadsEarned<5000000) list.push('People come from very far away to get a taste of your breads.');
				else if (Game.breadsEarned<10000000) list.push('Kings and queens from all over the world are enjoying your breads.');
				else if (Game.breadsEarned<50000000) list.push('There are now museums dedicated to your breads.');
				else if (Game.breadsEarned<100000000) list.push('A national day has been created in honor of your breads.');
				else if (Game.breadsEarned<500000000) list.push('Your breads have been named a part of the world wonders.');
				else if (Game.breadsEarned<1000000000) list.push('History books now include a whole chapter about your breads.');
				else if (Game.breadsEarned<5000000000) list.push('Your breads have been placed under government surveillance.');
				else if (Game.breadsEarned<10000000000) list.push('The whole planet is enjoying your breads!');
				else if (Game.breadsEarned<50000000000) list.push('Strange creatures from neighboring planets wish to try your breads.');
				else if (Game.breadsEarned<100000000000) list.push('Elder gods from the whole cosmos have awoken to taste your breads.');
				else if (Game.breadsEarned<500000000000) list.push('Beings from other dimensions lapse into existence just to get a taste of your breads.');
				else if (Game.breadsEarned<1000000000000) list.push('Your breads have achieved sentience.');
				else if (Game.breadsEarned<5000000000000) list.push('The universe has now turned into bread dough, to the molecular level.');
				else if (Game.breadsEarned<10000000000000) list.push('Your breads are rewriting the fundamental laws of the universe.');
				else if (Game.breadsEarned<10000000000000) list.push('A local news station runs a 10-minute segment about your breads. Success!<br><span style="font-size:50%;">(you win a bread)</span>');
				else if (Game.breadsEarned<10100000000000) list.push('it\'s time to stop playing');//only show this for 100 millions (it's funny for a moment)
			}
			...
			if (Game.elderWrath>0 && (((Game.pledges==0 && Game.resets==0) && Math.random()<0.5) || Math.random()<0.05))
			{
				...
				if (Game.elderWrath==1) list.push(choose([
					...
					'News : processions of old ladies sighted around bread facilities!',
					...
					'News : nurses report "strange scent of bread dough" around female elderly patients!'
				]));
				...
				if (Game.elderWrath==3) list.push(choose([
					'News : large "flesh highways" scar continent, stretch between various bread facilities!',
			...
			if (Game.season=='fools')
			{
				...
				if (Game.breadsEarned>=1000) list.push(choose([
					...
					'The word of the day is : '+choose(['viral','search engine optimization','blags and wobsites','social networks','web 3.0','logistics','leveraging','branding','proactive','synergizing','market research','demographics','pie charts','blogular','blogulacious','blogastic','authenticity','electronic mail','cellular phones','rap music','breads, I guess'])+'.',
					'Profit\'s in the air!'
				]));
				if (Game.breadsEarned>=1000 && Math.random()<0.1) list.push(choose([
					'If you could get some more breads baked, that\'d be great.',
				...
				if (Game.TickerN%2==0 || Game.breadsEarned>=10100000000)
				{
					...
					if (Game.Objects['Grandma'].amount>0) list.push(choose([
					'Your ovens are diligently baking more and more breads.',
					'Your ovens burn a whole batch. Ah well! Still good.'
					]));
					
					if (Game.Objects['Farm'].amount>0) list.push(choose([
					'Scores of breads come out of your kitchens.',
					...
					'Your supermarkets are full of bread merch!'
					]));
					...
					'Your bread-themed TV show is being adapted into a new movie!'
					]));
					
					if (Game.Objects['Time machine'].amount>0) list.push(choose([
					'Your theme parks are doing well - puddles of vomit and roller-coaster casualties are being swept under the rug!',
					'Visitors are stuffing themselves with breads before riding your roller-coasters. You might want to hire more clean-up crews.'
					]));
					
					if (Game.Objects['Antimatter condenser'].amount>0) list.push(choose([
					'breadcoin is officially the most mined digital currency in the history of mankind!',
					'breadcoin piracy is rampant!'
					]));
					
					if (Game.Objects['Prism'].amount>0) list.push(choose([
					'Your corporate nations just gained a new parliament!',
					'You\'ve just annexed a new nation!',
					'A new nation joins the grand bread conglomerate!'
					]));
					
					if (Game.Objects['Chancemaker'].amount>0) list.push(choose([
					'Your intergalactic federation of bread-sponsored planets reports record-breaking profits!',
					'Billions of unwashed aliens are pleased to join your workforce as you annex their planet!',
					'New toll opened on interstellar highway, funnelling more profits into the bread economy!'
					]));
					
					if (Game.Objects['Fractal engine'].amount>0) list.push(choose([
					'Your bread-based political party is doing fantastic in the polls!',
					'New pro-bread law passes without a hitch thanks to your firm grasp of the political ecosystem!',
					'Your appointed senators are overturning bread bans left and right!'
					]));
					
					if (Game.Objects['Javascript console'].amount>0) list.push(choose([
					'breads are now one of the defining aspects of mankind! Congratulations!',
					'Time travelers report that this era will later come to be known, thanks to you, as the bread millennium!',
					'breads now deeply rooted in human culture, likely puzzling future historians!'
					]));
					
					if (Game.Objects['Idleverse'].amount>0) list.push(choose([
					'Public aghast as all remaining aspects of their lives overtaken by universal bread industry!',
				...
				if (Game.breadsEarned<5) list.push('Such a grand day to begin a new business.');
				else if (Game.breadsEarned<50) list.push('You\'re baking up a storm!');
				else if (Game.breadsEarned<100) list.push('You are confident that one day, your bread company will be the greatest on the market!');
				else if (Game.breadsEarned<1000) list.push('Business is picking up!');
				else if (Game.breadsEarned<5000) list.push('You\'re making sales left and right!');
				else if (Game.breadsEarned<20000) list.push('Everyone wants to buy your breads!');
				else if (Game.breadsEarned<50000) list.push('You are now spending most of your day signing contracts!');
				else if (Game.breadsEarned<500000) list.push('You\'ve been elected "business tycoon of the year"!');
				else if (Game.breadsEarned<1000000) list.push('Your breads are a worldwide sensation! Well done, old chap!');
				else if (Game.breadsEarned<5000000) list.push('Your brand has made its way into popular culture. Children recite your slogans and adults reminisce them fondly!');
				else if (Game.breadsEarned<1000000000) list.push('A business day like any other. It\'s good to be at the top!');
				else if (Game.breadsEarned<10100000000) list.push('You look back at your career. It\'s been a fascinating journey, building your baking empire from the ground up.');//only show this for 100 millions
			}
			...
			if (!manual && Game.T>Game.fps*10 && Game.Has('Fortune breads') && Math.random()<(Game.HasAchiev('O Fortuna')?0.04:0.02))
			{
				var fortunes=[];
				...
				if (fortunes.length>0)
				{
					...
					if (me=='fortuneGC') me='Today is your lucky day!';/*<br>Click here for a golden bread.';*/
		...
		AddEvent(Game.tickerL,'click',function(event){
			...
			if (Game.TickerEffect && Game.TickerEffect.type=='fortune')
			{
				...
				if (effect=='fortuneGC')
				{
					Game.Notify('Fortune!','A golden bread has appeared.',[10,32]);
					Game.fortuneGC=1;
				...
				else if (effect=='fortuneCPS')
				{
					...
					Game.fortuneCPS=1;
					Game.Earn(Math.min(Game.breadsPs*60*60,Game.breads));
				}
				else
				{
		...
		Game.Object=function(name,commonName,desc,icon,iconColumn,art,price,cps,buyFunction)
		{
			...
			this.buy=function(amount)
			{
				...
				//if (moni>0 && amount>1) Game.Notify(this.name,'Bought <b>'+bought+'</b> for '+Beautify(moni)+' breads','',2);
			}
			this.sell=function(amount,bypass)
			{
				...
				for (var i=0;i<amount;i++)
				{
					...
					if (this.amount>0)
					{
						...
						moni+=price;
						Game.breads+=price;
						Game.breadsEarned=Math.max(Game.breads,Game.breadsEarned);//this is to avoid players getting the cheater achievement when selling buildings that have a higher price than they used to
						this.amount--;
						price=this.getPrice();
						this.price=price;
				...
				if (success && Game.shimmerTypes['golden'].n<=0 && Game.auraMult('Dragon Orbs')>0)
				{
					...
					if (highestBuilding==this && Math.random()<Game.auraMult('Dragon Orbs')*0.1)
					{
						...
						if (buffsN==0)
						{
							...
							Game.Notify('Dragon Orbs!','Wish granted. Golden bread spawned.',[33,25]);
						}
					}
				}
				if (success) {PlaySound('snd/sell'+choose([1,2,3,4])+'.mp3',0.75);this.refresh();}
				//if (moni>0) Game.Notify(this.name,'Sold <b>'+sold+'</b> for '+Beautify(moni)+' breads','',2);
			}
			this.sacrifice=function(amount)//sell without getting back any money
			{
				...
				for (var i=0;i<amount;i++)
				{
					...
					if (this.amount>0)
					{
						...
						//moni+=price;
						//Game.breads+=price;
						//Game.breadsEarned=Math.max(Game.breads,Game.breadsEarned);
						this.amount--;
						price=this.getPrice();
						this.price=price;
						if (this.sellFunction) this.sellFunction();
			...
			this.tooltip=function()
			{
				...
				//if (l('rowInfo'+me.id) && Game.drawT%10==0) l('rowInfoContent'+me.id).innerHTML='&bull; '+me.amount+' '+(me.amount==1?me.single:me.plural)+'<br>&bull; producing '+Beautify(me.storedTotalCps,1)+' '+(me.storedTotalCps==1?'bread':'breads')+' per second<br>&bull; total : '+Beautify(me.totalbreads)+' '+(Math.floor(me.totalbreads)==1?'bread':'breads')+' '+me.actionName;
				
				var canBuy=false;
				var price=me.bulkPrice;
				if ((Game.buyMode==1 && Game.breads>=price) || (Game.buyMode==-1 && me.amount>0)) canBuy=true;
				...
				if (me.amount>0)
				{
					...
					for (var i in me.synergies)
					{
						...
						if (Game.Has(it.name))
						{
							...
							//synergiesStr+='Synergy with '+other.name+'; we boost it by '+Beautify((me.amount*weight)*100,1)+'%, producing '+Beautify(boost)+' CpS. My synergy boost is now '+Beautify((synergyBoost/Game.breadsPs)*100,1)+'%.<br>';
						}
					}
					if (synergyBoost>0)
					{
						...
						//synergiesStr='...along with <b>'+Beautify(synergyBoost,1)+'</b> breads through synergies with other buildings ('+synergiesStr+'; <b>'+Beautify((synergyBoost/Game.breadsPs)*100,1)+'%</b> of total CpS)';
						//synergiesStr='...also boosting some other buildings, accounting for <b>'+Beautify(synergyBoost,1)+'</b> breads per second (a combined <b>'+Beautify((synergyBoost/Game.breadsPs)*100,1)+'%</b> of total CpS) : '+synergiesStr+'';
						synergiesStr='...also boosting some other buildings : '+synergiesStr+' - all combined, these boosts account for <b>'+Beautify(synergyBoost,1)+'</b> breads per second (<b>'+Beautify((synergyBoost/Game.breadsPs)*100,1)+'%</b> of total CpS)';
					}
				}
				...
				(me.totalbreads>0?(
					...
					(me.amount>0?'&bull; each '+me.single+' produces <b>'+Beautify((me.storedTotalCps/me.amount)*Game.globalCpsMult,1)+'</b> '+((me.storedTotalCps/me.amount)*Game.globalCpsMult==1?'bread':'breads')+' per second<br>':'')+
					'&bull; '+me.amount+' '+(me.amount==1?me.single:me.plural)+' producing <b>'+Beautify(me.storedTotalCps*Game.globalCpsMult,1)+'</b> '+(me.storedTotalCps*Game.globalCpsMult==1?'bread':'breads')+' per second (<b>'+Beautify(Game.breadsPs>0?((me.amount>0?((me.storedTotalCps*Game.globalCpsMult)/Game.breadsPs):0)*100):0,1)+'%</b> of total CpS)<br>'+
					(synergiesStr?('&bull; '+synergiesStr+'<br>'):'')+
					'&bull; <b>'+Beautify(me.totalbreads)+'</b> '+(Math.floor(me.totalbreads)==1?'bread':'breads')+' '+me.actionName+' so far</div>'
				):'')+
				'</div>';
			}
			...
			this.rebuild=function()
			{
				...
				//var classes='product';
				var price=me.bulkPrice;
				/*if (Game.breadsEarned>=me.basePrice || me.bought>0) {classes+=' unlocked';me.locked=0;} else {classes+=' locked';me.locked=1;}
				if (Game.breads>=price) classes+=' enabled'; else classes+=' disabled';
		...
		Game.magicCpS=function(what)
		{
			...
			{
				//this makes buildings give 1% more breads for every building over 250.
		...
		new Game.Object('Grandma','grandma|grandmas|baked|Grandmas are [X] year older|Grandmas are [X] years older','A nice grandma to bake more breads.',1,1,{pic:function(i){
			var list=['grandma'];
		...
		new Game.Object('Farm','farm|farms|harvested|[X] more acre|[X] more acres','Grows bread plants from bread seeds.',3,2,{base:'farm',xV:8,yV:8,w:64,rows:2,x:0,y:16},500,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
		...
		new Game.Object('Mine','mine|mines|mined|[X] mile deeper|[X] miles deeper','Mines out bread dough and chocolate chips.',4,3,{base:'mine',xV:16,yV:16,w:64,rows:2,x:0,y:24},10000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Factory','factory|factories|mass-produced|[X] additional patent|[X] additional patents','Produces large quantities of breads.',5,4,{base:'factory',xV:8,yV:0,w:64,rows:1,x:0,y:-22},3000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Bank','bank|banks|banked|Interest rates [X]% better|Interest rates [X]% better','Generates breads from interest.',6,15,{base:'bank',xV:8,yV:4,w:56,rows:1,x:0,y:13},0,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Wizard tower','wizard tower|wizard towers|summoned|Incantations have [X] more syllable|Incantations have [X] more syllables','Summons breads with magic spells.',8,17,{base:'wizardtower',xV:16,yV:16,w:48,rows:2,x:0,y:20},0,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Shipment','shipment|shipments|shipped|[X] galaxy fully explored|[X] galaxies fully explored','Brings in fresh breads from the bread planet.',9,5,{base:'shipment',xV:16,yV:16,w:64,rows:1,x:0,y:0},40000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Alchemy lab','alchemy lab|alchemy labs|transmuted|[X] primordial element mastered|[X] primordial elements mastered','Turns gold into breads!',10,6,{base:'alchemylab',xV:16,yV:16,w:64,rows:2,x:0,y:16},200000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Portal','portal|portals|retrieved|[X] dimension enslaved|[X] dimensions enslaved','Opens a door to the breadverse.',11,7,{base:'portal',xV:32,yV:32,w:64,rows:2,x:0,y:0},1666666,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Time machine','time machine|time machines|recovered|[X] century secured|[X] centuries secured','Brings breads from the past, before they were even eaten.',12,8,{base:'timemachine',xV:32,yV:32,w:64,rows:1,x:0,y:0},123456789,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Antimatter condenser','antimatter condenser|antimatter condensers|condensed|[X] extra quark flavor|[X] extra quark flavors','Condenses the antimatter in the universe into breads.',13,13,{base:'antimattercondenser',xV:0,yV:64,w:64,rows:1,x:0,y:0},3999999999,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Prism','prism|prisms|converted|[X] new color discovered|[X] new colors discovered','Converts light itself into breads.',14,14,{base:'prism',xV:16,yV:4,w:64,rows:1,x:0,y:20},75000000000,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Chancemaker','chancemaker|chancemakers|spontaneously generated|Chancemakers are powered by [X]-leaf clovers|Chancemakers are powered by [X]-leaf clovers','Generates breads out of thin air through sheer luck.',15,19,{base:'chancemaker',xV:8,yV:64,w:64,rows:1,x:0,y:0,rows:2},77777777777,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Fractal engine','fractal engine|fractal engines|made from breads|[X] iteration deep|[X] iterations deep','Turns breads into even more breads.',16,20,{base:'fractalEngine',xV:8,yV:64,w:64,rows:1,x:0,y:0},12345678987654321,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		new Game.Object('Javascript console','javascript console|javascript consoles|programmed|Equipped with [X] external library|Equipped with [X] external libraries','Creates breads from the very code this game was written in.',17,32,{base:'javascriptconsole',xV:8,yV:64,w:14,rows:1,x:8,y:-32,frames:2},12345678987654321,function(me){
			var mult=1;
			mult*=Game.GetTieredCpsMult(me);
			mult*=Game.magicCpS(me.name);
			return me.baseCps*mult;
		...
		Game.foolObjects={
			...
			'Cursor':{name:'Rolling pin',desc:'Essential in flattening dough. The first step in bread-making.',icon:0},
			'Grandma':{name:'Oven',desc:'A crucial element of baking breads.',icon:1},
			'Farm':{name:'Kitchen',desc:'The more kitchens, the more breads your employees can produce.',icon:2},
			...
			'Wizard tower':{name:'Meme',desc:'bread memes are all the rage! With just the right amount of social media astroturfing, your brand image will be all over the cyberspace.',icon:6},
			'Shipment':{name:'Supermarket',desc:'A gigantic bread emporium - your very own retail chain.',icon:7},
			'Alchemy lab':{name:'Stock share',desc:'You\'re officially on the stock market, and everyone wants a piece!',icon:8},
			'Portal':{name:'TV show',desc:'Your breads have their own sitcom! Hilarious baking hijinks set to the cheesiest laughtrack.',icon:10},
			'Time machine':{name:'Theme park',desc:'bread theme parks, full of mascots and roller-coasters. Build one, build a hundred!',icon:11},
			'Antimatter condenser':{name:'breadcoin',desc:'A virtual currency, already replacing regular money in some small countries.',icon:12},
			...
			'Chancemaker':{name:'Privatized planet',desc:'Actually, you know what\'s cool? A whole planet dedicated to producing, advertising, selling, and consuming your breads.',icon:15},
			'Fractal engine':{name:'Senate seat',desc:'Only through political dominion can you truly alter this world to create a brighter, more bread-friendly future.',icon:16},
			'Javascript console':{name:'Doctrine',desc:'Taking many forms -religion, culture, philosophy- a doctrine may, when handled properly, cause a lasting impact on civilizations, reshaping minds and people and ensuring all future generations share a singular goal - the production, and acquisition, of more breads.',icon:17},
			'Idleverse':{name:'Lateral expansions',desc:'Sometimes the best way to keep going up is sideways. Diversify your ventures through non-bread investments.',icon:18},
		};
		...
		Game.Upgrade=function(name,desc,price,icon,buyFunction)
		{
			...
			this.pool='';//can be '', bread, toggle, debug, prestige, prestigeDecor, tech, or unused
		...
		Game.Upgrade.prototype.getPrice=function()
		{
			...
			if (this.pool!='prestige')
			{
				...
				if (this.pool=='bread' && Game.Has('Divine bakeries')) price/=5;
			}
			return Math.ceil(price);
		}
		...
		Game.Upgrade.prototype.canBuy=function()
		{
			...
			if (Game.breads>=this.getPrice()) return true; else return false;
		}
		...
		{
			if (pool=='' || pool=='bread' || pool=='tech') return true; else return false;
		}
		...
		Game.UnlockAt=[];//this contains an array of every upgrade with a bread requirement in the form of {breads:(amount of breads earned required),name:(name of upgrade or achievement to unlock)} (and possibly require:(name of upgrade of achievement to own))
		//note : the bread will not be added to the list if it contains locked:1 (use for seasonal breads and such)
		
		Game.NewUpgradebread=function(obj)
		{
			var upgrade=new Game.Upgrade(obj.name,'bread production multiplier <b>+'+Beautify((typeof(obj.power)==='function'?obj.power(obj):obj.power),1)+'%</b>.<q>'+obj.desc+'</q>',obj.price,obj.icon);
			upgrade.power=obj.power;
			upgrade.pool='bread';
			var toPush={breads:obj.price/20,name:obj.name};
		...
		new Game.Upgrade('Thousand fingers','The mouse and cursors gain <b>+0.1</b> breads for each non-cursor object owned.<q>clickity</q>',100000,[0,13]);Game.MakeTiered(Game.last,4,0);
		...
		new Game.TieredUpgrade('bread trees','Farms are <b>twice</b> as efficient.<q>A relative of the breadfruit.</q>','Farm',3);
		...
		order=800;
		new Game.TieredUpgrade('Ancient tablet','Portals are <b>twice</b> as efficient.<q>A strange slab of peanut brittle, holding an ancient bread recipe. Neat!</q>','Portal',1);
		new Game.TieredUpgrade('Insane oatling workers','Portals are <b>twice</b> as efficient.<q>ARISE, MY MINIONS!</q>','Portal',2);
		new Game.TieredUpgrade('Soul bond','Portals are <b>twice</b> as efficient.<q>So I just sign up and get more breads? Sure, whatever!</q>','Portal',3);
		...
		order=10000;
		Game.NewUpgradebread({name:'Plain breads',desc:'We all gotta start somewhere.',icon:[2,3],power:										1,	price:	999999});
		Game.NewUpgradebread({name:'Sugar breads',desc:'Tasty, if a little unimaginative.',icon:[7,3],power:									1,	price:	999999*5});
		Game.NewUpgradebread({name:'Oatmeal raisin breads',desc:'No raisin to hate these.',icon:[0,3],power:									1,	price:	9999999});
		Game.NewUpgradebread({name:'Peanut butter breads',desc:'Get yourself some jam breads!',icon:[1,3],power:								2,	price:	9999999*5});
		Game.NewUpgradebread({name:'Coconut breads',desc:'Flaky, but not unreliable. Some people go crazy for these.',icon:[3,3],power:		2,	price:	99999999});
		order=10001;
		Game.NewUpgradebread({name:'White chocolate breads',desc:'I know what you\'ll say. It\'s just cocoa butter! It\'s not real chocolate!<br>Oh please.',icon:[4,3],power:2,	price:	99999999*5});
		order=10000;
		Game.NewUpgradebread({name:'Macadamia nut breads',desc:'They\'re macadamn delicious!',icon:[5,3],power:								2,	price:	99999999});
		order=10002;
		Game.NewUpgradebread({name:'Double-chip breads',desc:'DOUBLE THE CHIPS<br>DOUBLE THE TASTY<br>(double the calories)',icon:[6,3],power:2,	price:	999999999*5});
		Game.NewUpgradebread({name:'White chocolate macadamia nut breads',desc:'Orteil\'s favorite.',icon:[8,3],power:						2,	price:	9999999999});
		Game.NewUpgradebread({name:'All-chocolate breads',desc:'CHOCOVERDOSE.',icon:[9,3],power:												2,	price:	9999999999*5});
		...
		order=300;new Game.TieredUpgrade('Genetically-modified breads','Farms are <b>twice</b> as efficient.<q>All-natural mutations.</q>','Farm',4);
		order=500;new Game.TieredUpgrade('Radium reactors','Factories are <b>twice</b> as efficient.<q>Gives your breads a healthy glow.</q>','Factory',4);
		...
		order=700;new Game.TieredUpgrade('Ambrosia','Alchemy labs are <b>twice</b> as efficient.<q>Adding this to the bread mix is sure to make them even more addictive!<br>Perhaps dangerously so.<br>Let\'s hope you can keep selling these legally.</q>','Alchemy lab',4);
		...
		order=5000;
		new Game.Upgrade('Lucky day','Golden breads appear <b>twice as often</b> and stay <b>twice as long</b>.<q>Oh hey, a four-leaf penny!</q>',777777777,[27,6]);
		new Game.Upgrade('Serendipity','Golden breads appear <b>twice as often</b> and stay <b>twice as long</b>.<q>What joy! Seven horseshoes!</q>',77777777777,[27,6]);
		...
		order=10020;
		Game.NewUpgradebread({name:'Dark chocolate-coated breads',desc:'These absorb light so well you almost need to squint to see them.',icon:[10,3],power:			5,	price:	99999999999});
		Game.NewUpgradebread({name:'White chocolate-coated breads',desc:'These dazzling breads absolutely glisten with flavor.',icon:[11,3],power:					5,	price:	99999999999});
		...
		order=250;
		Game.GrandmaSynergy('Farmer grandmas','A nice farmer to grow more breads.','Farm');
		Game.GrandmaSynergy('Miner grandmas','A nice miner to dig more breads.','Mine');
		Game.GrandmaSynergy('Worker grandmas','A nice worker to manufacture more breads.','Factory');
		Game.GrandmaSynergy('Cosmic grandmas','A nice thing to... uh... breads.','Shipment');
		Game.GrandmaSynergy('Transmuted grandmas','A nice golden grandma to convert into more breads.','Alchemy lab');
		Game.GrandmaSynergy('Altered grandmas','a NiCe GrAnDmA tO bA##########','Portal');
		Game.GrandmaSynergy('Grandmas\' grandmas','A nice grandma\'s nice grandma to bake double the breads.','Time machine');
		...
		order=15000;
		new Game.Upgrade('Specialized chocolate chips','bread production multiplier <b>+1%</b>.<q>Computer-designed chocolate chips. Computer chips, if you will.</q>',1000000000000000,[0,9],function(){Game.SetResearch('Designer cocoa beans');});Game.last.pool='tech';
		new Game.Upgrade('Designer cocoa beans','bread production multiplier <b>+2%</b>.<q>Now more aerodynamic than ever!</q>',2000000000000000,[1,9],function(){Game.SetResearch('Ritual rolling pins');});Game.last.pool='tech';
		...
		new Game.Upgrade('Underworld ovens','bread production multiplier <b>+3%</b>.<q>Powered by science, of course!</q>',8000000000000000,[3,9],function(){Game.SetResearch('One mind');});Game.last.pool='tech';
		...
		new Game.Upgrade('Exotic nuts','bread production multiplier <b>+4%</b>.<q>You\'ll go crazy over these!</q>',32000000000000000,[5,9],function(){Game.SetResearch('Communal brainsweep');});Game.last.pool='tech';
		...
		new Game.Upgrade('Arcane sugar','bread production multiplier <b>+5%</b>.<q>Tastes like insects, ligaments, and molasses.</q>',128000000000000000,[7,9],function(){Game.SetResearch('Elder Pact');});Game.last.pool='tech';
		...
		new Game.Upgrade('Elder Pledge','Contains the wrath of the elders, at least for a while.<q>This is a simple ritual involving anti-aging cream, bread batter mixed in the moonlight, and a live chicken.</q>',1,[9,9],function()
		{
			Game.elderWrath=0;
			Game.pledges++;
		...
		order=10020;
		Game.NewUpgradebread({name:'Eclipse breads',desc:'Look to the bread.',icon:[0,4],power:					2,	price:	99999999999*5});
		Game.NewUpgradebread({name:'Zebra breads',desc:'...',icon:[1,4],power:									2,	price:	999999999999});
		...
		order=40000;
		new Game.Upgrade('Gold hoard','Golden breads appear <b>really often</b>.<q>That\'s entirely too many.</q>',7,[10,14]);//debug purposes only
		Game.last.pool='debug';
		...
		order=5000;
		new Game.Upgrade('Get lucky','Golden bread effects last <b>twice as long</b>.<q>You\'ve been up all night, haven\'t you?</q>',77777777777777,[27,6]);
		...
		order=10020;
		Game.NewUpgradebread({name:'Snickerdoodles',desc:'True to their name.',icon:[2,4],power:												2,	price:	999999999999*5});
		Game.NewUpgradebread({name:'Stroopwafels',desc:'If it ain\'t dutch, it ain\'t much.',icon:[3,4],power:									2,	price:	9999999999999});
		Game.NewUpgradebread({name:'Macaroons',desc:'Not to be confused with macarons.<br>These have coconut, okay?',icon:[4,4],power:			2,	price:	9999999999999*5});
		...
		order=10020;
		Game.NewUpgradebread({name:'Empire biscuits',desc:'For your growing bread empire, of course!',icon:[5,4],power:											2,	price:	99999999999999});
		order=10031;
		Game.NewUpgradebread({name:'British tea biscuits',desc:'Quite.',icon:[6,4],require:'Tin of british tea biscuits',power:									2,	price:	99999999999999});
		Game.NewUpgradebread({name:'Chocolate british tea biscuits',desc:'Yes, quite.',icon:[7,4],require:Game.last.name,power:									2,	price:	99999999999999});
		Game.NewUpgradebread({name:'Round british tea biscuits',desc:'Yes, quite riveting.',icon:[8,4],require:Game.last.name,power:								2,	price:	99999999999999});
		Game.NewUpgradebread({name:'Round chocolate british tea biscuits',desc:'Yes, quite riveting indeed.',icon:[9,4],require:Game.last.name,power:				2,	price:	99999999999999});
		Game.NewUpgradebread({name:'Round british tea biscuits with heart motif',desc:'Yes, quite riveting indeed, old chap.',icon:[10,4],require:Game.last.name,power:	2,	price:	99999999999999});
		Game.NewUpgradebread({name:'Round chocolate british tea biscuits with heart motif',desc:'I like breads.',icon:[11,4],require:Game.last.name,power:		2,	price:	99999999999999});
		...
		new Game.TieredUpgrade('String theory','Antimatter condensers are <b>twice</b> as efficient.<q>Reveals new insight about the true meaning of baking breads (and, as a bonus, the structure of the universe).</q>','Antimatter condenser',2);
		...
		order=255;
		Game.GrandmaSynergy('Antigrandmas','A mean antigrandma to vomit more breads.','Antimatter condenser');

		order=10020;
		Game.NewUpgradebread({name:'Madeleines',desc:'Unforgettable!',icon:[12,3],power:																2,	price:	99999999999999*5});
		Game.NewUpgradebread({name:'Palmiers',desc:'Palmier than you!',icon:[13,3],power:																2,	price:	99999999999999*5});
		Game.NewUpgradebread({name:'Palets',desc:'You could probably play hockey with these.<br>I mean, you\'re welcome to try.',icon:[12,4],power:	2,	price:	999999999999999});
		Game.NewUpgradebread({name:'Sabl&eacute;s',desc:'The name implies they\'re made of sand. But you know better, don\'t you?',icon:[13,4],power:	2,	price:	999999999999999});
		...
		order=500;new Game.TieredUpgrade('Recombobulators','Factories are <b>twice</b> as efficient.<q>A major part of bread recombobulation.</q>','Factory',5);
		...
		order=800;new Game.TieredUpgrade('Brane transplant','Portals are <b>twice</b> as efficient.<q>This refers to the practice of merging higher dimensional universes, or "branes", with our own, in order to facilitate transit (and harvesting of precious bread dough).</q>','Portal',5);
		...
		order=10030;
		Game.NewUpgradebread({name:'Caramoas',desc:'Yeah. That\'s got a nice ring to it.',icon:[14,4],require:'Box of brand biscuits',power:					3,	price:	9999999999999999});
		Game.NewUpgradebread({name:'Sagalongs',desc:'Grandma\'s favorite?',icon:[15,3],require:'Box of brand biscuits',power:									3,	price:	9999999999999999});
		Game.NewUpgradebread({name:'Shortfoils',desc:'Foiled again!',icon:[15,4],require:'Box of brand biscuits',power:										3,	price:	9999999999999999});
		Game.NewUpgradebread({name:'Win mints',desc:'They\'re the luckiest breads you\'ve ever tasted!',icon:[14,3],require:'Box of brand biscuits',power:	3,	price:	9999999999999999});
		
		order=40000;
		new Game.Upgrade('Perfect idling','You keep producing breads even while the game is closed.<q>It\'s the most beautiful thing I\'ve ever seen.</q>',7,[10,0]);//debug purposes only
		Game.last.pool='debug';
		
		order=10030;
		Game.NewUpgradebread({name:'Fig gluttons',desc:'Got it all figured out.',icon:[17,4],require:'Box of brand biscuits',power:													2,	price:	999999999999999*5});
		Game.NewUpgradebread({name:'Loreols',desc:'Because, uh... they\'re worth it?',icon:[16,3],require:'Box of brand biscuits',power:												2,	price:	999999999999999*5});
		Game.NewUpgradebread({name:'Jaffa cakes',desc:'If you want to bake a bread from scratch, you must first build a factory.',icon:[17,3],require:'Box of brand biscuits',power:	2,	price:	999999999999999*5});
		Game.NewUpgradebread({name:'Grease\'s cups',desc:'Extra-greasy peanut butter.',icon:[16,4],require:'Box of brand biscuits',power:												2,	price:	999999999999999*5});
		...
		new Game.Upgrade('Heavenly bread stand','Unlocks <b>25%</b> of the potential of your prestige level.<q>Don\'t forget to visit the heavenly lemonade stand afterwards. When afterlife gives you lemons...</q>',1111,[18,7]);Game.last.noPerm=1;
		...
		order=10100;
		Game.NewUpgradebread({name:'Skull breads',desc:'Wanna know something spooky? You\'ve got one of these inside your head RIGHT NOW.',locked:1,icon:[12,8],power:	2, price: 444444444444});
		Game.NewUpgradebread({name:'Ghost breads',desc:'They\'re something strange, but they look pretty good!',locked:1,icon:[13,8],power:								2, price: 444444444444});
		Game.NewUpgradebread({name:'Bat breads',desc:'The breads this town deserves.',locked:1,icon:[14,8],power:														2, price: 444444444444});
		Game.NewUpgradebread({name:'Slime breads',desc:'The incredible melting breads!',locked:1,icon:[15,8],power: 														2, price: 444444444444});
		Game.NewUpgradebread({name:'Pumpkin breads',desc:'Not even pumpkin-flavored. Tastes like glazing. Yeugh.',locked:1,icon:[16,8],power:								2, price: 444444444444});
		Game.NewUpgradebread({name:'Eyeball breads',desc:'When you stare into the bread, the bread stares back at you.',locked:1,icon:[17,8],power:						2, price: 444444444444});
		Game.NewUpgradebread({name:'Spider breads',desc:'You found the recipe on the web. They do whatever a bread can.',locked:1,icon:[18,8],power:						2, price: 444444444444});
		
		Game.halloweenDrops=['Skull breads','Ghost breads','Bat breads','Slime breads','Pumpkin breads','Eyeball breads','Spider breads'];
		...
		{
			Game.Upgrades[Game.halloweenDrops[i]].descFunc=function(){return '<div style="text-align:center;">You currently own <b>'+Game.GetHowManyHalloweenDrops()+'/'+Game.halloweenDrops.length+'</b> halloween breads.</div><div class="line"></div>'+this.desc;};
		}*/
		...
		order=10200;
		Game.NewUpgradebread({name:'Christmas tree biscuits',desc:'Whose pine is it anyway?',locked:1,icon:[12,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Snowflake biscuits',desc:'Mass-produced to be unique in every way.',locked:1,icon:[13,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Snowman biscuits',desc:'It\'s frosted. Doubly so.',locked:1,icon:[14,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Holly biscuits',desc:'You don\'t smooch under these ones. That would be the mistletoe (which, botanically, is a smellier variant of the mistlefinger).',locked:1,icon:[15,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Candy cane biscuits',desc:'It\'s two treats in one!<br>(Further inspection reveals the frosting does not actually taste like peppermint, but like mundane sugary frosting.)',locked:1,icon:[16,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Bell biscuits',desc:'What do these even have to do with christmas? Who cares, ring them in!',locked:1,icon:[17,10],power:2,price: 252525252525});
		Game.NewUpgradebread({name:'Present biscuits',desc:'The prequel to future biscuits. Watch out!',locked:1,icon:[18,10],power:2,price: 252525252525});
		
		order=10020;
		Game.NewUpgradebread({name:'Gingerbread men',desc:'You like to bite the legs off first, right? How about tearing off the arms? You sick monster.',icon:[18,4],power:		2,price: 9999999999999999});
		Game.NewUpgradebread({name:'Gingerbread trees',desc:'Evergreens in pastry form. Yule be surprised what you can come up with.',icon:[18,3],power:							2,price: 9999999999999999});
		...
		new Game.Upgrade('Increased merriness','bread production multiplier <b>+15%</b>.<br>Cost scales with Santa level.<q>It turns out that the key to increased merriness, strangely enough, happens to be a good campfire and some s\'mores.<br>You know what they say, after all; the s\'more, the merrier.</q>',2525,[17,9]);
		new Game.Upgrade('Improved jolliness','bread production multiplier <b>+15%</b>.<br>Cost scales with Santa level.<q>A nice wobbly belly goes a long way.<br>You jolly?</q>',2525,[17,9]);
		new Game.Upgrade('A lump of coal','bread production multiplier <b>+1%</b>.<br>Cost scales with Santa level.<q>Some of the world\'s worst stocking stuffing.<br>I guess you could try starting your own little industrial revolution, or something?...</q>',2525,[13,9]);
		new Game.Upgrade('An itchy sweater','bread production multiplier <b>+1%</b>.<br>Cost scales with Santa level.<q>You don\'t know what\'s worse : the embarrassingly quaint "elf on reindeer" motif, or the fact that wearing it makes you feel like you\'re wrapped in a dead sasquatch.</q>',2525,[14,9]);
		...
		new Game.Upgrade('Santa\'s legacy','bread production multiplier <b>+3% per Santa\'s levels</b>.<br>Cost scales with Santa level.<q>In the north pole, you gotta get the elves first. Then when you get the elves, you start making the toys. Then when you get the toys... then you get the breads.</q>',2525,[19,9]);
		new Game.Upgrade('Santa\'s milk and breads','Milk is <b>5% more powerful</b>.<br>Cost scales with Santa level.<q>Part of Santa\'s dreadfully unbalanced diet.</q>',2525,[19,9]);
		...
		order=25000;
		new Game.Upgrade('Santa\'s dominion','bread production multiplier <b>+20%</b>.<br>All buildings are <b>1% cheaper</b>.<br>All upgrades are <b>2% cheaper</b>.<q>My name is Claus, king of kings;<br>Look on my toys, ye Mighty, and despair!</q>',2525252525252525,[19,10],function(){Game.storeToRefresh=1;});
		...
		Game.NewUpgradebread({name:'Pure heart biscuits',desc:'Melty white chocolate<br>that says "I *like* like you".',season:'valentines',icon:[19,3],													power:heartPower,price: 1000000});
		Game.NewUpgradebread({name:'Ardent heart biscuits',desc:'A red hot cherry biscuit that will nudge the target of your affection in interesting directions.',require:Game.last.name,season:'valentines',icon:[20,3],			power:heartPower,price: 1000000000});
		Game.NewUpgradebread({name:'Sour heart biscuits',desc:'A bitter lime biscuit for the lonely and the heart-broken.',require:Game.last.name,season:'valentines',icon:[20,4],													power:heartPower,price: 1000000000000});
		Game.NewUpgradebread({name:'Weeping heart biscuits',desc:'An ice-cold blueberry biscuit, symbol of a mending heart.',require:Game.last.name,season:'valentines',icon:[21,3],												power:heartPower,price: 1000000000000000});
		Game.NewUpgradebread({name:'Golden heart biscuits',desc:'A beautiful biscuit to symbolize kindness, true love, and sincerity.',require:Game.last.name,season:'valentines',icon:[21,4],										power:heartPower,price: 1000000000000000000});
		Game.NewUpgradebread({name:'Eternal heart biscuits',desc:'Silver icing for a very special someone you\'ve liked for a long, long time.',require:Game.last.name,season:'valentines',icon:[19,4],							power:heartPower,price: 1000000000000000000000});
		...
		order=255;
		Game.GrandmaSynergy('Rainbow grandmas','A luminous grandma to sparkle into breads.','Prism');
		...
		order=500;new Game.TieredUpgrade('Deep-bake process','Factories are <b>twice</b> as efficient.<q>A patented process increasing bread yield two-fold for the same amount of ingredients. Don\'t ask how, don\'t take pictures, and be sure to wear your protective suit.</q>','Factory',6);
		...
		order=600;new Game.TieredUpgrade('Generation ship','Shipments are <b>twice</b> as efficient.<q>Built to last, this humongous spacecraft will surely deliver your breads to the deep ends of space, one day.</q>','Shipment',6);
		...
		order=900;new Game.TieredUpgrade('Far future enactment','Time machines are <b>twice</b> as efficient.<q>The far future enactment authorizes you to delve deep into the future - where civilization has fallen and risen again, and breads are plentiful.</q>','Time machine',6);
		...
		order=10032;
		Game.NewUpgradebread({name:'Rose macarons',desc:'Although an odd flavor, these pastries recently rose in popularity.',icon:[22,3],require:'Box of macarons',		power:3,price: 9999});
		Game.NewUpgradebread({name:'Lemon macarons',desc:'Tastefully sour, delightful treats.',icon:[23,3],require:'Box of macarons',										power:3,price: 9999999});
		Game.NewUpgradebread({name:'Chocolate macarons',desc:'They\'re like tiny sugary burgers!',icon:[24,3],require:'Box of macarons',									power:3,price: 9999999999});
		Game.NewUpgradebread({name:'Pistachio macarons',desc:'Pistachio shells now removed after multiple complaints.',icon:[22,4],require:'Box of macarons',										power:3,price: 9999999999999});
		Game.NewUpgradebread({name:'Hazelnut macarons',desc:'These go especially well with coffee.',icon:[23,4],require:'Box of macarons',									power:3,price: 9999999999999999});
		Game.NewUpgradebread({name:'Violet macarons',desc:'It\'s like spraying perfume into your mouth!',icon:[24,4],require:'Box of macarons',							power:3,price: 9999999999999999999});
		
		order=40000;
		new Game.Upgrade('Magic shenanigans','bread production <b>multiplied by 1,000</b>.<q>It\'s magic. I ain\'t gotta explain sh<div style="display:inline-block;background:url(img/money.png);width:16px;height:16px;position:relative;top:4px;left:0px;margin:0px -2px;"></div>t.</q>',7,[17,5]);//debug purposes only
		Game.last.pool='debug';
		...
		new Game.Upgrade('Chicken egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>The egg. The egg came first. Get over it.</q>',eggPrice,[1,12]);
		new Game.Upgrade('Duck egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Then he waddled away.</q>',eggPrice,[2,12]);
		new Game.Upgrade('Turkey egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These hatch into strange, hand-shaped creatures.</q>',eggPrice,[3,12]);
		new Game.Upgrade('Quail egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These eggs are positively tiny. I mean look at them. How does this happen? Whose idea was that?</q>',eggPrice,[4,12]);
		new Game.Upgrade('Robin egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Holy azure-hued shelled embryos!</q>',eggPrice,[5,12]);
		new Game.Upgrade('Ostrich egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>One of the largest eggs in the world. More like ostrouch, am I right?<br>Guys?</q>',eggPrice,[6,12]);
		new Game.Upgrade('Cassowary egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>The cassowary is taller than you, possesses murderous claws and can easily outrun you.<br>You\'d do well to be casso-wary of them.</q>',eggPrice,[7,12]);
		new Game.Upgrade('Salmon roe','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Do the impossible, see the invisible.<br>Roe roe, fight the power?</q>',eggPrice,[8,12]);
		new Game.Upgrade('Frogspawn','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>I was going to make a pun about how these "toadally look like eyeballs", but froget it.</q>',eggPrice,[9,12]);
		new Game.Upgrade('Shark egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>HELLO IS THIS FOOD?<br>LET ME TELL YOU ABOUT FOOD.<br>WHY DO I KEEP EATING MY FRIENDS</q>',eggPrice,[10,12]);
		new Game.Upgrade('Turtle egg','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>Turtles, right? Hatch from shells. Grow into shells. What\'s up with that?<br>Now for my skit about airplane food.</q>',eggPrice,[11,12]);
		new Game.Upgrade('Ant larva','bread production multiplier <b>+1%</b>.<br>Cost scales with how many eggs you own.<q>These are a delicacy in some countries, I swear. You will let these invade your digestive tract, and you will derive great pleasure from it.<br>And all will be well.</q>',eggPrice,[12,12]);
		new Game.Upgrade('Golden goose egg','Golden breads appear <b>5% more often</b>.<br>Cost scales with how many eggs you own.<q>The sole vestige of a tragic tale involving misguided investments.</q>',eggPrice2,[13,12]);
		...
		new Game.Upgrade('Wrinklerspawn','Wrinklers explode into <b>5% more breads</b>.<br>Cost scales with how many eggs you own.<q>Look at this little guy! It\'s gonna be a big boy someday! Yes it is!</q>',eggPrice2,[15,12]);
		new Game.Upgrade('bread egg','Clicking is <b>10% more powerful</b>.<br>Cost scales with how many eggs you own.<q>The shell appears to be chipped.<br>I wonder what\'s inside this one!</q>',eggPrice2,[16,12]);
		...
		new Game.Upgrade('Chocolate egg','Contains <b>a lot of breads</b>.<br>Cost scales with how many eggs you own.<q>Laid by the elusive cocoa bird. There\'s a surprise inside!</q>',eggPrice2,[18,12],function()
		{
			var breads=Game.breads*0.05;
			if (Game.prefs.popups) Game.Popup('The chocolate egg bursts into<br>'+Beautify(breads)+'!');
			else Game.Notify('Chocolate egg','The egg bursts into <b>'+Beautify(breads)+'</b> breads!',Game.Upgrades['Chocolate egg'].icon);
			Game.Earn(breads);
		});
		...
		Game.easterEggs=['Chicken egg','Duck egg','Turkey egg','Quail egg','Robin egg','Ostrich egg','Cassowary egg','Salmon roe','Frogspawn','Shark egg','Turtle egg','Ant larva','Golden goose egg','Faberge egg','Wrinklerspawn','bread egg','Omelette','Chocolate egg','Century egg','"egg"'];
		...
		Game.rareEggDrops=['Golden goose egg','Faberge egg','Wrinklerspawn','bread egg','Omelette','Chocolate egg','Century egg','"egg"'];
		...
		//{Game.Upgrades[Game.eggDrops[i]].priceFunc=function(){return Math.pow(Game.GetHowManyEggs()+1,2)*Game.breadsPs*60*5;}}
		...
		//{Game.Upgrades[Game.rareEggDrops[i]].priceFunc=function(){return Math.pow(Game.GetHowManyEggs()+1,3)*Game.breadsPs*60*5;}}
		...
		order=10032;
		Game.NewUpgradebread({name:'Caramel macarons',desc:'The saltiest, chewiest of them all.',icon:[25,3],require:'Box of macarons',		power:3,price: 9999999999999999999999});
		Game.NewUpgradebread({name:'Licorice macarons',desc:'Also known as "blackarons".',icon:[25,4],require:'Box of macarons',				power:3,price: 9999999999999999999999999});
		...
		order=550;
		new Game.TieredUpgrade('Golden idols','Temples are <b>twice</b> as efficient.<q>Lure even greedier adventurers to retrieve your breads. Now that\'s a real idol game!</q>','Temple',1);
		new Game.TieredUpgrade('Sacrifices','Temples are <b>twice</b> as efficient.<q>What\'s a life to a gigaton of breads?</q>','Temple',2);
		...
		new Game.TieredUpgrade('School of sorcery','Wizard towers are <b>twice</b> as efficient.<q>This bread-funded academy of witchcraft is home to the 4 prestigious houses of magic : the Jocks, the Nerds, the Preps, and the Deathmunchers.</q>','Wizard tower',5);
		new Game.TieredUpgrade('Dark formulas','Wizard towers are <b>twice</b> as efficient.<q>Eldritch forces are at work behind these spells - you get the feeling you really shouldn\'t be messing with those. But I mean, free breads, right?</q>','Wizard tower',6);

		order=250;
		Game.GrandmaSynergy('Banker grandmas','A nice banker to cash in more breads.','Bank');
		Game.GrandmaSynergy('Priestess grandmas','A nice priestess to praise the one true Baker in the sky.','Temple');
		Game.GrandmaSynergy('Witch grandmas','A nice witch to cast a zip, and a zoop, and poof! breads.','Wizard tower');
		
		
		
		order=0;
		new Game.Upgrade('Tin of british tea biscuits','Contains an assortment of fancy biscuits.<q>Every time is tea time.</q>',25,[21,8]);Game.last.pool='prestige';Game.last.parents=['Heavenly breads'];
		new Game.Upgrade('Box of macarons','Contains an assortment of macarons.<q>Multicolored delicacies filled with various kinds of jam.<br>Not to be confused with macaroons, macaroni, macarena or any of that nonsense.</q>',25,[20,8]);Game.last.pool='prestige';Game.last.parents=['Heavenly breads'];
		new Game.Upgrade('Box of brand biscuits','Contains an assortment of popular biscuits.<q>They\'re brand new!</q>',25,[20,9]);Game.last.pool='prestige';Game.last.parents=['Heavenly breads'];
	
		order=10020;
		Game.NewUpgradebread({name:'Pure black chocolate breads',desc:'Dipped in a lab-made substance darker than the darkest cocoa (dubbed "chocoalate").',icon:[26,3],power:									5,price: 9999999999999999*5});
		Game.NewUpgradebread({name:'Pure white chocolate breads',desc:'Elaborated on the nano-scale, the coating on this biscuit is able to refract light even in a pitch-black environment.',icon:[26,4],power:	5,price: 9999999999999999*5});
		Game.NewUpgradebread({name:'Ladyfingers',desc:'Cleaned and sanitized so well you\'d swear they\'re actual biscuits.',icon:[27,3],power:																	3,price: 99999999999999999});
		Game.NewUpgradebread({name:'Tuiles',desc:'These never go out of tile.',icon:[27,4],power:																													3,price: 99999999999999999*5});
		Game.NewUpgradebread({name:'Chocolate-stuffed biscuits',desc:'A princely snack!<br>The holes are so the chocolate stuffing can breathe.',icon:[28,3],power:												3,price: 999999999999999999});
		Game.NewUpgradebread({name:'Checker breads',desc:'A square bread? This solves so many storage and packaging problems! You\'re a genius!',icon:[28,4],power:												3,price: 999999999999999999*5});
		Game.NewUpgradebread({name:'Butter breads',desc:'These melt right off your mouth and into your heart. (Let\'s face it, they\'re rather fattening.)',icon:[29,3],power:									3,price: 9999999999999999999});
		Game.NewUpgradebread({name:'Cream breads',desc:'It\'s like two chocolate chip breads! But brought together with the magic of cream! It\'s fiendishly perfect!',icon:[29,4],power:						3,price: 9999999999999999999*5});
		...
		Game.AssignPermanentSlot=function(slot)
		{
			...
			{
				var me=Game.Upgrades[i];
				if (me.bought && me.unlocked && !me.noPerm && (me.pool=='' || me.pool=='bread'))
				{
					var fail=0;
		...
		new Game.Upgrade('Starspawn','Eggs drop <b>10%</b> more often.<br>Golden breads appear <b>2%</b> more often during Easter.',111111,[0,12]);Game.last.pool='prestige';Game.last.parents=['Season switcher'];
		new Game.Upgrade('Starsnow','Christmas breads drop <b>5%</b> more often.<br>Reindeer appear <b>5%</b> more often.',111111,[12,9]);Game.last.pool='prestige';Game.last.parents=['Season switcher'];
		new Game.Upgrade('Starterror','Spooky breads drop <b>10%</b> more often.<br>Golden breads appear <b>2%</b> more often during Halloween.',111111,[13,8]);Game.last.pool='prestige';Game.last.parents=['Season switcher'];
		new Game.Upgrade('Starlove','Heart breads are <b>50%</b> more powerful.<br>Golden breads appear <b>2%</b> more often during Valentines.',111111,[20,3]);Game.last.pool='prestige';Game.last.parents=['Season switcher'];
		new Game.Upgrade('Startrade','Golden breads appear <b>5%</b> more often during Business day.',111111,[17,6]);Game.last.pool='prestige';Game.last.parents=['Season switcher'];
		...
		new Game.Upgrade('Twin Gates of Transcendence','You now <b>keep making breads while the game is closed</b>, at the rate of <b>5%</b> of your regular CpS and up to <b>1 hour</b> after the game is closed.<br>(Beyond 1 hour, this is reduced by a further 90% - your rate goes down to <b>0.5%</b> of your CpS.)<q>This is one occasion you\'re always underdressed for. Don\'t worry, just rush in past the bouncer and pretend you know people.</q>',1,[15,11]);Game.last.pool='prestige';

		new Game.Upgrade('Heavenly luck','Golden breads appear <b>5%</b> more often.<q>Someone up there likes you.</q>',77,[22,6]);Game.last.pool='prestige';
		new Game.Upgrade('Lasting fortune','Golden breads effects last <b>10%</b> longer.<q>This isn\'t your average everyday luck. This is... advanced luck.</q>',777,[23,6]);Game.last.pool='prestige';Game.last.parents=['Heavenly luck'];
		new Game.Upgrade('Decisive fate','Golden breads stay <b>5%</b> longer.<q>Life just got a bit more intense.</q>',7777,[10,14]);Game.last.pool='prestige';Game.last.parents=['Lasting fortune'];
		...
		new Game.Upgrade('Divine bakeries','bread upgrades are <b>5 times cheaper</b>.<q>They sure know what they\'re doing.</q>',399999,[17,7]);Game.last.pool='prestige';Game.last.parents=['Divine sales','Divine discount'];
		
		new Game.Upgrade('Starter kit','You start with <b>10 cursors</b>.<q>This can come in handy.</q>',50,[0,14]);Game.last.pool='prestige';Game.last.parents=['Tin of british tea biscuits','Box of macarons','Box of brand biscuits','Tin of butter breads'];
		...
		new Game.Upgrade('Halo gloves','Clicks are <b>10% more powerful</b>.<q>Smite that bread.</q>',55555,[22,7]);Game.last.pool='prestige';Game.last.parents=['Starter kit'];
		...
		new Game.Upgrade('Sacrilegious corruption','Wrinklers regurgitate <b>5%</b> more breads.<q>Unique in the animal kingdom, the wrinkler digestive tract is able to withstand an incredible degree of dilation - provided you prod them appropriately.</q>',444444,[19,8]);Game.last.pool='prestige';Game.last.parents=['Unholy bait'];
		...
		order=300;new Game.TieredUpgrade('Fudge fungus','Farms are <b>twice</b> as efficient.<q>A sugary parasite whose tendrils help bread growth.<br>Please do not breathe in the spores. In case of spore ingestion, seek medical help within the next 36 seconds.</q>','Farm',7);
		...
		order=550;new Game.TieredUpgrade('Creation myth','Temples are <b>twice</b> as efficient.<q>Stories have been circulating about the origins of the very first bread that was ever baked; tales of how it all began, in the Dough beyond time and the Ovens of destiny.</q>','Temple',7);
		order=575;new Game.TieredUpgrade('breadmancy','Wizard towers are <b>twice</b> as efficient.<q>There it is; the perfected school of baking magic. From summoning chips to hexing nuts, there is not a single part of bread-making that hasn\'t been improved tenfold by magic tricks.</q>','Wizard tower',7);
		...
		order=900;new Game.TieredUpgrade('Great loop hypothesis','Time machines are <b>twice</b> as efficient.<q>What if our universe is just one instance of an infinite cycle? What if, before and after it, stretched infinite amounts of the same universe, themselves containing infinite amounts of breads?</q>','Time machine',7);
		order=1000;new Game.TieredUpgrade('The Pulse','Antimatter condensers are <b>twice</b> as efficient.<q>You\'ve tapped into the very pulse of the cosmos, a timeless rhythm along which every material and antimaterial thing beats in unison. This, somehow, means more breads.</q>','Antimatter condenser',7);
		order=1100;
		...
		order=550;new Game.TieredUpgrade('Theocracy','Temples are <b>twice</b> as efficient.<q>You\'ve turned your bread empire into a perfect theocracy, gathering the adoration of zillions of followers from every corner of the universe.<br>Don\'t let it go to your head.</q>','Temple',8);
		order=575;new Game.TieredUpgrade('Rabbit trick','Wizard towers are <b>twice</b> as efficient.<q>Using nothing more than a fancy top hat, your wizards have found a way to simultaneously curb rabbit population and produce heaps of extra breads for basically free!<br>Resulting breads may or may not be fit for vegans.</q>','Wizard tower',8);
		...
		order=700;new Game.TieredUpgrade('Beige goo','Alchemy labs are <b>twice</b> as efficient.<q>Well now you\'ve done it. Good job. Very nice. That\'s 3 galaxies you\'ve just converted into breads. Good thing you can hop from universe to universe.</q>','Alchemy lab',8);
		...
		order=900;new Game.TieredUpgrade('breadtopian moments of maybe','Time machines are <b>twice</b> as efficient.<q>Reminiscing how things could have been, should have been, will have been.</q>','Time machine',8);
		...
		new Game.Upgrade('Kitten experts','You gain <b>more CpS</b> the more milk you have.<q>10 years expurrrtise in the bread business, sir</q>',900000000000000000000000000000,Game.GetIcon('Kitten',8));Game.last.kitten=1;Game.MakeTiered(Game.last,8,18);
		
		new Game.Upgrade('How to bake your dragon','Allows you to purchase a <b>crumbly egg</b> once you have earned 1 million breads.<q>A tome full of helpful tips such as "oh god, stay away from it", "why did we buy this thing, it\'s not even house-broken" and "groom twice a week in the direction of the scales".</q>',9,[22,12]);Game.last.pool='prestige';

		order=25100;
		new Game.Upgrade('A crumbly egg','Unlocks the <b>bread dragon egg</b>.<q>Thank you for adopting this robust, fun-loving bread dragon! It will bring you years of joy and entertainment.<br>Keep in a dry and cool place, and away from other house pets. Subscription to home insurance is strongly advised.</q>',25,[21,12]);
		
		new Game.Upgrade('Chimera','Synergy upgrades are <b>2% cheaper</b>.<br>You gain another <b>+5%</b> of your regular CpS while the game is closed.<br>You retain optimal bread production while the game is closed for <b>2 more days</b>.<q>More than the sum of its parts.</q>',Math.pow(angelPriceFactor,9),[24,7]);Game.last.pool='prestige';Game.last.parents=['God','Lucifer','Synergies Vol. II'];
		
		new Game.Upgrade('Tin of butter breads','Contains an assortment of rich butter breads.<q>Five varieties of danish breads.<br>Complete with little paper cups.</q>',25,[21,9]);Game.last.pool='prestige';Game.last.parents=['Heavenly breads'];
		
		new Game.Upgrade('Golden switch','Unlocks the <b>golden switch</b>, which passively boosts your CpS by 50% but disables golden breads.<q>Less clicking, more idling.</q>',999,[21,10]);Game.last.pool='prestige';Game.last.parents=['Heavenly luck'];
		
		new Game.Upgrade('Classic dairy selection','Unlocks the <b>milk selector</b>, letting you pick which milk is displayed under your bread.<br>Comes with a variety of basic flavors.<q>Don\'t have a cow, man.</q>',9,[1,8]);Game.last.pool='prestige';Game.last.parents=[];
		...
		order=10300;
		Game.NewUpgradebread({name:'Dragon bread',desc:'Imbued with the vigor and vitality of a full-grown bread dragon, this mystical bread will embolden your empire for the generations to come.',icon:[10,25],power:5,price:9999999999999999*7,locked:1});
		
		
		order=40000;
		new Game.Upgrade('Golden switch [off]','Turning this on will give you a passive <b>+50% CpS</b>, but prevents golden breads from spawning.<br>Cost is equal to 1 hour of production.',1000000,[20,10]);
		Game.last.pool='toggle';Game.last.toggleInto='Golden switch [on]';
		Game.last.priceFunc=function(){return Game.breadsPs*60*60;}
		var func=function(){
			if (Game.Has('Residual luck'))
			{
				var bonus=0;
				...
				return '<div style="text-align:center;">'+Game.listTinyOwnedUpgrades(Game.goldenbreadUpgrades)+'<br><br>The effective boost is <b>+'+Beautify(Math.round(50+bonus*10))+'%</b><br>thanks to residual luck<br>and your <b>'+bonus+'</b> golden bread upgrade'+(bonus==1?'':'s')+'.</div><div class="line"></div>'+this.desc;
			}
			return this.desc;
		};
		Game.last.descFunc=func;
		
		new Game.Upgrade('Golden switch [on]','The switch is currently giving you a passive <b>+50% CpS</b>; it also prevents golden breads from spawning.<br>Turning it off will revert those effects.<br>Cost is equal to 1 hour of production.',1000000,[21,10]);
		...
		Game.NewUpgradebread({name:'Milk chocolate butter biscuit',desc:'Rewarded for owning 100 of everything.<br>It bears the engraving of a fine entrepreneur.',icon:[27,8],power:	10,price: 999999999999999999999*butterBiscuitMult,locked:1});
		Game.NewUpgradebread({name:'Dark chocolate butter biscuit',desc:'Rewarded for owning 150 of everything.<br>It is adorned with the image of an experienced bread tycoon.',icon:[27,9],power:	10,price: 999999999999999999999999*butterBiscuitMult,locked:1});
		Game.NewUpgradebread({name:'White chocolate butter biscuit',desc:'Rewarded for owning 200 of everything.<br>The chocolate is chiseled to depict a masterful pastry magnate.',icon:[28,9],power:	10,price: 999999999999999999999999999*butterBiscuitMult,locked:1});
		Game.NewUpgradebread({name:'Ruby chocolate butter biscuit',desc:'Rewarded for owning 250 of everything.<br>Covered in a rare red chocolate, this biscuit is etched to represent the face of a bread industrialist gone mad with power.',icon:[28,8],power:	10,price: 999999999999999999999999999999*butterBiscuitMult,locked:1});
		
		order=10020;
		Game.NewUpgradebread({name:'Gingersnaps',desc:'breads with a soul. Probably.',icon:[29,10],power:						4,price: 99999999999999999999});
		Game.NewUpgradebread({name:'Cinnamon breads',desc:'The secret is in the patented swirly glazing.',icon:[23,8],power:						4,price: 99999999999999999999*5});
		Game.NewUpgradebread({name:'Vanity breads',desc:'One tiny candied fruit sits atop this decadent bread.',icon:[22,8],power:						4,price: 999999999999999999999});
		Game.NewUpgradebread({name:'Cigars',desc:'Close, but no match for those extravagant bread straws they serve in coffee shops these days.',icon:[25,8],power:						4,price: 999999999999999999999*5});
		Game.NewUpgradebread({name:'Pinwheel breads',desc:'Bringing you the dizzying combination of brown flavor and beige taste!',icon:[22,10],power:						4,price: 9999999999999999999999});
		Game.NewUpgradebread({name:'Fudge squares',desc:'Not exactly breads, but you won\'t care once you\'ve tasted one of these.<br>They\'re so good, it\'s fudged-up!',icon:[24,8],power:						4,price: 9999999999999999999999*5});
		
		order=10030;
		Game.NewUpgradebread({name:'Digits',desc:'Three flavors, zero phalanges.',icon:[26,8],require:'Box of brand biscuits',power:												2,	price:	999999999999999*5});
		
		order=10029;
		Game.NewUpgradebread({name:'Butter horseshoes',desc:'It would behoove you to not overindulge in these.',icon:[22,9],require:'Tin of butter breads',power:							4,	price:	99999999999999999999999});
		Game.NewUpgradebread({name:'Butter pucks',desc:'Lord, what fools these mortals be!<br>(This is kind of a hokey reference.)',icon:[23,9],require:'Tin of butter breads',power:							4,	price:	99999999999999999999999*5});
		Game.NewUpgradebread({name:'Butter knots',desc:'Look, you can call these pretzels if you want, but you\'d just be fooling yourself, wouldn\'t you?',icon:[24,9],require:'Tin of butter breads',power:							4,	price:	999999999999999999999999});
		Game.NewUpgradebread({name:'Butter slabs',desc:'Nothing butter than a slab to the face.',icon:[25,9],require:'Tin of butter breads',power:							4,	price:	999999999999999999999999*5});
		Game.NewUpgradebread({name:'Butter swirls',desc:'These are equal parts sugar, butter, and warm fuzzy feelings - all of which cause millions of deaths everyday.',icon:[26,9],require:'Tin of butter breads',power:							4,	price:	9999999999999999999999999});
		
		order=10020;
		Game.NewUpgradebread({name:'Shortbread biscuits',desc:'These rich butter breads are neither short, nor bread. What a country!',icon:[23,10],power:						4,price: 99999999999999999999999});
		Game.NewUpgradebread({name:'Millionaires\' shortbreads',desc:'Three thought-provoking layers of creamy chocolate, hard-working caramel and crumbly biscuit in a poignant commentary of class struggle.',icon:[24,10],power:						4,price: 99999999999999999999999*5});
		Game.NewUpgradebread({name:'Caramel breads',desc:'The polymerized carbohydrates adorning these breads are sure to stick to your teeth for quite a while.',icon:[25,10],power:						4,price: 999999999999999999999999});
		...
		var desc=function(totalHours){
			...
			return 'You retain optimal bread production while the game is closed for twice as long, for a total of <b>'+str+'</b>.';
		}
		...
		new Game.Upgrade('Asmodeus',desc(32)+'<q>This demon with three monstrous heads draws his power from the all-consuming desire for breads and all things sweet.</q>',Math.pow(angelPriceFactor,5),[11,11]);Game.last.pool='prestige';Game.last.parents=['Satan'];
		...
		new Game.Upgrade('Golden bread alert sound','Unlocks the <b>golden bread sound selector</b>, which lets you pick whether golden breads emit a sound when appearing or not.<q>A sound decision.</q>',9999,[28,6]);Game.last.pool='prestige';Game.last.parents=['Decisive fate','Golden switch'];
		
		order=49900;
		new Game.Upgrade('Golden bread sound selector','Lets you change the sound golden breads make when they spawn.',0,[28,6]);
		Game.last.descFunc=function(){
		...
		new Game.Upgrade('Legacy','This is the first heavenly upgrade; it unlocks the <b>Heavenly chips</b> system.<div class="line"></div>Each time you ascend, the breads you made in your past life are turned into <b>heavenly chips</b> and <b>prestige</b>.<div class="line"></div><b>Heavenly chips</b> can be spent on a variety of permanent transcendental upgrades.<div class="line"></div>Your <b>prestige level</b> also gives you a permanent <b>+1% CpS</b> per level.<q>We\'ve all been waiting for you.</q>',1,[21,6]);Game.last.pool='prestige';Game.last.parents=[];
		
		new Game.Upgrade('Elder spice','You can attract <b>2 more wrinklers</b>.<q>The bread your bread could smell like.</q>',444444,[19,8]);Game.last.pool='prestige';Game.last.parents=['Unholy bait'];
		
		new Game.Upgrade('Residual luck','While the golden switch is on, you gain an additional <b>+10% CpS</b> per golden bread upgrade owned.<q>Fortune comes in many flavors.</q>',99999,[27,6]);Game.last.pool='prestige';Game.last.parents=['Golden switch'];
		...
		Game.SynergyUpgrade('Gold fund','<q>If gold is the backbone of the economy, breads, surely, are its hip joints.</q>','Alchemy lab','Bank','synergy2');
		...
		new Game.Upgrade('Heavenly breads','bread production multiplier <b>+10% permanently</b>.<q>Baked with heavenly chips. An otherwordly flavor that transcends time and space.</q>',3,[25,12]);Game.last.pool='prestige';Game.last.parents=['Legacy'];Game.last.power=10;Game.last.pseudobread=true;
		new Game.Upgrade('Wrinkly breads','bread production multiplier <b>+10% permanently</b>.<q>The result of regular breads left to age out for countless eons in a place where time and space are meaningless.</q>',6666666,[26,12]);Game.last.pool='prestige';Game.last.parents=['Sacrilegious corruption','Elder spice'];Game.last.power=10;Game.last.pseudobread=true;
		new Game.Upgrade('Distilled essence of redoubled luck','Golden breads (and all other things that spawn, such as reindeer) have <b>1% chance of being doubled</b>.<q>Tastes glittery. The empty phial makes for a great pencil holder.</q>',7777777,[27,12]);Game.last.pool='prestige';Game.last.parents=['Divine bakeries','Residual luck'];
		
		order=40000;
		new Game.Upgrade('Occult obstruction','bread production <b>reduced to 0</b>.<q>If symptoms persist, consult a doctor.</q>',7,[15,5]);//debug purposes only
		Game.last.pool='debug';
		...
		order=10300;
		Game.NewUpgradebread({name:'Lavender chocolate butter biscuit',desc:'Rewarded for owning 300 of everything.<br>This subtly-flavored biscuit represents the accomplishments of decades of top-secret research. The molded design on the chocolate resembles a well-known entrepreneur who gave their all to the ancient path of baking.',icon:[26,10],power:	10,price: 999999999999999999999999999999999*butterBiscuitMult,locked:1});
		
		order=10030;
		Game.NewUpgradebread({name:'Lombardia breads',desc:'These come from those farms with the really good memory.',icon:[23,13],require:'Box of brand biscuits',power:												3,	price:	999999999999999999999*5});
		Game.NewUpgradebread({name:'Bastenaken breads',desc:'French breads made of delicious cinnamon and candy sugar. These do not contain Nuts!',icon:[24,13],require:'Box of brand biscuits',power:												3,	price:	999999999999999999999*5});
		
		order=10020;
		Game.NewUpgradebread({name:'Pecan sandies',desc:'Stick a nut on a bread and call it a day! Name your band after it! Whatever!',icon:[25,13],power:						4,price: 999999999999999999999999*5});
		Game.NewUpgradebread({name:'Moravian spice breads',desc:'Popular for being the world\'s moravianest breads.',icon:[26,13],power:						4,price: 9999999999999999999999999});
		Game.NewUpgradebread({name:'Anzac biscuits',desc:'Army biscuits from a bakery down under, containing no eggs but yes oats.',icon:[27,13],power:						4,price: 9999999999999999999999999*5});
		Game.NewUpgradebread({name:'Buttercakes',desc:'Glistening with cholesterol, these breads moistly straddle the line between the legal definition of a bread and just a straight-up stick of butter.',icon:[29,13],power:						4,price: 99999999999999999999999999});
		Game.NewUpgradebread({name:'Ice cream sandwiches',desc:'In an alternate universe, "ice cream sandwich" designates an ice cream cone filled with bacon, lettuce, and tomatoes. Maybe some sprinkles too.',icon:[28,13],power:						4,price: 99999999999999999999999999*5});
		
		new Game.Upgrade('Stevia Caelestis','Sugar lumps ripen <b>an hour sooner</b>.<q>A plant of supernatural sweetness grown by angels in heavenly gardens.</q>',100000000,[25,15]);Game.last.pool='prestige';Game.last.parents=['Wrinkly breads'];
		...
		new Game.Upgrade('Lucky digit','<b>+1%</b> prestige level effect on CpS.<br><b>+1%</b> golden bread effect duration.<br><b>+1%</b> golden bread lifespan.<q>This upgrade is a bit shy and only appears when your prestige level ends in 7.</q>',777,[24,15]);Game.last.pool='prestige';Game.last.parents=['Heavenly luck'];Game.last.showIf=function(){return (Math.ceil(Game.prestige)%10==7);};
		new Game.Upgrade('Lucky number','<b>+1%</b> prestige level effect on CpS.<br><b>+1%</b> golden bread effect duration.<br><b>+1%</b> golden bread lifespan.<q>This upgrade is a reclusive hermit and only appears when your prestige level ends in 777.</q>',77777,[24,15]);Game.last.pool='prestige';Game.last.parents=['Lucky digit','Lasting fortune'];Game.last.showIf=function(){return (Math.ceil(Game.prestige)%1000==777);};
		new Game.Upgrade('Lucky payout','<b>+1%</b> prestige level effect on CpS.<br><b>+1%</b> golden bread effect duration.<br><b>+1%</b> golden bread lifespan.<q>This upgrade took an oath of complete seclusion from the rest of the world and only appears when your prestige level ends in 777777.</q>',77777777,[24,15]);Game.last.pool='prestige';Game.last.parents=['Lucky number','Decisive fate'];Game.last.showIf=function(){return (Math.ceil(Game.prestige)%1000000==777777);};
		...
		order=255;
		Game.GrandmaSynergy('Lucky grandmas','A fortunate grandma that always seems to find more breads.','Chancemaker');
		
		order=1200;
		new Game.TieredUpgrade('Your lucky bread','Chancemakers are <b>twice</b> as efficient.<q>This is the first bread you\'ve ever baked. It holds a deep sentimental value and, after all this time, an interesting smell.</q>','Chancemaker',1);
		...
		Game.NewUpgradebread({name:'Birthday bread',desc:'-',icon:[22,13],power:years,price:99999999999999999999999999999});Game.last.baseDesc='bread production multiplier <b>+1%</b> for every year bread Clicker has existed (currently : <b>+'+Beautify(years)+'%</b>).<q>Thank you for playing bread Clicker!<br>-Orteil</q>';Game.last.desc=BeautifyInText(Game.last.baseDesc);
		...
		order=10020;
		Game.NewUpgradebread({name:'Pink biscuits',desc:'One of the oldest breads. Traditionally dipped in champagne to soften it, because the French will use any opportunity to drink.',icon:[21,16],power:						4,price: 999999999999999999999999999});
		Game.NewUpgradebread({name:'Whole-grain breads',desc:'Covered in seeds and other earthy-looking debris. Really going for that "5-second rule" look.',icon:[22,16],power:						4,price: 999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Candy breads',desc:'These melt in your hands just a little bit.',icon:[23,16],power:						4,price: 9999999999999999999999999999});
		Game.NewUpgradebread({name:'Big chip breads',desc:'You are in awe at the size of these chips. Absolute units.',icon:[24,16],power:						4,price: 9999999999999999999999999999*5});
		Game.NewUpgradebread({name:'One chip breads',desc:'You get one.',icon:[25,16],power:						1,price: 99999999999999999999999999999});
		...
		order=10020;
		Game.NewUpgradebread({name:'Sprinkles breads',desc:'A bit of festive decorating helps hide the fact that this might be one of the blandest breads you\'ve ever tasted.',icon:[21,14],power:						4,price: 99999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Peanut butter blossoms',desc:'Topped with a scrumptious chocolate squirt, which is something we really wish we didn\'t just write.',icon:[22,14],power:						4,price: 999999999999999999999999999999});
		Game.NewUpgradebread({name:'No-bake breads',desc:'You have no idea how these mysterious oven-less treats came to be or how they hold their shape. You\'re thinking either elephant glue or cold fusion.',icon:[21,15],power:						4,price: 999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Florentines',desc:'These make up for being the fruitcake of breads by at least having the decency to feature chocolate.',icon:[26,16],power:						4,price: 9999999999999999999999999999999});
		Game.NewUpgradebread({name:'Chocolate crinkles',desc:'Non-denominational breads to celebrate year-round deliciousness, and certainly not Christmas or some other nonsense.',icon:[22,15],power:						4,price: 9999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Maple breads',desc:'Made with syrup from a land where milk comes in bags, instead of spontaneously pooling at the bottom of your screen depending on your achievements.',icon:[21,13],power:						4,price: 99999999999999999999999999999999});
		...
		order=10030;
		Game.NewUpgradebread({name:'Festivity loops',desc:'These garish biscuits are a perfect fit for children\'s birthday parties or the funerals of strange, eccentric billionaires.',icon:[25,17],require:'Box of brand biscuits',power:												2,	price:	999999999999999999999999*5});
		
		order=10020;
		Game.NewUpgradebread({name:'Persian rice breads',desc:'Rose water and poppy seeds are the secret ingredients of these small, butter-free breads.',icon:[28,15],power:						4,price: 99999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Norwegian breads',desc:'A flat butter bread with a sliver of candied cherry on top. It is said that these illustrate the bleakness of scandinavian existentialism.',icon:[22,20],power:						4,price: 999999999999999999999999999999999});
		Game.NewUpgradebread({name:'Crispy rice breads',desc:'Fun to make at home! Store-bought breads are obsolete! Topple the system! There\'s marshmallows in these! Destroy capitalism!',icon:[23,20],power:						4,price: 999999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Ube breads',desc:'The tint is obtained by the use of purple yams. According to color symbolism, these breads are either noble, holy, or supervillains.',icon:[24,17],power:						4,price: 9999999999999999999999999999999999});
		Game.NewUpgradebread({name:'Butterscotch breads',desc:'The butterscotch chips are just the right amount of sticky, and make you feel like you\'re eating candy.',icon:[24,20],power:						4,price: 9999999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Speculaas',desc:'These crunchy, almost obnoxiously cinnamony breads are a source of dutch pride. About the origin of the name, one can only speculate.',icon:[21,20],power:						4,price: 99999999999999999999999999999999999});
		
		order=10200;
		Game.NewUpgradebread({name:'Elderwort biscuits',desc:'-',icon:[22,25],power:2,price:60*2,locked:1});Game.last.baseDesc='bread production multiplier <b>+2%</b>.<br>Grandma production multiplier <b>+2%</b>.<br>Dropped by elderwort plants.<q>They taste incredibly stale, even when baked fresh.</q>';
		Game.NewUpgradebread({name:'Bakeberry breads',desc:'-',icon:[23,25],power:2,price:60,locked:1});Game.last.baseDesc='bread production multiplier <b>+2%</b>.<br>Dropped by bakeberry plants.<q>Really good dipped in hot chocolate.</q>';
		Game.NewUpgradebread({name:'Duketater breads',desc:'-',icon:[24,25],power:10,price:60*3,locked:1});Game.last.baseDesc='bread production multiplier <b>+10%</b>.<br>Dropped by duketater plants.<q>Fragrant and mealy, with a slight yellow aftertaste.</q>';
		Game.NewUpgradebread({name:'Green yeast digestives',desc:'-',icon:[25,25],power:0,price:60*3,locked:1});Game.last.baseDesc='<b>+1%</b> golden bread gains and effect duration.<br><b>+1%</b> golden bread frequency.<br><b>+3%</b> random drops.<br>Dropped by green rot plants.<q>These are tastier than you\'d expect, but not by much.</q>';
		...
		order=10200;
		Game.NewUpgradebread({name:'Wheat slims',desc:'-',icon:[28,25],power:1,price:30,locked:1});Game.last.baseDesc='bread production multiplier <b>+1%</b>.<br>Dropped by baker\'s wheat plants.<q>The only reason you\'d consider these to be breads is because you feel slightly sorry for them.</q>';
		
		var gardenDrops=['Elderwort biscuits','Bakeberry breads','Duketater breads','Green yeast digestives','Fern tea','Ichor syrup','Wheat slims'];
		for (var i in gardenDrops)//scale by CpS
		{
			var it=Game.Upgrades[gardenDrops[i]];
			it.priceFunc=function(cost){return function(){return cost*Game.breadsPs*60;}}(it.basePrice);
		...
		new Game.Upgrade('Eye of the wrinkler','Mouse over a wrinkler to see how many breads are in its stomach.<q>Just a wrinkler and its will to survive.<br>Hangin\' tough, stayin\' hungry.</q>',99999999,[27,26]);Game.last.pool='prestige';Game.last.parents=['Wrinkly breads'];
		...
		order=10300;
		Game.NewUpgradebread({name:'Pure pitch-black chocolate butter biscuit',desc:'Rewarded for owning 500 of everything.<br>This chocolate is so pure and so flawless that it has no color of its own, instead taking on the appearance of whatever is around it. You\'re a bit surprised to notice that this one isn\'t stamped with your effigy, as its surface is perfectly smooth (to the picometer) - until you realize it\'s quite literally reflecting your own face like a mirror.',icon:[24,27],power:	10,price: 999999999999999999999999999999999999999999999*butterBiscuitMult,locked:1});
		
		order=10020;
		Game.NewUpgradebread({name:'Chocolate oatmeal breads',desc:'These bad boys compensate for lack of a cohesive form and a lumpy, unsightly appearance by being just simply delicious. Something we should all aspire to.',icon:[23,28],power:						4,price: 99999999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Molasses breads',desc:'Sticky, crackly, and dusted in fine sugar.<br>Some lunatics have been known to eat these with potatoes.',icon:[24,28],power:						4,price: 999999999999999999999999999999999999});
		Game.NewUpgradebread({name:'Biscotti',desc:'Almonds and pistachios make these very robust breads slightly more interesting to eat than to bludgeon people with.',icon:[22,28],power:						4,price: 999999999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Waffle breads',desc:'Whether these are breads with shockingly waffle-like features or simply regular bread-sized waffles is a debate we\'re not getting into here.',icon:[21,28],power:						4,price: 9999999999999999999999999999999999999});
		
		
		order=10000;
		//early breads that unlock at the same time as coconut breads; meant to boost early game a little bit
		Game.NewUpgradebread({name:'Almond breads',desc:'Sometimes you feel like one of these. Sometimes you don\'t.',icon:[21,27],power:							2,	price:	99999999});
		Game.NewUpgradebread({name:'Hazelnut breads',desc:'Tastes like a morning stroll through a fragrant forest, minus the clouds of gnats.',icon:[22,27],power:							2,	price:	99999999});
		Game.NewUpgradebread({name:'Walnut breads',desc:'Some experts have pointed to the walnut\'s eerie resemblance to the human brain as a sign of its sentience - a theory most walnuts vehemently object to.',icon:[23,27],power:							2,	price:	99999999});
		...
		order=525;new Game.TieredUpgrade('Rules of acquisition','Banks are <b>twice</b> as efficient.<q>Rule 387 : a bread baked is a bread kept.</q>','Bank',11);
		...
		order=600;new Game.TieredUpgrade('Universal alphabet','Shipments are <b>twice</b> as efficient.<q>You\'ve managed to chart a language that can be understood by any sentient species in the galaxy; its exciting vocabulary contains over 56 trillion words that sound and look like sparkly burps, forming intricate sentences that usually translate to something like "give us your breads, or else".</q>','Shipment',11);
		order=700;new Game.TieredUpgrade('Public betterment','Alchemy labs are <b>twice</b> as efficient.<q>Why do we keep trying to change useless matter into breads, or breads into even better breads? Clearly, the way of the future is to change the people who eat the breads into people with a greater understanding, appreciation and respect for the breads they\'re eating. Into the vat you go!</q>','Alchemy lab',11);
		order=800;new Game.TieredUpgrade('Embedded microportals','Portals are <b>twice</b> as efficient.<q>We\'ve found out that if we bake the portals into the breads themselves, we can transport people\'s taste buds straight into the taste dimension! Good thing your army of lawyers got rid of the FDA a while ago!</q>','Portal',11);
		order=900;new Game.TieredUpgrade('Nostalgia','Time machines are <b>twice</b> as efficient.<q>Your time machine technicians insist that this is some advanced new time travel tech, and not just an existing emotion universal to mankind. Either way, you have to admit that selling people the same old breads just because it reminds them of the good old times is an interesting prospect.</q>','Time machine',11);
		order=1000;new Game.TieredUpgrade('The definite molecule','Antimatter condensers are <b>twice</b> as efficient.<q>Your scientists have found a way to pack a bread into one single continuous molecule, opening exciting new prospects in both storage and flavor despite the fact that these take up to a whole year to digest.</q>','Antimatter condenser',11);
		order=1100;new Game.TieredUpgrade('Light capture measures','Prisms are <b>twice</b> as efficient.<q>As the universe gets ever so slightly dimmer due to you converting more and more of its light into breads, you\'ve taken to finding new and unexplored sources of light for your prisms; for instance, the warm glow emitted by a pregnant woman, or the twinkle in the eye of a hopeful child.</q>','Prism',11);
		...
		order=255;
		Game.GrandmaSynergy('Metagrandmas','A fractal grandma to make more grandmas to make more breads.','Fractal engine');
		...
		new Game.TieredUpgrade('Nested universe theory','Fractal engines are <b>twice</b> as efficient.<q>Asserts that each subatomic particle is host to a whole new universe, and therefore, another limitless quantity of breads.<br>This somehow stacks with the theory of nanocosmics, because physics.</q>','Fractal engine',4);
		...
		order=10020;
		Game.NewUpgradebread({name:'Custard creams',desc:'British lore pits these in a merciless war against bourbon biscuits.<br>The filling evokes vanilla without quite approaching it.<br>They\'re tastier on the inside!',icon:[23,29],power:						4,price: 9999999999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Bourbon biscuits',desc:'Two chocolate biscuits joined together with even more chocolate.<br>The sworn rivals of custard creams, as legend has it.',icon:[24,29],power:						4,price: 99999999999999999999999999999999999999});
		...
		order=10020;
		Game.NewUpgradebread({name:'Mini-breads',desc:'Have you ever noticed how the smaller something is, the easier it is to binge on it?',icon:[29,30],power:						5,price: 99999999999999999999999999999999999999*5});
		
		new Game.Upgrade('Sugar crystal breads','bread production multiplier <b>+5% permanently</b>, and <b>+1%</b> for every building type level 10 or higher.<q>Infused with cosmic sweetness. It gives off a faint shimmery sound when you hold it up to your ear.</q>',1000000000,[21,30]);Game.last.pool='prestige';Game.last.parents=['Sugar baking'];Game.last.power=function(){
			var n=5;
			for (var i in Game.Objects)
			{
		...
		new Game.Upgrade('Box of maybe breads','Contains an assortment of...something.<q>These may or may not be considered breads.</q>',333000000000,[25,29]);Game.last.pool='prestige';Game.last.parents=['Sugar crystal breads'];
		new Game.Upgrade('Box of not breads','Contains an assortment of...something.<q>These are strictly, definitely not breads.</q>',333000000000,[26,29]);Game.last.pool='prestige';Game.last.parents=['Sugar crystal breads'];
		new Game.Upgrade('Box of pastries','Contains an assortment of delicious pastries.<q>These are a damn slippery slope is what they are!</q>',333000000000,[27,29]);Game.last.pool='prestige';Game.last.parents=['Sugar crystal breads'];
		
		order=10040;
		Game.NewUpgradebread({name:'Profiteroles',desc:'Also known as cream puffs, these pastries are light, fluffy, filled with whipped cream and fun to throw at people when snowballs are running scarce.',icon:[29,29],require:'Box of pastries',		power:4,price: Math.pow(10,31)});
		Game.NewUpgradebread({name:'Jelly donut',desc:'Guaranteed to contain at least 0.3% jelly filling, or your money back.<br>You can still see the jelly stab wound!',icon:[27,28],require:'Box of pastries',		power:4,price: Math.pow(10,33)});
		Game.NewUpgradebread({name:'Glazed donut',desc:'Absolutely gooey with sugar. The hole is the tastiest part!',icon:[28,28],require:'Box of pastries',		power:4,price: Math.pow(10,35)});
		Game.NewUpgradebread({name:'Chocolate cake',desc:'The cake is a Portal reference!',icon:[25,27],require:'Box of pastries',		power:4,price: Math.pow(10,37)});
		Game.NewUpgradebread({name:'Strawberry cake',desc:'It\'s not easy to come up with flavor text for something as generic as this, but some would say it\'s a piece of cake.',icon:[26,27],require:'Box of pastries',		power:4,price: Math.pow(10,39)});
		Game.NewUpgradebread({name:'Apple pie',desc:'It is said that some grandmas go rogue and bake these instead.',icon:[25,28],require:'Box of pastries',		power:4,price: Math.pow(10,41)});
		Game.NewUpgradebread({name:'Lemon meringue pie',desc:'Meringue is a finicky substance made of sugar and egg whites that requires specific atmospheric conditions to be baked at all. The lemon, as far as we can tell, isn\'t nearly as picky.',icon:[26,28],require:'Box of pastries',		power:4,price: Math.pow(10,43)});
		Game.NewUpgradebread({name:'Butter croissant',desc:'Look around.<br>A rude man in a striped shirt bikes past you. He smells of cigarettes and caf&eacute;-au-lait. Somewhere, a mime uses his moustache to make fun of the British. 300 pigeons fly overhead.<br>Relax. You\'re experiencing croissant.',icon:[29,28],require:'Box of pastries',		power:4,price: Math.pow(10,45)});
		
		order=10050;
		Game.NewUpgradebread({name:'bread dough',desc:'Bursting with infinite potential, but can also be eaten as is. Arguably worth the salmonella.',icon:[25,30],require:'Box of maybe breads',		power:4,price: Math.pow(10,35)});
		Game.NewUpgradebread({name:'Burnt bread',desc:'This bread flew too close to the sun and is now a shadow of its former self. If only you remembered to set a timer, you wouldn\'t have this tragedy on your hands...',icon:[23,30],require:'Box of maybe breads',		power:4,price: Math.pow(10,37)});
		Game.NewUpgradebread({name:'A chocolate chip bread but with the chips picked off for some reason',desc:'This has to be the saddest thing you\'ve ever seen.',icon:[24,30],require:'Box of maybe breads',		power:3,price: Math.pow(10,39)});
		Game.NewUpgradebread({name:'Flavor text bread',desc:'What you\'re currently reading is what gives this bread its inimitable flavor.',icon:[22,30],require:'Box of maybe breads',		power:4,price: Math.pow(10,41)});
		Game.NewUpgradebread({name:'High-definition bread',desc:'Uncomfortably detailed, like those weird stories your aunt keeps telling at parties.',icon:[28,10],require:'Box of maybe breads',		power:5,price: Math.pow(10,43)});
		
		order=10060;
		Game.NewUpgradebread({name:'Toast',desc:'A crisp slice of bread, begging for some butter and jam.<br>Why do people keep proposing these at parties?',icon:[27,10],require:'Box of not breads',		power:4,price: Math.pow(10,34)});
		Game.NewUpgradebread({name:'Peanut butter & jelly',desc:'It\'s time.',icon:[29,9],require:'Box of not breads',		power:4,price: Math.pow(10,36)});
		Game.NewUpgradebread({name:'Wookies',desc:'These aren\'t the breads you\'re looking for.',icon:[26,30],require:'Box of not breads',		power:4,price: Math.pow(10,38)});
		Game.NewUpgradebread({name:'Cheeseburger',desc:'Absolutely no relation to breads whatsoever - Orteil just wanted an excuse to draw a cheeseburger.',icon:[28,30],require:'Box of not breads',		power:4,price: Math.pow(10,40)});
		Game.NewUpgradebread({name:'One lone chocolate chip',desc:'The start of something beautiful.',icon:[27,30],require:'Box of not breads',		power:1,price: Math.pow(10,42)});
		...
		new Game.Upgrade('Shimmering veil','Unlocks the <b>shimmering veil</b>, a switch that passively boosts your CpS by <b>50%</b>.<br>You start with the veil turned on; however, it is very fragile, and clicking the big bread or any golden bread or reindeer will turn it off, requiring 24 hours of CpS to turn back on.<q>Hands off!</q>',999999999,[9,10]);Game.last.pool='prestige';Game.last.parents=['Distilled essence of redoubled luck'];
		...
		var func=function(){
			...
			return (this.name=='Shimmering veil [on]'?'<div style="text-align:center;">Active.</div><div class="line"></div>':'')+'Boosts your bread production by <b>'+Beautify(boost)+'%</b> when active.<br>The veil is very fragile and will break if you click the big bread or any golden breads or reindeer.<br><br>Once broken, turning the veil back on costs 24 hours of unbuffed CpS.'+(resist>0?('<br><br>Has a <b>'+Beautify(resist)+'%</b> chance to not break.'):'');
		};
		...
		Game.loseShimmeringVeil=function(context)
		{
			...
			if (Game.Has('Reinforced membrane'))
			{
				...
				else if (context=='click') Math.seedrandom(Game.seed+'/'+Game.breadClicks);
				if (Math.random()<0.1)
				{
		...
		var getbreadPrice=function(level){return 999999999999999999999999999999999999999*Math.pow(10,(level-1)/2);};
		
		order=10020;
		Game.NewUpgradebread({name:'Whoopie pies',desc:'Two chocolate halves joined together by a cream filling. It\'s got no eyebrows, but you never noticed until now.',icon:[21,31],power:						5,price: getbreadPrice(1)});
		Game.NewUpgradebread({name:'Caramel wafer biscuits',desc:'Coated in delicious chocolate. As many layers as you\'ll get in a biscuit without involving onions.',icon:[22,31],power:						5,price: getbreadPrice(2)});
		Game.NewUpgradebread({name:'Chocolate chip mocha breads',desc:'Mocha started out as an excuse to smuggle chocolate into coffee. And now, in a poignant display of diplomacy and cultural exchange, it\'s bringing coffee to chocolate breads.',icon:[23,31],power:						5,price: getbreadPrice(3)});
		Game.NewUpgradebread({name:'Earl Grey breads',desc:'Captain Picard\'s favorite.',icon:[24,31],power:						5,price: getbreadPrice(4)});
		Game.NewUpgradebread({name:'Corn syrup breads',desc:'The corn syrup makes it extra chewy. Not the type of stuff you\'d think to put in a bread, but bakers make do.',icon:[25,31],power:						5,price: getbreadPrice(5)});
		Game.NewUpgradebread({name:'Icebox breads',desc:'Can be prepared in a variety of shapes with a variety of ingredients. Made by freezing dough before baking it, mirroring a time-proven medieval torture practice. Gotta keep them guessing.',icon:[26,31],power:						5,price: getbreadPrice(6)});
		Game.NewUpgradebread({name:'Graham crackers',desc:'Inspired in their design by the wish to live a life of austere temperance, free from pleasure or cheer; it\'s no wonder these are so tasty.',icon:[27,31],power:						5,price: getbreadPrice(7)});
		Game.NewUpgradebread({name:'Hardtack',desc:'Extremely hard and, if we\'re being honest, extremely tack.<br>If you\'re considering eating this as a fun snack, you probably have other things to worry about than this game, like getting scurvy or your crew fomenting mutiny.',icon:[28,31],power:						5,price: getbreadPrice(8)});
		Game.NewUpgradebread({name:'Cornflake breads',desc:'They\'re grrrrrroovy! Careful not to let it sit in your milk too long, lest you accidentally end up with a bowl of cereal and get confused.',icon:[29,31],power:						5,price: getbreadPrice(9)});
		Game.NewUpgradebread({name:'Tofu breads',desc:'There\'s really two ways to go with tofu cooking; either it asserts itself in plain sight or it camouflages itself in the other ingredients. This happens to be the latter, and as such, you can\'t really tell the difference between this and a regular bread, save for that one pixel on the left.',icon:[30,31],power:						5,price: getbreadPrice(10)});
		Game.NewUpgradebread({name:'Gluten-free breads',desc:'Made with browned butter and milk to closely match the archetypal chocolate chip bread.<br>For celiacs, a chance to indulge in a delicious risk-free pastry. For others, a strangely threatening confection whose empty eyes will never know heaven nor hell.',icon:[30,30],power:						5,price: getbreadPrice(10)});
		Game.NewUpgradebread({name:'Russian bread breads',desc:'Also known as alphabet breads; while most bakers follow the recipe to the letter, it is said that some substitute the flour for spelt. But don\'t take my word for it.',icon:[30,29],power:						5,price: getbreadPrice(11)});
		Game.NewUpgradebread({name:'Lebkuchen',desc:'Diverse breads from Germany, fragrant with honey and spices, often baked around Christmas.<br>Once worn by warriors of old for protection in battle.<br>+5 STR, +20% magic resistance.',icon:[30,28],power:						5,price: getbreadPrice(12)});
		Game.NewUpgradebread({name:'Aachener Printen',desc:'The honey once used to sweeten these gingerbread-like treats has since been swapped out for beet sugar, providing another sad example of regressive evolution.',icon:[30,27],power:						5,price: getbreadPrice(13)});
		Game.NewUpgradebread({name:'Canistrelli',desc:'A dry biscuit flavored with anise and wine, tough like the people of Corsica where it comes from.',icon:[30,26],power:						5,price: getbreadPrice(14)});
		Game.NewUpgradebread({name:'Nice biscuits',desc:'Made with coconut and perfect with tea. Traces its origins to a French city so nice they named it that.',icon:[30,25],power:						5,price: getbreadPrice(15)});
		Game.NewUpgradebread({name:'French pure butter breads',desc:'You can\'t tell what\'s stronger coming off these - the smell of butter or condescension.',icon:[31,25],power:						5,price: getbreadPrice(16)});
		Game.NewUpgradebread({name:'Petit beurre',desc:'An unassuming biscuit whose name simply means "little butter". Famed and feared for its four ears and forty-eight teeth.<br>When it hears ya, it\'ll get ya...',icon:[31,26],power:						5,price: getbreadPrice(16)});
		Game.NewUpgradebread({name:'Nanaimo bars',desc:'A delicious no-bake pastry hailing from Canada. Probably beats eating straight-up snow with maple syrup poured on it, but what do I know.',icon:[31,27],power:						5,price: getbreadPrice(17)});
		Game.NewUpgradebread({name:'Berger breads',desc:'Messily slathered with chocolate fudge, but one of the most popular bergers of Baltimore, along with the triple fried egg berger and the blue crab cheeseberger.',icon:[31,28],power:						5,price: getbreadPrice(18)});
		Game.NewUpgradebread({name:'Chinsuko',desc:'A little piece of Okinawa in bread form. Part of a Japanese custom of selling sweets as souvenirs. But hey, pressed pennies are cool too.',icon:[31,29],power:						5,price: getbreadPrice(19)});
		Game.NewUpgradebread({name:'Panda koala biscuits',desc:'Assorted jungle animals with equally assorted fillings.<br>Comes in chocolate, strawberry, vanilla and green tea.<br>Eat them all before they go extinct!',icon:[31,13],power:						5,price: getbreadPrice(19)});
		Game.NewUpgradebread({name:'Putri salju',desc:'A beloved Indonesian pastry; its name means "snow princess", for the powdered sugar it\'s coated with. Had we added these to bread Clicker some years ago, this is where we\'d make a reference to that one Disney movie, but it\'s probably time to let it go.',icon:[31,30],power:						5,price: getbreadPrice(20)});
		Game.NewUpgradebread({name:'Milk breads',desc:'Best eaten with a tall glass of chocolate.',icon:[31,31],power:						5,price: getbreadPrice(21)});
		
		order=9999;
		Game.NewUpgradebread({name:'bread crumbs',desc:'There used to be a bread here. Now there isn\'t.<br>Good heavens, what did you <i>DO?!</i>',icon:[30,13],power:1,require:'Legacy',price:100});
		Game.NewUpgradebread({name:'Chocolate chip bread',desc:'This is the bread you\'ve been clicking this whole time. It looks a bit dented and nibbled on, but it\'s otherwise good as new.',icon:[10,0],power:10,require:'Legacy',price:1000000000000});
		...
		order=255;
		Game.GrandmaSynergy('Binary grandmas','A digital grandma to transfer more breads.<br>(See also : boolean grandmas, string grandmas, and not-a-number grandmas, also known as "NaNs".)','Javascript console');
		...
		new Game.TieredUpgrade('64bit arrays','Javascript consoles are <b>twice</b> as efficient.<q>A long-form variable type to pack your breads much more efficiently.</q>','Javascript console',2);
		...
		new Game.TieredUpgrade('Syntactic sugar','Javascript consoles are <b>twice</b> as efficient.<q>Tastier code for tastier breads.</q>','Javascript console',5);
		...
		new Game.TieredUpgrade('Just-in-time baking','Javascript consoles are <b>twice</b> as efficient.<q>A new method of preparing breads; they bake themselves right in front of the customers before eating, leaving your kitchens mess-free.</q>','Javascript console',7);
		new Game.TieredUpgrade('breads++','Javascript consoles are <b>twice</b> as efficient.<q>Your very own bread-themed programming language, elegantly named after its most interesting ability - increasing the "breads" variable by 1.</q>','Javascript console',8);
		...
		order=10020;
		Game.NewUpgradebread({name:'Chai tea breads',desc:'Not exactly Captain Picard\'s favorite, but I mean, these will do in a pinch.',icon:[23,32],power:						5,price: getbreadPrice(4)+5});Game.last.order=10020.5685;
		
		Game.NewUpgradebread({name:'Yogurt breads',desc:'Augmented by the wonders of dairy, these breads are light and fluffy and just one more thing for the lactose-intolerant to avoid.<br>Truly for the cultured among us.',icon:[24,32],power:						5,price: getbreadPrice(25)});
		Game.NewUpgradebread({name:'Thumbprint breads',desc:'Filled with jam and sometimes served in little paper cups. No longer admissible as biometric evidence in court. We\'re not having a repeat of that whole mess.',icon:[25,32],power:						5,price: getbreadPrice(26)});
		Game.NewUpgradebread({name:'Pizzelle',desc:'Thin, crisp waffle breads baked in a bespoke iron following an ancient Italian recipe.<br>These breads have been around for a long, long time.<br>These breads have seen things.',icon:[26,32],power:						5,price: getbreadPrice(27)});
		
		order=10030;
		Game.NewUpgradebread({name:'Zilla wafers',desc:'Popular vanilla-flavored biscuits that somehow keep ending up in banana pudding.<br>Themed after a beloved radioactive prehistoric monster, for some reason.',icon:[22,32],require:'Box of brand biscuits',power:												2,	price:	999999999999999999999999999999*5});
		Game.NewUpgradebread({name:'Dim Dams',desc:'Two biscuits joined by chocolate and coated in even more chocolate.<br>You wonder - which one is the dim, and which one is the dam?',icon:[31,10],require:'Box of brand biscuits',power:												2,	price:	999999999999999999999999999999999*5});
		
		order=10060;
		Game.NewUpgradebread({name:'Candy',desc:'There are two pillars to the world of sweets : pastries, of course - and candy.<br>You could make a whole new game just about these, but for now, please enjoy these assorted generic treats.',icon:[30,10],require:'Box of not breads',		power:5,price: Math.pow(10,46)});
		...
		new Game.Upgrade('Fortune #101','You gain <b>+7%</b> CpS.<q>Some people dream of fortunes; others dream of breads.</q>',Game.Tiers['fortune'].price*100000000,[0,0]);Game.MakeTiered(Game.last,'fortune',10);
		Game.last.priceFunc=function(me){return Math.min(me.basePrice,Game.unbuffedCps*60*60*24);}
		...
		new Game.Upgrade('Fortune breads','The news ticker may occasionally have <b>fortunes</b>, which may be clicked for something good.<q>These don\'t taste all that great but that\'s not really the point, is it?</q>',77777777777,[29,8]);Game.last.pool='prestige';Game.last.parents=['Distilled essence of redoubled luck'];
		...
		order=10300;
		Game.NewUpgradebread({name:'Prism heart biscuits',desc:'An every-flavor biscuit that stands for universal love and being true to yourself.',require:'Eternal heart biscuits',season:'valentines',icon:[30,8],							power:heartPower,price: 1000000000000000000000000});Game.last.order=10300.175;
		...
		new Game.Upgrade('Dragon scale','bread production multiplier <b>+3%</b>.<br>Cost scales with CpS, but 10 times cheaper with a fully-trained dragon.<q>Your dragon sheds these regularly, so this one probably won\'t be missed.<br>Note: icon not to scale.</q>',999,[30,14]);Game.last.priceFunc=dragonDropUpgradeCost;
		...
		order=10020;
		Game.NewUpgradebread({name:'Granola breads',desc:'Wait! These are just oatmeal breads mixed with raisin breads! What next, half-dark chocolate half-white chocolate breads?',icon:[28,32],power:						5,price: getbreadPrice(28)});
		Game.NewUpgradebread({name:'Ricotta breads',desc:'Light and cake-like. Often flavored with lemon or almond extract. Sprinkles optional. Allegedly Italian. Investigation pending.',icon:[29,32],power:						5,price: getbreadPrice(29)});
		Game.NewUpgradebread({name:'Roze koeken',desc:'The icing on these Dutch breads is traditionally pink, but different colors may be used for special occasions - such as pink to celebrate Breast Cancer Awareness Month, or for International Flamingo Day, pink.',icon:[30,32],power:						5,price: getbreadPrice(30)});
		Game.NewUpgradebread({name:'Peanut butter cup breads',desc:'What more poignant example of modern societal struggles than the brazen reclaiming of a corporate product by integrating it in the vastly more authentic shell of a homemade undertaking? Anyway this is a peanut butter cup, baked into a bread. It\'s pretty good!',icon:[31,32],power:						5,price: getbreadPrice(31)});
		Game.NewUpgradebread({name:'Sesame breads',desc:'Look at all the little seeds on these! It\'s like someone dropped them on the street or something! A very welcoming and educational street!',icon:[22,33],power:						5,price: getbreadPrice(32)});
		Game.NewUpgradebread({name:'Taiyaki',desc:'A pastry fish filled with red bean paste, doomed to live an existence of constant and excruciating pain as its aquatic environment slowly dissolves its soft doughy body.<br>Also comes in chocolate flavor!',icon:[23,33],power:						5,price: getbreadPrice(33)});
		Game.NewUpgradebread({name:'Vanillekipferl',desc:'Nut-based breads from Central Europe, coated in powdered vanilla sugar. Regular kipferl, crescent-shaped bread rolls from the same region, are much less exciting.',icon:[24,33],power:						5,price: getbreadPrice(34)});
		
		order=10300;
		Game.NewUpgradebread({name:'Cosmic chocolate butter biscuit',desc:'Rewarded for owning 550 of everything.<br>Through some strange trick of magic or technology, looking at this bread is like peering into a deep ocean of ancient stars. The origins of this biscuit are unknown; its manufacture, as far as your best investigators can tell, left no paper trail. From a certain angle, if you squint hard enough, you\'ll notice that a number of stars near the center are arranged to resemble the outline of your own face.',icon:[27,32],power:	10,price: 999999999999999999999999999999999999999999999999*butterBiscuitMult,locked:1});
		...
		order=1400;new Game.TieredUpgrade('Your biggest fans','Javascript consoles are <b>twice</b> as efficient.<q>Let\'s face it, baking breads isn\'t the most optimized thing there is. So you\'ve purchased your biggest fans yet and stuck them next to your computers to keep things chill and in working order. Cool!</q>','Javascript console',12);
		
		
		order=10020;
		Game.NewUpgradebread({name:'Battenberg biscuits',desc:'Inspired by a cake of the same name, itself named after a prince of the same name. You suppose you could play a really, really short game of chess on these.',icon:[28,33],power:						5,price: getbreadPrice(35)});
		Game.NewUpgradebread({name:'Rosette breads',desc:'Intricate fried pastries from Northern Europe, made using specialized irons and dipped in icing sugar. While usually eaten as a delicious treat, these are often also used as Christmas tree decorations, or worn elegantly on one\'s lapel to symbolize the nah I\'m just messing with you.',icon:[26,33],power:						5,price: getbreadPrice(36)});
		Game.NewUpgradebread({name:'Gangmakers',desc:'The little bit of raspberry jam at its center is crucial; a plain butter bread with chocolate topping does not a gangmaker make.',icon:[27,33],power:						5,price: getbreadPrice(37)});
		Game.NewUpgradebread({name:'Welsh breads',desc:'Welsh breads, also known as Welsh cakes, bakestones, griddle cakes, griddle scones, or pics, or in Welsh: <i>picau ar y maen, pice bach, cacennau cri</i> or <i>teisennau gradell</i>, are rich currant-filled scone-like biscuits of uncertain origin.',icon:[29,33],power:						5,price: getbreadPrice(38)});
		Game.NewUpgradebread({name:'Raspberry cheesecake breads',desc:'The humble raspberry cheesecake, now in ascended bread form. Researchers posit that raspberry cheesecake breads are evidence that the final form of every baked good, through convergent evolution, approaches that of a bread, in a process known as breadnisation.',icon:[25,33],power:						5,price: getbreadPrice(39)});
		...
		order=1500;
		new Game.TieredUpgrade('Manifest destiny','Idleverses are <b>twice</b> as efficient.<q>While the ethics of ransacking parallel universes for their riches may seem questionable to some, you\'ve reasoned that bringing the good word of your bread empire to the unwashed confines of other realities is your moral duty, nay, your righteous imperative, and must be undertaken as soon as possible, lest they do it to you first!</q>','Idleverse',1);
		new Game.TieredUpgrade('The multiverse in a nutshell','Idleverses are <b>twice</b> as efficient.<q>The structure of the metacosmos may seem confusing and at times even contradictory, but here\'s what you\'ve gathered so far:<br><br><div style="text-align:left;">&bull; each reality, or "idleverse", exists in parallel to all others<br><br>&bull; most realities seem to converge towards the production of a sole type of item (ours evidently being, thanks to you, breads)<br><br>&bull; each reality is riddled with chaotic tunnels to a number of subordinate dimensions (such as the so-called "breadverse"), much like swiss cheese<br><br>&bull; all realities bathe in an infinite liquid of peculiar properties, colloquially known as "milk"</div><br>Finally, each reality may have its own interpretation of the concept of "reality", for added fun.</q>','Idleverse',2);
		new Game.TieredUpgrade('All-conversion','Idleverses are <b>twice</b> as efficient.<q>It\'s quite nice that you can rewire the logic of each universe to generate breads instead, but you still end up with parsec-loads of whatever they were producing before - baubles you\'ve long made obsolete: cash money, gems, cheeseburgers, puppies... That\'s why you\'ve designed the universal converter, compatible with any substance and capable of turning those useless spoils of conquest into the reassuring crumbly rustle of even more breads.</q>','Idleverse',3);
		...
		order=10300;
		Game.NewUpgradebread({name:'Butter biscuit (with butter)',desc:'Rewarded for owning 600 of everything.<br>This is a plain butter biscuit. It\'s got some butter on it. The butter doesn\'t look like anything in particular.',icon:[30,33],power:	10,price: 999999999999999999999999999999999999999999999999999*butterBiscuitMult,locked:1});
		...
		order=10020;
		Game.NewUpgradebread({name:'Bokkenpootjes',desc:'Consist of 2 meringue halves joined by buttercream and dipped both ways in chocolate. Named after a goat\'s foot that probably stepped in something twice.',icon:[32,8],power:						5,price: getbreadPrice(40)});
		Game.NewUpgradebread({name:'Fat rascals',desc:'Almond-smiled Yorkshire cakes with a rich history and an even richer recipe. The more diet-conscious are invited to try the lean version, skinny scallywags.',icon:[33,8],power:						5,price: getbreadPrice(41)});
		Game.NewUpgradebread({name:'Ischler breads',desc:'Originating in the Austro-Hungarian Empire, these have spread throughout every country in eastern Europe and spawned just as many recipes, each claiming to be the original. The basis remains unchanged across all variants: two biscuits sandwiched around chocolate buttercream. Or was it jam?',icon:[32,9],power:						5,price: getbreadPrice(42)});
		Game.NewUpgradebread({name:'Matcha breads',desc:'Green tea and breads, a matcha made in heaven.',icon:[33,9],power:						5,price: getbreadPrice(42)});
		
		order=10032;
		Game.NewUpgradebread({name:'Earl Grey macarons',desc:'Best served hot, make it so!',icon:[32,10],require:'Box of macarons',							power:3,price: 9999999999999999999999999999});
		
		order=10030;
		Game.NewUpgradebread({name:'Pokey',desc:'While commonly thought to be named so because it\'s fun to poke your classmates with these, Pokey-brand biscuit sticks actually get their name from their popularity in smoke-free prisons, where they\'re commonly smuggled and traded in lieu of cigarettes.',icon:[33,10],require:'Box of brand biscuits',power:												2,	price:	999999999999999999999999999999999999*5});
		
		order=10000;
		Game.NewUpgradebread({name:'Cashew breads',desc:'Let me tell you about cashews. Cashews are not nuts, but seeds that grow out of curious red or yellow fruits - which can be eaten on their own, or made into drinks. The shell around the nut itself contains a nasty substance that stains and irritates the hands of whoever handles it for too long. But that\'s okay, since now that you\'ve read this you\'ll make sure it doesn\'t get in the breads! Oh, you\'ve already eaten how many? Okay then.',icon:[32,7],power:							2,	price:	99999999});
		order=10001;
		Game.NewUpgradebread({name:'Milk chocolate breads',desc:'A strange inversion of chocolate milk. For those who are a little bit too hardcore for white chocolate, but not hardcore enough for dark.',icon:[33,7],power:2,	price:	99999999*5});
		...
		Game.santaDrops=['Increased merriness','Improved jolliness','A lump of coal','An itchy sweater','Reindeer baking grounds','Weighted sleighs','Ho ho ho-flavored frosting','Season savings','Toy workshop','Naughty list','Santa\'s bottomless bag','Santa\'s helpers','Santa\'s legacy','Santa\'s milk and breads'];
		...
		Game.Upgrades['Ghostly biscuit'].descFunc=function(){return '<div style="text-align:center;">'+Game.listTinyOwnedUpgrades(Game.halloweenDrops)+'<br><br>You\'ve purchased <b>'+Game.GetHowManyHalloweenDrops()+'/'+Game.halloweenDrops.length+'</b> halloween breads.<div class="line"></div>'+Game.saySeasonSwitchUses()+'<div class="line"></div></div>'+this.desc;};
		...
		Game.computeSeasonPrices=function()
		{
			for (var i in Game.seasons)
			{
				Game.seasons[i].triggerUpgrade.priceFunc=function(){
					...
					//return Game.breadsPs*60*Math.pow(1.5,Game.seasonUses)*m;
		...
		Game.goldenbreadUpgrades=['Get lucky','Lucky day','Serendipity','Heavenly luck','Lasting fortune','Decisive fate','Lucky digit','Lucky number','Lucky payout','Golden goose egg'];
		
		Game.breadUpgrades=[];
		for (var i in Game.Upgrades)
		{
			var me=Game.Upgrades[i];
			if ((me.pool=='bread' || me.pseudobread)) Game.breadUpgrades.push(me);
		...
		Game.ProductionAchievement=function(name,building,tier,q,mult)
		{
			...
			var achiev=new Game.Achievement(name,'Make <b>'+toFixed(pow)+'</b> breads just from '+building.plural+'.'+(q?'<q>'+q+'</q>':''),icon);
		...
		Game.BankAchievement=function(name,q)
		{
			...
			var achiev=new Game.Achievement(name,'Bake <b>'+toFixed(threshold)+'</b> bread'+(threshold==1?'':'s')+' in one ascension.'+(q?('<q>'+q+'</q>'):''),[Game.thresholdIcons[Game.BankAchievements.length],(Game.BankAchievements.length>32?1:Game.BankAchievements.length>23?2:5)]);
		...
		Game.CpsAchievement=function(name,q)
		{
			...
			var achiev=new Game.Achievement(name,'Bake <b>'+toFixed(threshold)+'</b> bread'+(threshold==1?'':'s')+' per second.'+(q?('<q>'+q+'</q>'):''),[Game.thresholdIcons[Game.CpsAchievements.length],(Game.CpsAchievements.length>32?1:Game.CpsAchievements.length>23?2:5)]);
			achiev.threshold=threshold;
		...
		Game.BankAchievement('breads all the way down');
		...
		Game.CpsAchievement('bread monster');
		Game.CpsAchievement('Mass producer');
		Game.CpsAchievement('bread vortex');
		Game.CpsAchievement('bread pulsar');
		Game.CpsAchievement('bread quasar');
		Game.CpsAchievement('Oh hey, you\'re still here');
		Game.CpsAchievement('Let\'s never bake again');
		
		order=30010;
		new Game.Achievement('Sacrifice','Ascend with <b>1 million</b> breads baked.<q>Easy come, easy go.</q>',[11,6]);
		new Game.Achievement('Oblivion','Ascend with <b>1 billion</b> breads baked.<q>Back to square one.</q>',[11,6]);
		new Game.Achievement('From scratch','Ascend with <b>1 trillion</b> breads baked.<q>It\'s been fun.</q>',[11,6]);
		
		order=11010;
		new Game.Achievement('Neverclick','Make <b>1 million</b> breads by only having clicked <b>15 times</b>.',[12,0]);//Game.last.pool='shadow';
		order=1000;
		new Game.Achievement('Clicktastic','Make <b>1,000</b> breads from clicking.',[11,0]);
		new Game.Achievement('Clickathlon','Make <b>100,000</b> breads from clicking.',[11,1]);
		new Game.Achievement('Clickolympics','Make <b>10,000,000</b> breads from clicking.',[11,2]);
		new Game.Achievement('Clickorama','Make <b>1,000,000,000</b> breads from clicking.',[11,13]);
		...
		Game.TieredAchievement('Grandma\'s breads','Have <b>1</b> grandma.','Grandma',1);
		...
		order=10000;
		new Game.Achievement('Golden bread','Click a <b>golden bread</b>.',[10,14]);
		new Game.Achievement('Lucky bread','Click <b>7 golden breads</b>.',[22,6]);
		new Game.Achievement('A stroke of luck','Click <b>27 golden breads</b>.',[23,6]);
		
		order=30200;
		new Game.Achievement('Cheated breads taste awful','Hack in some breads.',[10,6]);Game.last.pool='shadow';
		order=11010;
		...
		order=11000;
		new Game.Achievement('bread-dunker','Dunk the bread.<q>You did it!</q>',[1,8]);
		
		order=10000;
		new Game.Achievement('Fortune','Click <b>77 golden breads</b>.<q>You should really go to bed.</q>',[24,6]);
		order=31000;
		new Game.Achievement('True Neverclick','Make <b>1 million</b> breads with <b>no</b> bread clicks.<q>This kinda defeats the whole purpose, doesn\'t it?</q>',[12,0]);Game.last.pool='shadow';
		...
		order=10000;
		new Game.Achievement('Leprechaun','Click <b>777 golden breads</b>.',[25,6]);
		new Game.Achievement('Black cat\'s paw','Click <b>7777 golden breads</b>.',[26,6]);
		
		order=30050;
		new Game.Achievement('Nihilism','Ascend with <b>1 quadrillion</b> breads baked.<q>There are many things<br>that need to be erased</q>',[11,7]);
		...
		order=30500;
		new Game.Achievement('Hardcore','Get to <b>1 billion</b> breads baked with <b>no upgrades purchased</b>.',[12,6]);//Game.last.pool='shadow';
		
		order=30600;
		new Game.Achievement('Speed baking I','Get to <b>1 million</b> breads baked in <b>35 minutes</b>.',[12,5]);Game.last.pool='shadow';
		new Game.Achievement('Speed baking II','Get to <b>1 million</b> breads baked in <b>25 minutes</b>.',[13,5]);Game.last.pool='shadow';
		new Game.Achievement('Speed baking III','Get to <b>1 million</b> breads baked in <b>15 minutes</b>.',[14,5]);Game.last.pool='shadow';
		...
		order=1000;
		new Game.Achievement('Clickasmic','Make <b>100,000,000,000</b> breads from clicking.',[11,14]);
		...
		order=22000;
		new Game.Achievement('Spooky breads','Unlock <b>every Halloween-themed bread</b>.<div class="line"></div>Owning this achievement makes Halloween-themed breads drop more frequently in future playthroughs.',[12,8]);
		...
		new Game.Achievement('Let it snow','Unlock <b>every Christmas-themed bread</b>.<div class="line"></div>Owning this achievement makes Christmas-themed breads drop more frequently in future playthroughs.',[19,9]);
		...
		order=22300;
		new Game.Achievement('Lovely breads','Unlock <b>every Valentine-themed bread</b>.',[20,3]);
		
		order=7001;
		new Game.Achievement('Centennial and a half','Have at least <b>150 of everything</b>.',[7,6]);
		
		order=11000;
		new Game.Achievement('Tiny bread','Click the tiny bread.<q>These aren\'t the breads<br>you\'re clicking for.</q>',[0,5]);
		
		order=400000;
		new Game.Achievement('You win a bread','This is for baking 10 trillion breads and making it on the local news.<q>We\'re all so proud of you.</q>',[10,0]);
		...
		order=1000;
		new Game.Achievement('Clickageddon','Make <b>10,000,000,000,000</b> breads from clicking.',[11,15]);
		new Game.Achievement('Clicknarok','Make <b>1,000,000,000,000,000</b> breads from clicking.',[11,16]);
		...
		order=30050;
		new Game.Achievement('Dematerialize','Ascend with <b>1 quintillion</b> breads baked.<q>Presto!<br>...where\'d the breads go?</q>',[11,7]);
		new Game.Achievement('Nil zero zilch','Ascend with <b>1 sextillion</b> breads baked.<q>To summarize : really not very much at all.</q>',[11,7]);
		new Game.Achievement('Transcendence','Ascend with <b>1 septillion</b> breads baked.<q>Your breads are now on a higher plane of being.</q>',[11,8]);
		new Game.Achievement('Obliterate','Ascend with <b>1 octillion</b> breads baked.<q>Resistance is futile, albeit entertaining.</q>',[11,8]);
		new Game.Achievement('Negative void','Ascend with <b>1 nonillion</b> breads baked.<q>You now have so few breads that it\'s almost like you have a negative amount of them.</q>',[11,8]);
		...
		Game.BankAchievement('The land of milk and breads');
		Game.BankAchievement('He who controls the breads controls the universe','The milk must flow!');
		...
		Game.BankAchievement('In the mouth of madness','A bread is just what we tell each other it is.');
		...
		Game.CpsAchievement('A world filled with breads');
		Game.CpsAchievement('When this baby hits '+Beautify(10000000000000*60*60)+' breads per hour');
		Game.CpsAchievement('Fast and delicious');
		Game.CpsAchievement('breadhertz : a really, really tasty hertz','Tastier than a hertz donut, anyway.');
		...
		order=1000;
		new Game.Achievement('Clickastrophe','Make <b>100,000,000,000,000,000</b> breads from clicking.',[11,17]);
		new Game.Achievement('Clickataclysm','Make <b>10,000,000,000,000,000,000</b> breads from clicking.',[11,18]);
		...
		order=6005;
		new Game.Achievement('The elder scrolls','Own a combined <b>777</b> grandmas and cursors.<q>Let me guess. Someone stole your bread.</q>',[10,9]);
		
		order=30050;
		new Game.Achievement('To crumbs, you say?','Ascend with <b>1 decillion</b> breads baked.<q>Very well then.</q>',[29,6]);
		...
		order=1800;Game.TieredAchievement('bread clicker forever and forever a hundred years bread clicker, all day long forever, forever a hundred times, over and over bread clicker adventures dot com','Have <b>300</b> time machines.','Time machine',7);
		...
		order=10000;
		new Game.Achievement('Early bird','Click a golden bread <b>less than 1 second after it spawns</b>.',[10,14]);
		new Game.Achievement('Fading luck','Click a golden bread <b>less than 1 second before it dies</b>.',[10,14]);
		...
		Game.CpsAchievement('Well the breads start coming and they don\'t stop coming','Didn\'t make sense not to click for fun.');
		Game.CpsAchievement('I don\'t know if you\'ve noticed but all these icons are very slightly off-center');
		Game.CpsAchievement('The proof of the bread is in the baking','How can you have any breads if you don\'t bake your dough?');
		...
		order=10000;
		new Game.Achievement('Four-leaf bread','Have <b>4</b> golden breads simultaneously.<q>Fairly rare, considering breads don\'t even have leaves.</q>',[27,6]);Game.last.pool='shadow';
		...
		order=1000;
		new Game.Achievement('The ultimate clickdown','Make <b>1,000,000,000,000,000,000,000</b> breads from clicking.<q>(of ultimate destiny.)</q>',[11,19]);
		...
		order=1450;Game.TieredAchievement('Holy breads, grandma!','Have <b>400</b> temples.','Temple',9);
		order=1475;Game.TieredAchievement('The Prestige','Have <b>400</b> wizard towers.<q>(Unrelated to the bread Clicker feature of the same name.)</q>','Wizard tower',9);
		...
		order=36000;
		new Game.Achievement('So much to do so much to see','Manage a bread legacy for <b>at least a year</b>.<q>Thank you so much for playing bread Clicker!</q>',[23,11]);Game.last.pool='shadow';
		...
		Game.CpsAchievement('Green breads sleep furiously');
		...
		order=1000;
		new Game.Achievement('All the other kids with the pumped up clicks','Make <b>100,000,000,000,000,000,000,000</b> breads from clicking.',[11,28]);
		new Game.Achievement('One...more...click...','Make <b>10,000,000,000,000,000,000,000,000</b> breads from clicking.',[11,30]);
		...
		order=30050;
		new Game.Achievement('You get nothing','Ascend with <b>1 undecillion</b> breads baked.<q>Good day sir!</q>',[29,6]);
		new Game.Achievement('Humble rebeginnings','Ascend with <b>1 duodecillion</b> breads baked.<q>Started from the bottom, now we\'re here.</q>',[29,6]);
		new Game.Achievement('The end of the world','Ascend with <b>1 tredecillion</b> breads baked.<q>(as we know it)</q>',[21,25]);
		new Game.Achievement('Oh, you\'re back','Ascend with <b>1 quattuordecillion</b> breads baked.<q>Missed us?</q>',[21,25]);
		new Game.Achievement('Lazarus','Ascend with <b>1 quindecillion</b> breads baked.<q>All rise.</q>',[21,25]);
		...
		order=30250;
		new Game.Achievement('When the breads ascend just right','Ascend with exactly <b>1,000,000,000,000 breads</b>.',[25,7]);Game.last.pool='shadow';//this achievement is shadow because it is only achievable through blind luck or reading external guides; this may change in the future
		...
		order=30050;
		new Game.Achievement('Smurf account','Ascend with <b>1 sexdecillion</b> breads baked.<q>It\'s like you just appeared out of the blue!</q>',[21,32]);
		new Game.Achievement('If at first you don\'t succeed','Ascend with <b>1 septendecillion</b> breads baked.<q>If at first you don\'t succeed, try, try, try again.<br>But isn\'t that the definition of insanity?</q>',[21,32]);
		...
		order=1000;new Game.Achievement('Clickety split','Make <b>1,000,000,000,000,000,000,000,000,000</b> breads from clicking.',[11,31]);
		...
		order=10000;
		new Game.Achievement('Seven horseshoes','Click <b>27777 golden breads</b>.<q>Enough for one of those funky horses that graze near your factories.</q>',[21,33]);Game.last.pool='shadow';
		...
		order=2100;Game.TieredAchievement('Flip a bread. Chips, I win. Crust, you lose.','Have <b>600</b> chancemakers.','Chancemaker',13);
		...
		*/
		...
		new Game.buffType('frenzy',function(time,pow)
		{
			return {
				name:'Frenzy',
				desc:'bread production x'+pow+' for '+Game.sayTime(time*Game.fps,-1)+'!',
				icon:[10,14],
				time:time*Game.fps,
				add:true,
				multCpS:pow,
		...
		new Game.buffType('clot',function(time,pow)
		{
			return {
				name:'Clot',
				desc:'bread production halved for '+Game.sayTime(time*Game.fps,-1)+'!',
				icon:[15,5],
				time:time*Game.fps,
				add:true,
				multCpS:pow,
		...
		new Game.buffType('cursed finger',function(time,pow)
		{
			return {
				name:'Cursed finger',
				desc:'bread production halted for '+Game.sayTime(time*Game.fps,-1)+',<br>but each click is worth '+Game.sayTime(time*Game.fps,-1)+' of CpS.',
				icon:[12,17],
				time:time*Game.fps,
				add:true,
				power:pow,
		...
		new Game.buffType('bread storm',function(time,pow)
		{
			return {
				name:'bread storm',
				desc:'breads everywhere!',
				icon:[22,6],
				time:time*Game.fps,
				add:true,
				power:pow,
		...
		new Game.buffType('building buff',function(time,pow,building)
		{
			...
			return {
				name:Game.goldenbreadBuildingBuffs[obj.name][0],
				desc:'Your '+Beautify(obj.amount)+' '+obj.plural+' are boosting your CpS!<br>bread production +'+(Math.ceil(pow*100-100))+'% for '+Game.sayTime(time*Game.fps,-1)+'!',
		...
		new Game.buffType('building debuff',function(time,pow,building)
		{
			var obj=Game.ObjectsById[building];
			return {
				name:Game.goldenbreadBuildingBuffs[obj.name][1],
				desc:'Your '+Beautify(obj.amount)+' '+obj.plural+' are rusting your CpS!<br>bread production '+(Math.ceil(pow*100-100))+'% slower for '+Game.sayTime(time*Game.fps,-1)+'!',
		...
		new Game.buffType('sugar blessing',function(time,pow)
		{
			return {
				name:'Sugar blessing',
				desc:'You find 10% more golden breads for the next '+Game.sayTime(time*Game.fps,-1)+'.',
				icon:[29,16],
				time:time*Game.fps,
				//add:true
			};
		...
		Game.UpdateWrinklers=function()
		{
			...
			{
				xBase=Game.breadOriginX;
				yBase=Game.breadOriginY;
			}
			var max=Game.getWrinklersMax();
			var n=0;
			for (var i in Game.wrinklers)
			...
			for (var i in Game.wrinklers)
			{
				...
				if (me.phase==2)
				{
					me.sucked+=(((Game.breadsPs/Game.fps)*Game.cpsSucked));//suck the breads
				}
				if (me.phase>0)
				{
					if (me.type==0)
					...
					var d=128*(2-me.close);//*Game.BigbreadSize;
				...
				if (me.hp<=0.5 && me.phase>0)
				{
					...
					me.sucked*=toSuck;//bread dough does weird things inside wrinkler digestive tracts
					...
					if (me.sucked>0.5)
					{
						if (Game.prefs.popups) Game.Popup('Exploded a '+(me.type==1?'shiny ':'')+'wrinkler : found '+Beautify(me.sucked)+' breads!');
						else Game.Notify('Exploded a '+(me.type==1?'shiny ':'')+'wrinkler','Found <b>'+Beautify(me.sucked)+'</b> breads!',[19,8],6);
						Game.Popup('<div style="font-size:80%;">+'+Beautify(me.sucked)+' breads</div>',Game.mouseX,Game.mouseY);
						
						if (Game.season=='halloween')
						{
							//if (Math.random()<(Game.HasAchiev('Spooky breads')?0.2:0.05))//halloween bread drops
							var failRate=0.95;
							if (Game.HasAchiev('Spooky breads')) failRate=0.8;
							...
							if (Math.random()>failRate)//halloween bread drops
							{
								var bread=choose(['Skull breads','Ghost breads','Bat breads','Slime breads','Pumpkin breads','Eyeball breads','Spider breads']);
								if (!Game.HasUnlocked(bread) && !Game.Has(bread))
								{
									Game.Unlock(bread);
									if (Game.prefs.popups) Game.Popup('Found : '+bread+'!');
									else Game.Notify(bread,'You also found <b>'+bread+'</b>!',Game.Upgrades[bread].icon);
								}
							}
						}
						Game.DropEgg(0.98);
		...
		Game.DrawWrinklers=function()
		{
			...
			for (var i in Game.wrinklers)
			{
				...
				if (me.phase>0)
				{
					...
					//var s=Math.min(1,me.sucked/(Game.breadsPs*60))*0.75+0.25;//scale wrinklers as they eat
			...
			{
				var x=Game.breadOriginX;
				var y=Game.breadOriginY;
				ctx.font='14px Merriweather';
				ctx.textAlign='center';
		...
		Game.UpgradeSanta=function()
		{
			...
			if (Game.breads>moni && Game.santaLevel<14)
			{
				PlaySound('snd/shimmerClick.mp3');
		...
		Game.dragonLevels=[
			{name:'Dragon egg',action:'Chip it',pic:0,
				cost:function(){return Game.breads>=1000000;},
				buy:function(){Game.Spend(1000000);},
				costStr:function(){return Beautify(1000000)+' breads';}},
			{name:'Dragon egg',action:'Chip it',pic:1,
				cost:function(){return Game.breads>=1000000*2;},
				buy:function(){Game.Spend(1000000*2);},
				costStr:function(){return Beautify(1000000*2)+' breads';}},
			{name:'Dragon egg',action:'Chip it',pic:2,
				cost:function(){return Game.breads>=1000000*4;},
				buy:function(){Game.Spend(1000000*4);},
				costStr:function(){return Beautify(1000000*4)+' breads';}},
			{name:'Shivering dragon egg',action:'Hatch it',pic:3,
				cost:function(){return Game.breads>=1000000*8;},
				buy:function(){Game.Spend(1000000*8);},
				costStr:function(){return Beautify(1000000*8)+' breads';}},
			{name:'Krumblor, bread hatchling',action:'Train Breath of Milk<br><small>Aura : kittens are 5% more effective</small>',pic:4,
				cost:function(){return Game.breads>=1000000*16;},
				buy:function(){Game.Spend(1000000*16);},
				costStr:function(){return Beautify(1000000*16)+' breads';}},
			{name:'Krumblor, bread hatchling',action:'Train Dragon Cursor<br><small>Aura : clicking is 5% more effective</small>',pic:4,
			...
			{name:'Krumblor, bread hatchling',action:'Train Elder Battalion<br><small>Aura : grandmas gain +1% CpS for every non-grandma building</small>',pic:4,
			...
			{name:'Krumblor, bread hatchling',action:'Train Reaper of Fields<br><small>Aura : golden breads may trigger a Dragon Harvest</small>',pic:4,
			...
			{name:'Krumblor, bread dragon',action:'Train Earth Shatterer<br><small>Aura : buildings sell back for 50% instead of 25%</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Master of the Armory<br><small>Aura : all upgrades are 2% cheaper</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Fierce Hoarder<br><small>Aura : all buildings are 2% cheaper</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Dragon God<br><small>Aura : prestige CpS bonus +5%</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Arcane Aura<br><small>Aura : golden breads appear 5% more often</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Dragonflight<br><small>Aura : golden breads may trigger a Dragonflight</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Ancestral Metamorphosis<br><small>Aura : golden breads give 10% more breads</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Unholy Dominion<br><small>Aura : wrath breads give 10% more breads</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Epoch Manipulator<br><small>Aura : golden bread effects last 5% longer</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Mind Over Matter<br><small>Aura : +25% random drops</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Radiant Appetite<br><small>Aura : all bread production multiplied by 2</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Dragon\'s Fortune<br><small>Aura : +123% CpS per golden bread on-screen</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Dragon\'s Curve<br><small>Aura : sugar lumps grow 5% faster, 50% weirder</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Reality Bending<br><small>Aura : 10% of every other aura, combined</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Train Dragon Orbs<br><small>Aura : selling your best building may grant a wish</small>',pic:5,
			...
			{name:'Krumblor, bread dragon',action:'Bake dragon bread<br><small>Delicious!</small>',pic:6,
				cost:function(){var fail=0;for (var i in Game.Objects){if (Game.Objects[i].amount<50) fail=1;}return (fail==0);},
				buy:function(){for (var i in Game.Objects){Game.Objects[i].sacrifice(50);}Game.Unlock('Dragon bread');},
				costStr:function(){return '50 of every building';}},
			{name:'Krumblor, bread dragon',action:'Train secondary aura<br><small>Lets you use two dragon auras simultaneously</small>',pic:7,
			...
			{name:'Krumblor, bread dragon',action:'Your dragon is fully trained.',pic:8}
		];
		...
		Game.dragonAuras={
			...
			4:{name:'Reaper of Fields',pic:[2,25],desc:'Golden breads may trigger a <b>Dragon Harvest</b>.'},
			...
			9:{name:'Arcane Aura',pic:[17,25],desc:'Golden breads appear <b>+5%</b> more often.'},
			10:{name:'Dragonflight',pic:[5,25],desc:'Golden breads may trigger a <b>Dragonflight</b>.'},
			11:{name:'Ancestral Metamorphosis',pic:[6,25],desc:'Golden breads give <b>10%</b> more breads.'},
			12:{name:'Unholy Dominion',pic:[7,25],desc:'Wrath breads give <b>10%</b> more breads.'},
			13:{name:'Epoch Manipulator',pic:[8,25],desc:'Golden breads last <b>5%</b> longer.'},
			14:{name:'Mind Over Matter',pic:[13,25],desc:'Random drops are <b>25% more common</b>.'},
			15:{name:'Radiant Appetite',pic:[14,25],desc:'All bread production <b>multiplied by 2</b>.'},
			16:{name:'Dragon\'s Fortune',pic:[19,25],desc:'<b>+123% CpS</b> per golden bread on-screen, multiplicative.'},
			...
			19:{name:'Dragon Orbs',pic:[33,25],desc:'With no buffs and no golden breads on screen, selling your most powerful building has <b>10% chance to summon one</b>.'},
		};
				...
				if (Game.specialTab=='santa')
				{
					...
					if (Game.santaLevel<14)
					{
						...
						'<div class="optionBox" style="margin-bottom:0px;"><a class="option framed large title" '+Game.clickStr+'="Game.UpgradeSanta();">'+
							...
							'<div style="display:table-cell;vertical-align:middle;font-size:65%;">cost :<div'+(Game.breads>moni?'':' style="color:#777;"')+'>'+Beautify(Math.pow(Game.santaLevel+1,Game.santaLevel+1))+' '+(Game.santaLevel>0?'breads':'bread')+'</div></div>'+
						'</a></div>';
					}
				}
		...
		Game.DrawBackground=function()
		{
			...
			if (!Game.Background)//init some stuff
			{
				...
				Game.LeftBackground.canvas.height=Game.LeftBackground.canvas.parentNode.offsetHeight;
					...
					Game.LeftBackground.drawImage(Pic('brokenbread.png'),0,0);
					Game.LeftBackground.drawImage(Pic('brokenbreadHalo.png'),0,0);
			...
			else
			{
				...
				Game.breadOriginX=Math.floor(ctx.canvas.width/2);
				Game.breadOriginY=Math.floor(ctx.canvas.height*0.4);
				...
				{	
					if (Game.prefs.particles)
					{
						...
						{
							if (Game.breadsPs>=1000) pic='breadShower3.png';
							else if (Game.breadsPs>=500) pic='breadShower2.png';
							else if (Game.breadsPs>=50) pic='breadShower1.png';
							else pic='';
						}
						if (pic!='')
						{
						...
						if (showDragon)
						{
							...
							var x=Game.breadOriginX-s/2;
							var y=Game.breadOriginY-s/(1.4+0.2*Math.sin(Game.T*0.01));
						...
						{
							ctx.globalAlpha=1;
							var amount=Math.floor(Game.breads).toString();
							...
							for (var i=0;i<digits;i++)
							{
								...
								for (var ii=0;ii<num;ii++)
								{
									...
									ctx.drawImage(Pic('perfectbread.png'),x-s/2,y-s/2,s,s);
								}
								space+=s/2;
							}
						}
						else
						{
							...
							{
								var nestW=304*0.98*Game.BigbreadSize;
								var nestH=161*0.98*Game.BigbreadSize;
								ctx.drawImage(Pic('nest.png'),-nestW/2,-nestH/2+130,nestW,nestH);
							}
							//ctx.rotate(((Game.startDate%360)/360)*Math.PI*2);
							ctx.drawImage(Pic('perfectbread.png'),-s/2,-s/2,s,s);
					...
					else//no particles
					{
						...
						var x=Game.breadOriginX-s/2;
						var y=Game.breadOriginY-s/2;
						ctx.drawImage(Pic('perfectbread.png'),x,y,s,s);
					}
					...
					{
						ctx.save();
						ctx.translate(Game.breadOriginX,Game.breadOriginY);
						...
						for (var i=0;i<amount;i++)
						{
							...
							var x=0;
							var y=(140/* *Game.BigbreadSize*/+n*16+w)-16;
							...
							{
								y+=16;
								x=Game.breadOriginX+Math.sin(-((r-5)/360)*Math.PI*2)*y;
								y=Game.breadOriginY+Math.cos(-((r-5)/360)*Math.PI*2)*y;
				...
				else
				{
					...
					for (var i=0;i<10;i++)
					{
						...
						ctx.drawImage(Pic('brokenbread.png'),256*(chunks[i]),0,256,256,-s/2+Math.sin(-(((chunks[i]+4)%10)/10)*Math.PI*2)*d,-s/2+Math.cos(-(((chunks[i]+4)%10)/10)*Math.PI*2)*d,s,s);
					}
					...
					for (var i=0;i<10;i++)
					{
						...
						ctx.drawImage(Pic('brokenbread.png'),256*(chunks[i]),0,256,256,-s/2+Math.sin(-(((chunks[i]+4)%10)/10)*Math.PI*2)*d+x2,-s/2+Math.cos(-(((chunks[i]+4)%10)/10)*Math.PI*2)*d+y2,s,s);
					}
					...
					ctx.drawImage(Pic('brokenbreadHalo.png'),-s/1.3333,-s/1.3333,s*1.5,s*1.5);
				...
				if (Game.prefs.milk)
				{
					...
					if (Game.TOYS)
					{
						...
						for (var i in Game.toys)
						{
							...
							ctx.translate(me.x,me.y);
							ctx.rotate(me.r);
							if (Game.toysType==1) ctx.drawImage(Pic('smallbreads.png'),(me.id%8)*64,0,64,64,-me.s/2,-me.s/2,me.s,me.s);
		...
		Game.SesameReset=function()
		{
			...
			Game.bakeryNameRefresh();
			Game.Achievements['Cheated breads taste awful'].won=1;
		}
		...
		Game.OpenSesame=function()
		{
			...
			str+='<div class="line"></div>';
			str+='<a class="option neato" '+Game.clickStr+'="Game.breads*=10;Game.breadsEarned*=10;">x10</a>';
			str+='<a class="option neato" '+Game.clickStr+'="Game.breads/=10;Game.breadsEarned/=10;">/10</a><br>';
			str+='<a class="option neato" '+Game.clickStr+'="Game.breads*=1000;Game.breadsEarned*=1000;">x1k</a>';
			str+='<a class="option neato" '+Game.clickStr+'="Game.breads/=1000;Game.breadsEarned/=1000;">/1k</a><br>';
			...
			str+='<div class="line"></div>';
			for (var i=0;i<Game.goldenbreadChoices.length/2;i++)
			{
				str+='<a class="option neato" '+Game.clickStr+'="var newShimmer=new Game.shimmer(\'golden\');newShimmer.force=\''+Game.goldenbreadChoices[i*2+1]+'\';">'+Game.goldenbreadChoices[i*2]+'</a>';
				//str+='<a class="option neato" '+Game.clickStr+'="Game.goldenbread.force=\''+Game.goldenbread.choices[i*2+1]+'\';Game.goldenbread.spawn();">'+Game.goldenbread.choices[i*2]+'</a>';
				//str+='<a class="option neato" '+Game.clickStr+'="Game.goldenbread.click(0,\''+Game.goldenbread.choices[i*2+1]+'\');">'+Game.goldenbread.choices[i*2]+'</a>';
			}
			str+='</div>';
		...
		Game.DebugUpgradeCpS=function()
		{
			...
			for (var i in Game.Upgrades)
			{
				...
				if (me.bought)
				{
					me.bought=0;
					Game.CalculateGains();
					//Game.debuggedUpgradeCpS[me.name]=CpS-Game.breadsPs;
					Game.debuggedUpgradeCpS[me.name]=(CpS/(Game.breadsPs||1)-1);
	...
	Game.Logic=function()
	{
		...
		if (!Game.OnAscend && Game.AscendTimer==0)
		{
			...
			//these are kinda fun
			//if (Game.BigbreadState==2 && !Game.promptOn && Game.Scroll!=0) Game.Clickbread();
			//if (Game.BigbreadState==1 && !Game.promptOn) Game.Clickbread();
			
			//handle graphic stuff
			if (Game.prefs.wobbly)
			{
				if (Game.BigbreadState==1) Game.BigbreadSizeT=0.98;
				else if (Game.BigbreadState==2) Game.BigbreadSizeT=1.05;
				else Game.BigbreadSizeT=1;
				Game.BigbreadSizeD+=(Game.BigbreadSizeT-Game.BigbreadSize)*0.75;
				Game.BigbreadSizeD*=0.75;
				Game.BigbreadSize+=Game.BigbreadSizeD;
				Game.BigbreadSize=Math.max(0.1,Game.BigbreadSize);
			}
			else
			{
				if (Game.BigbreadState==1) Game.BigbreadSize+=(0.98-Game.BigbreadSize)*0.5;
				else if (Game.BigbreadState==2) Game.BigbreadSize+=(1.05-Game.BigbreadSize)*0.5;
				else Game.BigbreadSize+=(1-Game.BigbreadSize)*0.5;
			}
			...
			Game.Earn(Game.breadsPs/Game.fps);//add breads per second
			...
			if (Game.cpsSucked>0)
			{
				Game.Dissolve((Game.breadsPs/Game.fps)*Game.cpsSucked);
				Game.breadsSucked+=((Game.breadsPs/Game.fps)*Game.cpsSucked);
				//should be using one of the following, but I'm not sure what I'm using this stat for anymore
				//Game.breadsSucked=Game.wrinklers.reduce(function(s,w){return s+w.sucked;},0);
				//for (var i in Game.wrinklers) {Game.breadsSucked+=Game.wrinklers[i].sucked;}
			}
			
			//var cps=Game.breadsPs+Game.breads*0.01;//exponential breads
			//Game.Earn(cps/Game.fps);//add breads per second
			
			for (var i in Game.Objects)
			{
				var me=Game.Objects[i];
				me.totalbreads+=(me.storedTotalCps*Game.globalCpsMult)/Game.fps;
			}
			if (Game.breads && Game.T%Math.ceil(Game.fps/Math.min(10,Game.breadsPs))==0 && Game.prefs.particles) Game.particleAdd();//bread shower
			...
			{
				if (isNaN(Game.breads)) {Game.breads=0;Game.breadsEarned=0;Game.recalculateGains=1;}
				...
				if (Game.breadsEarned>=1000000 && (Game.ascensionMode==1 || Game.resets==0))//challenge run or hasn't ascended yet
				{
					...
					if (Game.breadClicks<=15) Game.Win('Neverclick');
					if (Game.breadClicks<=0) Game.Win('True Neverclick');
					if (Game.breadsEarned>=1000000000 && Game.UpgradesOwned==0) Game.Win('Hardcore');
				}
				
				for (var i in Game.UnlockAt)
				{
					var unlock=Game.UnlockAt[i];
					if (Game.breadsEarned>=unlock.breads)
					{
						var pass=1;
				...
				if (Game.Has('Golden bread alert sound')) Game.Unlock('Golden bread sound selector');
				
				if (Game.Has('Prism heart biscuits')) Game.Win('Lovely breads');
				if (Game.season=='easter')
				{
					var eggs=0;
					for (var i in Game.easterEggs)
				...
				if (Game.Has('Legacy') && Game.ascensionMode!=1)
				{
					...
					if (Game.Has('Heavenly chip secret')) Game.Unlock('Heavenly bread stand');
					if (Game.Has('Heavenly bread stand')) Game.Unlock('Heavenly bakery');
				...
				{
					if (Game.breadsEarned>=Game.BankAchievements[i].threshold) Game.Win(Game.BankAchievements[i].name);
				}
				...
				if (Game.handmadebreads>=1000) {Game.Win('Clicktastic');Game.Unlock('Plastic mouse');}
				if (Game.handmadebreads>=100000) {Game.Win('Clickathlon');Game.Unlock('Iron mouse');}
				if (Game.handmadebreads>=10000000) {Game.Win('Clickolympics');Game.Unlock('Titanium mouse');}
				if (Game.handmadebreads>=1000000000) {Game.Win('Clickorama');Game.Unlock('Adamantium mouse');}
				if (Game.handmadebreads>=100000000000) {Game.Win('Clickasmic');Game.Unlock('Unobtainium mouse');}
				if (Game.handmadebreads>=10000000000000) {Game.Win('Clickageddon');Game.Unlock('Eludium mouse');}
				if (Game.handmadebreads>=1000000000000000) {Game.Win('Clicknarok');Game.Unlock('Wishalloy mouse');}
				if (Game.handmadebreads>=100000000000000000) {Game.Win('Clickastrophe');Game.Unlock('Fantasteel mouse');}
				if (Game.handmadebreads>=10000000000000000000) {Game.Win('Clickataclysm');Game.Unlock('Nevercrack mouse');}
				if (Game.handmadebreads>=1000000000000000000000) {Game.Win('The ultimate clickdown');Game.Unlock('Armythril mouse');}
				if (Game.handmadebreads>=100000000000000000000000) {Game.Win('All the other kids with the pumped up clicks');Game.Unlock('Technobsidian mouse');}
				if (Game.handmadebreads>=10000000000000000000000000) {Game.Win('One...more...click...');Game.Unlock('Plasmarble mouse');}
				if (Game.handmadebreads>=1000000000000000000000000000) {Game.Win('Clickety split');Game.Unlock('Miraculite mouse');}
				
				if (Game.breadsEarned<Game.breads) Game.Win('Cheated breads taste awful');
				
				if (Game.Has('Skull breads') && Game.Has('Ghost breads') && Game.Has('Bat breads') && Game.Has('Slime breads') && Game.Has('Pumpkin breads') && Game.Has('Eyeball breads') && Game.Has('Spider breads')) Game.Win('Spooky breads');
				...
				if (Game.breadsEarned>=1000000 && Game.Has('How to bake your dragon')) Game.Unlock('A crumbly egg');
				
				if (Game.breadsEarned>=25 && Game.season=='christmas') Game.Unlock('A festive hat');
				...
				if (Game.breadsEarned>=10000000000000 && !Game.HasAchiev('You win a bread')) {Game.Win('You win a bread');Game.Earn(1);}
				
				if (Game.shimmerTypes['golden'].n>=4) Game.Win('Four-leaf bread');
				...
				for (var i in Game.Objects)
				{
					...
					{
						if (it.totalbreads>=it.productionAchievs[ii].pow) Game.Win(it.productionAchievs[ii].achiev.name);
					}
				}
				
				if (!Game.HasAchiev('bread-dunker') && Game.LeftBackground && Game.milkProgress>0.1 && (Game.LeftBackground.canvas.height*0.4+256/2-16)>((1-Game.milkHd)*Game.LeftBackground.canvas.height)) Game.Win('bread-dunker');
				//&& l('bigbread').getBoundingClientRect().bottom>l('milk').getBoundingClientRect().top+16 && Game.milkProgress>0.1) Game.Win('bread-dunker');
				
				Game.runModHook('check');
			}
			
			Game.breadsd+=(Game.breads-Game.breadsd)*0.3;
		...
		{
			var title='bread Clicker';
			if (Game.season=='fools') title='bread Baker';
			document.title=(Game.OnAscend?'Ascending! ':'')+Beautify(Game.breads)+' '+(Game.breads==1?'bread':'breads')+' - '+title;
		}
		if (Game.T%15==0)
		{
			//written through the magic of "hope for the best" maths
			var chipsOwned=Game.HowMuchPrestige(Game.breadsReset);
			var ascendNowToOwn=Math.floor(Game.HowMuchPrestige(Game.breadsReset+Game.breadsEarned));
			var ascendNowToGet=ascendNowToOwn-Math.floor(chipsOwned);
			var nextChipAt=Game.HowManybreadsReset(Math.floor(chipsOwned+ascendNowToGet+1))-Game.HowManybreadsReset(Math.floor(chipsOwned+ascendNowToGet));
			var breadsToNext=Game.HowManybreadsReset(ascendNowToOwn+1)-(Game.breadsEarned+Game.breadsReset);
			var percent=1-(breadsToNext/nextChipAt);
			...
			str+='<div class="line"></div>';
			str+='You need <b>'+Beautify(breadsToNext)+' more breads</b> for the next level.<br>';
	...
	Game.Draw=function()
	{
		...
		if (!Game.OnAscend)
		{
			...
			var unit=(Math.round(Game.breadsd)==1?' bread':' breads');
			var str=Beautify(Math.round(Game.breadsd));
			if (Game.breadsd>=1000000)//dirty padding
			{
			...
			if (str.length>11 && !Game.mobile) unit='<br>breads';
			str+=unit;
			if (Game.prefs.monospace) str='<span class="monospace">'+str+'</span>';
			str=str+'<div style="font-size:50%;"'+(Game.cpsSucked>0?' class="warning"':'')+'>per second : '+Beautify(Game.breadsPs*(1-Game.cpsSucked),1)+'</div>';//display bread amount
			l('breads').innerHTML=str;
			l('compactbreads').innerHTML=str;
			Timer.track('bread amount');
			...
			if (Game.drawT%5==0)
			{
				//if (Game.prefs.monospace) {l('breads').className='title monospace';} else {l('breads').className='title';}
				var lastLocked=0;
				for (var i in Game.Objects)
				{
					var me=Game.Objects[i];
					...
					var classes='product';
					var price=me.bulkPrice;
					if (Game.breadsEarned>=me.basePrice || me.bought>0) {classes+=' unlocked';lastLocked=0;me.locked=0;} else {classes+=' locked';lastLocked++;me.locked=1;}
					if ((Game.buyMode==1 && Game.breads>=price) || (Game.buyMode==-1 && me.amount>0)) classes+=' enabled'; else classes+=' disabled';
				...
				for (var i in Game.UpgradesInStore)
				{
					...
					if (!me.bought)
					{
						...
						var canBuy=me.canBuy();//(Game.breads>=price);
	...
	Game.Loop=function()
	{
		...
		{
			if (Game.accumulatedDelay>1000*60*30) Game.delayTimeouts+=3;//more than 30 minutes delay ? computer probably asleep and not making breads anyway
	...
	if (!Game.ready)
	{
		...
		else
		{
			console.log('[=== '+choose([
				'Oh, hello!',
				'hey, how\'s it hangin',
				'About to cheat in some breads or just checking for bugs?',
				'Remember : cheated breads taste awful!',
				'Hey, Orteil here. Cheated breads taste awful... or do they?',
			])+' ===]');
			Game.Load();
			//try {Game.Load();}
			//catch(err) {console.log('ERROR : '+err.message);}
